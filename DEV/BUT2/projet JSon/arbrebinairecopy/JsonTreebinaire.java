...
public class JsonTreebinaire {
     ...
     */
    public JsonTreebinaire(JsonParser liste){
    ...
    public void modifier(int taille){
        ...
        for(int i=1;i<=taille;i++){
            ...
            if(chaine.compareTo("{")==0){
                ...
                optimiser(maillon.getDroite(),compteurVirgule,1);
                compteurVirgule=0;
            }
            if(chaine.compareTo("[")==0){
                int temp;
    ...
    public void optimiser(MaillonTree m,int nb,int etat){
        ...
        if(etat==0){
            for(int i=0;i<=permut;i++){
                permuter(m,m.getGauche());
            }
        }
        if(etat==1){
            for(int i=0;i<=permut;i++){
                permuter(m,m.getDroite());
            }
        }
        if(m.getGauche()!=null){
            if(m.getGauche().getValeur().compareTo(",")==0){
                optimiser(m.getGauche(),nb,0);
            }
        }
        if(m.getDroite()!=null){
            if(m.getDroite().getValeur().compareTo(",")==0){
                optimiser(m.getDroite(),x-nb,1);
            }
        }
    }
    /** méthode
    ...
    public static void main(String[] args) {
        ...
        JsonTreebinaire t = new JsonTreebinaire(j);
