...
public class TSQLiteRowBeginJava
{
  ...
  protected final String TEXT_118 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_119 = ";" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_121 = " = null;" + NL + "\tString query_";
  protected final String TEXT_122 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_126 = ".prepareStatement(";
  protected final String TEXT_127 = ");\t" + NL + "\t";
  protected final String TEXT_128 = NL + "\t\tjava.sql.Statement stmt_";
