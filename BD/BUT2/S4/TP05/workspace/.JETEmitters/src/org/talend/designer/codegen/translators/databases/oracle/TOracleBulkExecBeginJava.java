...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_378 = ".getTables(null, dbschema_";
  protected final String TEXT_379 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_380 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_381 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_382 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  protected final String TEXT_383 = ")) {" + NL + "                        whetherExist_";
  ...
  protected final String TEXT_394 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_395 = ".equals";
  protected final String TEXT_396 = "IgnoreCase";
  ...
  protected final String TEXT_402 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_406 = " - Creating table ";
  ...
  protected final String TEXT_414 = " - Create table ";
  ...
  protected final String TEXT_419 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_421 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_425 = " - Droping table ";
  ...
  protected final String TEXT_433 = " - Drop table ";
  ...
  protected final String TEXT_442 = " - Creating table ";
  protected final String TEXT_443 = "\" + tableName_";
  ...
  protected final String TEXT_450 = " - Create table ";
  ...
  protected final String TEXT_456 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_460 = " - Clearing table ";
  ...
  protected final String TEXT_468 = "- Clear table ";
  ...
  protected final String TEXT_474 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_475 = " = conn_";
  protected final String TEXT_476 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_477 = " = stmtTruncCount_";
  protected final String TEXT_478 = ".executeQuery(\"";
  protected final String TEXT_479 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_480 = " = conn_";
  protected final String TEXT_481 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_482 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_483 = " - Trancating table ";
  ...
  protected final String TEXT_491 = " - Truncate table ";
  protected final String TEXT_492 = "\" + tableName_";
  protected final String TEXT_493 = " + \"";
  protected final String TEXT_494 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_495 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_496 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_497 = " += rsTruncCount_";
  protected final String TEXT_498 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_499 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_500 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_501 = ".close();" + NL + "\t\t";
  protected final String TEXT_502 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_503 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_504 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_505 = NL + "boolean isDirect_";
  protected final String TEXT_506 = " = false;\t";
  protected final String TEXT_507 = NL + NL + "    String ctlf_";
  protected final String TEXT_508 = " = ";
  protected final String TEXT_509 = ";" + NL + "    String logf_";
  protected final String TEXT_510 = " = ";
  protected final String TEXT_511 = "+\".log\";" + NL + "\t" + NL + "\ttry {" + NL + "\t\tjava.io.BufferedReader ctlf_br_";
  protected final String TEXT_512 = " = new java.io.BufferedReader(new java.io.FileReader(ctlf_";
  protected final String TEXT_513 = "));" + NL + "\t\t" + NL + "\t\ttry{" + NL + "\t\t\tString optionLine_";
  protected final String TEXT_514 = " = ctlf_br_";
  protected final String TEXT_515 = ".readLine();" + NL + "\t\t\tString regex_";
  protected final String TEXT_516 = " = \"\\\\bdirect\\\\s*=\\\\s*true\\\\b\";" + NL + "\t\t\tjava.util.regex.Pattern pattern_";
  protected final String TEXT_517 = " = java.util.regex.Pattern.compile(regex_";
  protected final String TEXT_518 = ", java.util.regex.Pattern.CASE_INSENSITIVE);" + NL + "\t\t\tjava.util.regex.Matcher matcher_";
  protected final String TEXT_519 = " = pattern_";
  protected final String TEXT_520 = ".matcher(optionLine_";
  protected final String TEXT_521 = ");" + NL + "\t\t\tisDirect_";
  protected final String TEXT_522 = " = matcher_";
  protected final String TEXT_523 = ".find();\t\t" + NL + "\t\t}" + NL + "\t\tfinally\t{" + NL + "\t\t\tctlf_br_";
  protected final String TEXT_524 = ".close();" + NL + "\t\t}" + NL + "\t}catch(java.io.IOException ioe) {";
  protected final String TEXT_525 = NL + "\t\tthrow ioe;" + NL + "    }" + NL + "\t";
  protected final String TEXT_526 = NL + "\tisDirect_";
  protected final String TEXT_527 = " = ";
  protected final String TEXT_528 = ";" + NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_529 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_530 = ".append(\"OPTIONS (\");";
  protected final String TEXT_531 = NL + "            optionClause_";
  protected final String TEXT_532 = ".append(\", \");";
  protected final String TEXT_533 = NL + "                    optionClause_";
  protected final String TEXT_534 = ".append(\"";
  protected final String TEXT_535 = "=(";
  protected final String TEXT_536 = ")\");";
  protected final String TEXT_537 = NL + "                    optionClause_";
  protected final String TEXT_538 = ".append(\"";
  protected final String TEXT_539 = "=";
  protected final String TEXT_540 = "\");";
  protected final String TEXT_541 = NL + "                if(";
  protected final String TEXT_542 = ".split(\",\").length>1){" + NL + "                    optionClause_";
  protected final String TEXT_543 = ".append(\"";
  protected final String TEXT_544 = "=(\"+";
  protected final String TEXT_545 = "+\")\");" + NL + "                }else{" + NL + "                    optionClause_";
  protected final String TEXT_546 = ".append(\"";
  protected final String TEXT_547 = "=\"+";
  protected final String TEXT_548 = ");" + NL + "                }";
  protected final String TEXT_549 = NL + "                optionClause_";
  protected final String TEXT_550 = ".append(\"";
  protected final String TEXT_551 = "=";
  protected final String TEXT_552 = "\");";
  protected final String TEXT_553 = NL + "                optionClause_";
  protected final String TEXT_554 = ".append(\"";
  protected final String TEXT_555 = "='\"+";
  protected final String TEXT_556 = "+\"'\");";
  protected final String TEXT_557 = NL + "                optionClause_";
  protected final String TEXT_558 = ".append(\"";
  protected final String TEXT_559 = "=";
  protected final String TEXT_560 = "\");";
  protected final String TEXT_561 = NL + "                optionClause_";
  protected final String TEXT_562 = ".append(\"";
  protected final String TEXT_563 = "=\"+";
  protected final String TEXT_564 = ");";
  protected final String TEXT_565 = NL + "    optionClause_";
  protected final String TEXT_566 = ".append(\")\");";
  protected final String TEXT_567 = NL + "    String dataf_";
  protected final String TEXT_568 = " = ";
  protected final String TEXT_569 = " + Thread.currentThread().getId();" + NL + "" + NL + "    String ctlf_";
  protected final String TEXT_570 = " = dataf_";
  protected final String TEXT_571 = " + \".ctl\";" + NL + "" + NL + "    String badf_";
  protected final String TEXT_572 = " = dataf_";
  protected final String TEXT_573 = " + \".bad\";" + NL + "" + NL + "    String dscf_";
  protected final String TEXT_574 = " = dataf_";
  protected final String TEXT_575 = " + \".dsc\";" + NL + "" + NL + "    String logf_";
  protected final String TEXT_576 = " = dataf_";
  protected final String TEXT_577 = " + \".log\";" + NL + "" + NL + "    dataf_";
  protected final String TEXT_578 = " = ";
  protected final String TEXT_579 = ";" + NL + "" + NL + "    java.io.File badFile_";
  protected final String TEXT_580 = " = new java.io.File(badf_";
  protected final String TEXT_581 = ");" + NL + "" + NL + "    if(badFile_";
  protected final String TEXT_582 = ".exists()){" + NL + "" + NL + "        badFile_";
  protected final String TEXT_583 = ".delete();" + NL + "" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_584 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_585 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_586 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_587 = " ,false) ;" + NL + "" + NL + "    pw_";
  protected final String TEXT_588 = ".println(optionClause_";
  protected final String TEXT_589 = ".toString());" + NL + "" + NL + "    pw_";
  protected final String TEXT_590 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_591 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_592 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_593 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_594 = " + \"'\");" + NL;
  protected final String TEXT_595 = NL + "        bw_";
  protected final String TEXT_596 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_597 = NL + NL + NL;
  protected final String TEXT_598 = NL + "        bw_";
  protected final String TEXT_599 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_600 = " + \"'\\\"\");";
  protected final String TEXT_601 = NL + "        bw_";
  protected final String TEXT_602 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_603 = " + \"\\\"\");";
  protected final String TEXT_604 = NL + "        bw_";
  protected final String TEXT_605 = ".write(\" \\\"var \" + ";
  protected final String TEXT_606 = " + \"\\\"\");";
  protected final String TEXT_607 = NL + "    pw_";
  protected final String TEXT_608 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_609 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_610 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_611 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_612 = " + \"'\");";
  protected final String TEXT_613 = NL + "        pw_";
  protected final String TEXT_614 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_615 = NL + "        bw_";
  protected final String TEXT_616 = ".write(";
  protected final String TEXT_617 = ");";
  protected final String TEXT_618 = NL + "            pw_";
  protected final String TEXT_619 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_620 = ");" + NL + "            pw_";
  protected final String TEXT_621 = ".println(\"INSERT\");";
  protected final String TEXT_622 = NL + "            pw_";
  protected final String TEXT_623 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_624 = ");" + NL + "            pw_";
  protected final String TEXT_625 = ".println(\"";
  protected final String TEXT_626 = "\");";
  protected final String TEXT_627 = NL + "                pw_";
  protected final String TEXT_628 = ".println(\"WHEN \" + ";
  protected final String TEXT_629 = ");";
  protected final String TEXT_630 = NL + "            bw_";
  protected final String TEXT_631 = ".write(\"FIELDS TERMINATED BY ";
  protected final String TEXT_632 = "\");";
  protected final String TEXT_633 = NL + "            bw_";
  protected final String TEXT_634 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_635 = " + \"\\\"\");";
  protected final String TEXT_636 = NL + "                bw_";
  protected final String TEXT_637 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_638 = NL + "                bw_";
  protected final String TEXT_639 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_640 = NL + "            bw_";
  protected final String TEXT_641 = ".write(\"'\" + ";
  protected final String TEXT_642 = " + \"'\");";
  protected final String TEXT_643 = NL + "                bw_";
  protected final String TEXT_644 = ".write(\" AND '\" + ";
  protected final String TEXT_645 = " + \"'\");";
  protected final String TEXT_646 = NL + "            pw_";
  protected final String TEXT_647 = ".println(\"\");";
  protected final String TEXT_648 = NL + "            pw_";
  protected final String TEXT_649 = ".println(\"\");";
  protected final String TEXT_650 = NL + "            pw_";
  protected final String TEXT_651 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_652 = NL + "            pw_";
  protected final String TEXT_653 = ".println(\"";
  protected final String TEXT_654 = "\");";
  protected final String TEXT_655 = NL + "    bw_";
  protected final String TEXT_656 = ".close();" + NL + "    pw_";
  protected final String TEXT_657 = ".close();";
  protected final String TEXT_658 = NL + "String command_";
  protected final String TEXT_659 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_660 = " + \"/\" + dbPwd_";
  protected final String TEXT_661 = " + \"@\" + serviceUrl_";
  protected final String TEXT_662 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_663 = " + \"' LOG='\" + logf_";
  protected final String TEXT_664 = " + \"'\";" + NL + "String printableCommand_";
  protected final String TEXT_665 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_666 = " + \"/\" + \"....\" + \"@\" + serviceUrl_";
  protected final String TEXT_667 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_668 = " + \"' LOG='\" + logf_";
  protected final String TEXT_669 = " + \"'\";" + NL;
  protected final String TEXT_670 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_671 = " = conn_";
  protected final String TEXT_672 = ".createStatement();";
  protected final String TEXT_673 = NL + "        log.info(\"";
  protected final String TEXT_674 = " - Creating temp table ";
  protected final String TEXT_675 = "\" + tableName_";
  protected final String TEXT_676 = " + \"";
  protected final String TEXT_677 = ".\" );";
  protected final String TEXT_678 = NL + "    stmtCreateTmp_";
  protected final String TEXT_679 = ".execute(\"";
  protected final String TEXT_680 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_681 = ".close();";
  protected final String TEXT_682 = NL + "        log.info(\"";
  protected final String TEXT_683 = " - Create temp table ";
  protected final String TEXT_684 = "\" + tableName_";
  protected final String TEXT_685 = " + \"";
  protected final String TEXT_686 = " has succeeded.\");" + NL + "        log.info(\"";
  protected final String TEXT_687 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_688 = " + \"'.\");";
  protected final String TEXT_689 = NL + "    final Process process_";
  protected final String TEXT_690 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_691 = ");";
  protected final String TEXT_692 = NL + "        java.util.ArrayList<String> envParam_";
  protected final String TEXT_693 = "=new java.util.ArrayList<String>();" + NL + "        java.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_694 = " = System.getenv();" + NL + "        for (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_695 = ".entrySet())" + NL + "        {" + NL + "           envParam_";
  protected final String TEXT_696 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "        }";
  protected final String TEXT_697 = NL + "        envParam_";
  protected final String TEXT_698 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_699 = "\");";
  protected final String TEXT_700 = NL + "        envParam_";
  protected final String TEXT_701 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_702 = "\");";
  protected final String TEXT_703 = NL + "            envParam_";
  protected final String TEXT_704 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_705 = "\");";
  protected final String TEXT_706 = NL + "        envParam_";
  protected final String TEXT_707 = ".add(\"";
  protected final String TEXT_708 = "=";
  protected final String TEXT_709 = "\");";
  protected final String TEXT_710 = NL + "        log.info(\"";
  protected final String TEXT_711 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_712 = " + \"'.\");";
  protected final String TEXT_713 = NL + "    final Process process_";
  protected final String TEXT_714 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_715 = ",envParam_";
  protected final String TEXT_716 = ".toArray(new String[0]));";
  protected final String TEXT_717 = NL + NL + "//System.out.println(command_";
  protected final String TEXT_718 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_719 = " = new Thread() {" + NL + "    public void run() {" + NL + "        try {" + NL + "            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_720 = ".getInputStream()));" + NL + "            String line = \"\";" + NL + "            try {" + NL + "                while((line = reader.readLine()) != null) {";
  protected final String TEXT_721 = NL + "                        System.out.println(line);";
  protected final String TEXT_722 = NL + "                        globalMap.put(\"";
  protected final String TEXT_723 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_724 = "_OUTPUT\") + \"\\n\" + line);";
  protected final String TEXT_725 = NL + "                }" + NL + "            } finally {" + NL + "                 reader.close();" + NL + "            }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_726 = NL + "            ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_727 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_728 = " = new Thread() {" + NL + "    public void run() {" + NL + "       try {" + NL + "           java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_729 = ".getErrorStream()));" + NL + "           String line = \"\";" + NL + "           try {" + NL + "               while((line = reader.readLine()) != null) {" + NL + "                  globalMap.put(\"";
  protected final String TEXT_730 = "_SQLLOAD_ERROR\", \"true\");";
  protected final String TEXT_731 = NL + "                       System.err.println(line);";
  protected final String TEXT_732 = NL + "                       globalMap.put(\"";
  protected final String TEXT_733 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_734 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_735 = NL + "               }" + NL + "            } finally {" + NL + "                reader.close();" + NL + "            }" + NL + "        } catch(java.io.IOException ioe) {";
  protected final String TEXT_736 = NL + "           ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_737 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_738 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_739 = " = process_";
  protected final String TEXT_740 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_741 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_742 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_743 = "_SQLLOAD_ERROR\"))) {" + NL + "    throw new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_744 = "\" , globalMap);" + NL + "}";
  protected final String TEXT_745 = NL + "    log.info(\"";
  protected final String TEXT_746 = " - Excute command: '\" + printableCommand_";
  protected final String TEXT_747 = " + \"' has finished.\");" + NL + "    log.info(\"";
  protected final String TEXT_748 = " - Retrieving information from oracle log file: '\" + logf_";
  protected final String TEXT_749 = " + \"'.\");";
  protected final String TEXT_750 = NL + NL + "int nb_line_data_";
  protected final String TEXT_751 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_752 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_753 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_754 = " = 0;" + NL + "" + NL + "/*  1.get log file all lines count" + NL + "    2.get \"Total logical records read\" line number from file end." + NL + "    3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "" + NL + "//1" + NL + "" + NL + "class LogUtil_";
  protected final String TEXT_755 = "{" + NL + "    public int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "        int number=0;" + NL + "        java.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "        String tempLine = br.readLine();" + NL + "        if(tempLine!=null){" + NL + "            String str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "            boolean isNumber= pattern.matcher(str_number).matches();" + NL + "            if(isNumber){" + NL + "                number = Integer.parseInt(str_number);" + NL + "            }" + NL + "        }" + NL + "        return number;" + NL + "    }" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithDirect(String logf) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tjava.util.List<String> logLineList = new java.util.ArrayList<String>();" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tlogLineList.add(tempLine);" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "" + NL + "\t\tboolean isFirstEmptyLine = true;//Is the first empty line of empty block" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tint beforeNumLine = 0;" + NL + "\t\tfor(int i=logLineList.size()-1; i>=0; i--)" + NL + "\t\t{" + NL + "\t\t\ttempLine = logLineList.get(i);" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t}\t" + NL + "\t\t\telse if (isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t\tif(emptyLineNum==3){" + NL + "\t\t\t\t\tbeforeNumLine = i+1;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t" + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i <= beforeNumLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}\t" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithoutDirect(String logf, String tableName) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tint countLines =0;//log file lines count" + NL + "\t\tint lastTableLine = 0;//Line Number of the last table name" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tcountLines++;" + NL + "\t\t\tif(tempLine.toUpperCase().indexOf(\"TABLE \"+(tableName).toUpperCase())>-1){" + NL + "\t\t\t\tlastTableLine = countLines;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "\t\t//need new instance to readLine ." + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i<= lastTableLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}" + NL + "\t\tboolean isNumber=false;" + NL + "\t\ttempLine = lr.readLine();" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tboolean isFirstEmptyLine = false;//Is the first empty line of empty block" + NL + "\t\tfor (int i=lastTableLine+2; i<= countLines; i++) {" + NL + "\t\t\ttempLine = lr.readLine();" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tif(emptyLineNum==2){" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\tcontinue;//skip rows now empty" + NL + "\t\t\t}else if (!isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "" + NL + "LogUtil_";
  protected final String TEXT_756 = " lu_";
  protected final String TEXT_757 = " = new LogUtil_";
  protected final String TEXT_758 = "();" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_759 = " = null;" + NL + "try {" + NL + "\tif(isDirect_";
  protected final String TEXT_760 = "){" + NL + "\t\tlr_";
  protected final String TEXT_761 = " = lu_";
  protected final String TEXT_762 = ".parseLogFileWithDirect(logf_";
  protected final String TEXT_763 = ");\t\t" + NL + "\t}\t\t" + NL + "\telse{" + NL + "\t\tlr_";
  protected final String TEXT_764 = " = lu_";
  protected final String TEXT_765 = ".parseLogFileWithoutDirect(logf_";
  protected final String TEXT_766 = ", tableName_";
  protected final String TEXT_767 = ");\t" + NL + "\t}" + NL + "" + NL + "\tnb_line_data_";
  protected final String TEXT_768 = " = lu_";
  protected final String TEXT_769 = ".getNumber(lr_";
  protected final String TEXT_770 = ");//get the number of data line" + NL + "\tnb_line_bad_";
  protected final String TEXT_771 = " = lu_";
  protected final String TEXT_772 = ".getNumber(lr_";
  protected final String TEXT_773 = ");//get the number of reject data line" + NL + "\tnb_line_discarded_";
  protected final String TEXT_774 = " = lu_";
  protected final String TEXT_775 = ".getNumber(lr_";
  protected final String TEXT_776 = ");//get the number of discarded data line" + NL + "\tnb_line_inserted_";
  protected final String TEXT_777 = " = nb_line_data_";
  protected final String TEXT_778 = " - nb_line_bad_";
  protected final String TEXT_779 = " - nb_line_discarded_";
  protected final String TEXT_780 = ";" + NL + "} finally {" + NL + "\tlr_";
  protected final String TEXT_781 = ".close();" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_782 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_783 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_784 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_785 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_786 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_787 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_788 = "_RETURN_CODE\", exitCode_";
  protected final String TEXT_789 = ");";
  protected final String TEXT_790 = NL + "    log.info(\"";
  protected final String TEXT_791 = " - Retrieved number of line: \" + nb_line_data_";
  protected final String TEXT_792 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_793 = " - Retrieved number of bad line: \" + nb_line_bad_";
  protected final String TEXT_794 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_795 = " - Retrieved number of inserted line: \" + nb_line_inserted_";
  protected final String TEXT_796 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_797 = " - Retrieved information from oracle log file: '\" + logf_";
  protected final String TEXT_798 = " + \"' finish.\");";
