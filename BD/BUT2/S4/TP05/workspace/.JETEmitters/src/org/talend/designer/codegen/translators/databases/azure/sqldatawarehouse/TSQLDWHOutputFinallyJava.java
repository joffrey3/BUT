...
public class TSQLDWHOutputFinallyJava {
  ...
  protected final String TEXT_51 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tjava.sql.Connection ctn_";
  protected final String TEXT_52 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_53 = "\");" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\t\tif(!ctn_";
  protected final String TEXT_55 = ".getAutoCommit() && !ctn_";
  protected final String TEXT_56 = ".isClosed()) {" + NL + "                \t\tctn_";
  protected final String TEXT_57 = ".commit();" + NL + "                \t}" + NL + "            \t\t";
  protected final String TEXT_58 = NL + "            \t\t" + NL + "\t\t\t\t\tctn_";
  protected final String TEXT_59 = ".close();" + NL + "\t\t\t\t\t";
  protected final String TEXT_60 = NL + "\t\t\t\t} catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_61 = ") {" + NL + "\t\t\t\t\tString errorMessage_";
  protected final String TEXT_62 = " = \"failed to close the connection in ";
  protected final String TEXT_63 = " :\" + sqlEx_";
  protected final String TEXT_64 = ".getMessage();" + NL + "\t\t\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\t\tSystem.err.println(errorMessage_";
