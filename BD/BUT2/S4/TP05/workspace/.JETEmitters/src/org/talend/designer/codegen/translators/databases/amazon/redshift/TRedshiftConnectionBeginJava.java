...
public class TRedshiftConnectionBeginJava
{
  ...
  protected final String TEXT_28 = NL + "\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_29 = " = new java.io.FileWriter(";
  protected final String TEXT_30 = ", true);" + NL + "\t\t\t\tjava.io.PrintWriter logWriter_";
  protected final String TEXT_31 = " = new java.io.PrintWriter(output_";
  protected final String TEXT_32 = ",true);" + NL + "\t\t\t\tglobalMap.put(\"logWriter_";
  protected final String TEXT_33 = "\", logWriter_";
  protected final String TEXT_34 = ");" + NL + "\t\t\t\tjava.sql.DriverManager.setLogWriter(logWriter_";
  protected final String TEXT_35 = ");";
  protected final String TEXT_36 = NL + "\t\t\tStringBuilder sbuilder_";
  protected final String TEXT_37 = " = new StringBuilder();" + NL + "\t\t\tsbuilder_";
  protected final String TEXT_38 = ".append(\"jdbc:redshift://\").append(";
  protected final String TEXT_39 = ").append(\":\").append(";
  protected final String TEXT_40 = ").append(\"/\").append(";
  protected final String TEXT_41 = ").append(\"?loglevel=\").append(";
  protected final String TEXT_42 = ");";
  protected final String TEXT_43 = NL + "\t\t\t\tsbuilder_";
  protected final String TEXT_44 = ".append(\"&\").append(";
  protected final String TEXT_45 = ");";
  protected final String TEXT_46 = NL + "\t\t\tString url_";
  protected final String TEXT_47 = " = sbuilder_";
  protected final String TEXT_48 = ".toString();";
  protected final String TEXT_49 = NL + NL + "\t";
  protected final String TEXT_50 = NL + NL + "\tString dbUser_";
  ...
  protected final String TEXT_63 = NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_69 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_74 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_75 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_77 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_78 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_80 = " - Written records count: \" + nb_line_";
  protected final String TEXT_81 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_83 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_85 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_86 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_88 = " - Writing the record \" + nb_line_";
  protected final String TEXT_89 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_91 = " - Processing the record \" + nb_line_";
  protected final String TEXT_92 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_94 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_95 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_97 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_98 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_100 = " - Uses an existing connection ";
  ...
  protected final String TEXT_160 = NL + "\tglobalMap.put(\"schema_\" + \"";
  protected final String TEXT_161 = "\",";
  protected final String TEXT_162 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_\" + \"";
