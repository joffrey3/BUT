...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_52 = " = 0;" + NL + "int deletedCount_";
  ...
  protected final String TEXT_58 = NL + "        int updateKeyCount_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_61 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_62 = NL + "        int deleteKeyCount_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_65 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_66 = NL + NL + NL + "boolean whetherReject_";
  protected final String TEXT_67 = " = false;" + NL + "java.sql.Connection conn_";
  protected final String TEXT_68 = " = null;" + NL + "String dbschema_";
  ...
  protected final String TEXT_88 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_89 = NL + "\t    String url_";
  protected final String TEXT_90 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_91 = " + \":\" + ";
  protected final String TEXT_92 = " + \"/\" + ";
  protected final String TEXT_93 = ";";
  protected final String TEXT_94 = NL + "\t\tString url_";
  protected final String TEXT_95 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_96 = " + \":\" + ";
  protected final String TEXT_97 = " + \"/\" + ";
  protected final String TEXT_98 = " + \":\" + ";
  protected final String TEXT_99 = ";";
  protected final String TEXT_100 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\t";
  protected final String TEXT_101 = NL + "    dbUser_";
  ...
  protected final String TEXT_113 = ";" + NL + "" + NL + "    dbschema_";
  ...
  protected final String TEXT_135 = NL + "String tableName_";
  protected final String TEXT_136 = " = null;" + NL + "if(dbschema_";
  ...
  protected final String TEXT_161 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_162 = "));";
  protected final String TEXT_163 = NL + "                    stmtCreate_";
  protected final String TEXT_164 = ".execute(((\"";
  protected final String TEXT_165 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_177 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_198 = NL + "                    String keyCheckTable_";
  protected final String TEXT_199 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_206 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_209 = " + \"]\";";
  protected final String TEXT_210 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_211 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_212 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_213 = ")== null){//}";
  protected final String TEXT_214 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_217 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_218 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_219 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_220 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_221 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_284 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_352 = ".getTables(null, schemaForSearch_";
  ...
  protected final String TEXT_356 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_369 = ".equalsIgnoreCase(";
  protected final String TEXT_370 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_371 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_372 = ".close();";
  protected final String TEXT_373 = NL + "                                if(!whetherExist_";
  protected final String TEXT_374 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_425 = ".close();";
  ...
  protected final String TEXT_428 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_445 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_456 = ".createStatement();";
  protected final String TEXT_457 = NL + "                              stmtTrunc_";
  protected final String TEXT_458 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_465 = NL + "                if(!conn_";
  protected final String TEXT_466 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_467 = ".commit();" + NL + "                }";
  protected final String TEXT_468 = NL + "            deletedCount_";
  protected final String TEXT_469 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_498 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_523 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_538 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_539 = " = conn_";
  protected final String TEXT_540 = ".prepareStatement(insert_";
  protected final String TEXT_541 = ");" + NL + "\t    ";
  protected final String TEXT_542 = NL + "\t    String delete_";
  protected final String TEXT_543 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_547 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_600 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_601 = " {";
  protected final String TEXT_602 = NL + "\t\t\tvoid set";
  protected final String TEXT_603 = "_";
  protected final String TEXT_604 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_605 = "Struct ";
  protected final String TEXT_606 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  protected final String TEXT_607 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_608 = NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_609 = NL + "\t\t\t\tpstmtUpdate_";
  protected final String TEXT_610 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_611 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_612 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_618 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_619 = " setPrepareStatementUtil_";
  protected final String TEXT_620 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_621 = "();" + NL;
  protected final String TEXT_622 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_623 = " {";
  protected final String TEXT_624 = NL + "\t\t\tvoid assign_";
  protected final String TEXT_625 = "_";
  protected final String TEXT_626 = "(final ";
  protected final String TEXT_627 = "Struct ";
  protected final String TEXT_628 = ",final ";
  protected final String TEXT_629 = "Struct ";
  ...
  protected final String TEXT_638 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_639 = " dataPropagateUtil_";
  protected final String TEXT_640 = " = new DataPropagateUtil_";
