...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_181 = NL + "\tboolean bucketExist_";
  protected final String TEXT_182 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".doesBucketExist(";
  protected final String TEXT_185 = ");" + NL + "\t\t";
  protected final String TEXT_186 = "\t" + NL + "\t\t\tif(bucketExist_";
  protected final String TEXT_187 = "){" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_188 = " - Bucket \"+";
  protected final String TEXT_189 = "+\" exists.\");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_190 = " - Bucket \"+";
  protected final String TEXT_191 = "+\" does not exist.\");" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_193 = "){" + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_195 = ");" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_197 = " - \" + e_";
  protected final String TEXT_198 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_200 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_201 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_202 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_203 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_204 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_205 = "_BUCKET_NAME\", ";
  protected final String TEXT_206 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_207 = "_BUCKET_EXIST\", bucketExist_";
