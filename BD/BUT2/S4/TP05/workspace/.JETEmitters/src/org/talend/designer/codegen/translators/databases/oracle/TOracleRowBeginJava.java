...
public class TOracleRowBeginJava
{
  ...
  protected final String TEXT_123 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_124 = " + \":\" + ";
  protected final String TEXT_125 = " + \":\" + ";
  protected final String TEXT_126 = ";";
  protected final String TEXT_127 = NL + "\t\t\t\turl_";
  protected final String TEXT_128 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_129 = " + \")(port=\" + ";
  protected final String TEXT_130 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_131 = " + \")))\";";
  protected final String TEXT_132 = NL + "\t\t\t\turl_";
  protected final String TEXT_133 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_134 = ";";
  protected final String TEXT_135 = NL + "\t    \t\t\turl_";
  protected final String TEXT_136 = " = ";
  protected final String TEXT_137 = ";";
  protected final String TEXT_138 = NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  ...
  protected final String TEXT_144 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_145 = ") && !\"\".equals(";
  protected final String TEXT_146 = ")){" + NL + "                    atnParamsPrope_";
  protected final String TEXT_147 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_148 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "                }" + NL + "\t\t\t\tconn_";
  protected final String TEXT_149 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_150 = ", atnParamsPrope_";
  protected final String TEXT_151 = ");" + NL + "\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_153 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_155 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\tint nb_line_deleted_";
  protected final String TEXT_157 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_158 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_159 = " = null;" + NL + "\tString query_";
  protected final String TEXT_160 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_164 = ".prepareStatement(";
