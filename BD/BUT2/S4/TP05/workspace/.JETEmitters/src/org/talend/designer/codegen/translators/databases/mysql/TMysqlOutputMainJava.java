...
public class TMysqlOutputMainJava {
  ...
  protected final String TEXT_798 = ",java.sql.Types.CHAR);";
  ...
  protected final String TEXT_804 = ",java.sql.Types.DATE);";
  ...
  protected final String TEXT_810 = ",java.sql.Types.ARRAY);";
  ...
  protected final String TEXT_816 = ",java.sql.Types.INTEGER);";
  ...
  protected final String TEXT_822 = ",java.sql.Types.VARCHAR);";
  ...
  protected final String TEXT_828 = ",java.sql.Types.OTHER);";
  ...
  protected final String TEXT_834 = ",java.sql.Types.BOOLEAN);";
  ...
  protected final String TEXT_840 = ",java.sql.Types.DOUBLE);";
  ...
  protected final String TEXT_846 = ",java.sql.Types.FLOAT);";
  protected final String TEXT_847 = NL + "                }else{";
  protected final String TEXT_848 = NL + "                    if(";
  protected final String TEXT_849 = ".";
  protected final String TEXT_850 = "==null){";
  protected final String TEXT_851 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_852 = ".";
  protected final String TEXT_853 = ").toLowerCase())){";
  protected final String TEXT_854 = NL + "                ";
  protected final String TEXT_855 = ".setNull(counter";
  protected final String TEXT_856 = ",java.sql.Types.CHAR);" + NL + "" + NL + "                }else if(";
  protected final String TEXT_857 = ".";
  protected final String TEXT_858 = " == '\\0'){" + NL;
  protected final String TEXT_859 = NL + "                    ";
  protected final String TEXT_860 = ".setString(counter";
  protected final String TEXT_861 = ",\"\");" + NL + "" + NL + "                }else{" + NL;
  protected final String TEXT_862 = NL + "                    ";
  protected final String TEXT_863 = ".setString(counter";
  protected final String TEXT_864 = ",String.valueOf(";
  protected final String TEXT_865 = ".";
  protected final String TEXT_866 = "));" + NL + "                }";
  protected final String TEXT_867 = NL + "                if(";
  protected final String TEXT_868 = ".";
  protected final String TEXT_869 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_870 = " = ";
  protected final String TEXT_871 = ".";
  protected final String TEXT_872 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_873 = " < year1_";
  protected final String TEXT_874 = " || date_";
  protected final String TEXT_875 = " >= year10000_";
  protected final String TEXT_876 = ") {";
  protected final String TEXT_877 = NL + "                        ";
  protected final String TEXT_878 = ".setString(counter";
  protected final String TEXT_879 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_880 = NL + "                        ";
  protected final String TEXT_881 = ".setTimestamp(counter";
  protected final String TEXT_882 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_883 = "));" + NL + "                    }" + NL + "                }else{" + NL;
  protected final String TEXT_884 = NL + "                    ";
  protected final String TEXT_885 = ".setNull(counter";
  protected final String TEXT_886 = ",java.sql.Types.DATE);" + NL + "" + NL + "                }";
  protected final String TEXT_887 = NL + "                ";
  protected final String TEXT_888 = ".set";
  protected final String TEXT_889 = "(counter";
  protected final String TEXT_890 = ",";
  protected final String TEXT_891 = ".";
  protected final String TEXT_892 = ");";
  protected final String TEXT_893 = NL + NL + "                }" + NL;
  protected final String TEXT_894 = NL + "        query_";
  protected final String TEXT_895 = " = new StringBuffer(\"\");";
  protected final String TEXT_896 = NL + "                commitEvery_";
  protected final String TEXT_897 = " = buffersSize_";
  protected final String TEXT_898 = ";";
  protected final String TEXT_899 = NL + "                    batchSize_";
  protected final String TEXT_900 = " = buffersSize_";
  protected final String TEXT_901 = ";";
  protected final String TEXT_902 = NL;
  protected final String TEXT_903 = NL + "        whetherReject_";
  protected final String TEXT_904 = " = false;";
  protected final String TEXT_905 = NL + "                        int counter";
  protected final String TEXT_906 = " = rowCount";
  protected final String TEXT_907 = " * ";
  protected final String TEXT_908 = " + 1;";
  protected final String TEXT_909 = NL + "                            counter";
  protected final String TEXT_910 = "++;";
  protected final String TEXT_911 = NL + "                            int count_dyn_";
  protected final String TEXT_912 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_913 = ".";
  protected final String TEXT_914 = ", pstmt_";
  protected final String TEXT_915 = ", counter";
  protected final String TEXT_916 = "-1, \"";
  protected final String TEXT_917 = "\");" + NL + "                            counter";
  protected final String TEXT_918 = "+=count_dyn_";
  protected final String TEXT_919 = ";";
  protected final String TEXT_920 = NL + NL + "                    exInsertColValue";
  protected final String TEXT_921 = " = new BufferLine_";
  ...
  protected final String TEXT_936 = "){" + NL + "                        try{" + NL + "                            insertedCount_";
  protected final String TEXT_937 = " = insertedCount_";
  protected final String TEXT_938 = " + pstmt_";
  protected final String TEXT_939 = ".executeUpdate();" + NL + "                        }catch(java.lang.Exception e){";
  protected final String TEXT_940 = NL + "                             throw e;";
  protected final String TEXT_941 = NL + "                             System.err.println(e.getMessage());";
  protected final String TEXT_942 = NL + "                        }" + NL + "                        exInsertColValueList";
  protected final String TEXT_943 = ".clear();" + NL + "                        rowCount";
  protected final String TEXT_944 = " = 0;" + NL + "                        counter";
  protected final String TEXT_945 = "=1;" + NL + "                    }";
  ...
  protected final String TEXT_965 = NL + "                    pstmt_";
  protected final String TEXT_966 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_967 = "++;" + NL;
  protected final String TEXT_968 = NL + "                      batchSizeCounter_";
  protected final String TEXT_969 = "++;";
  protected final String TEXT_970 = NL + "                    try {" + NL + "                        nb_line_";
  ...
  protected final String TEXT_974 = ".executeUpdate();";
  ...
  protected final String TEXT_980 = "Struct();";
  ...
  protected final String TEXT_1000 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1001 = ",";
  protected final String TEXT_1002 = ".";
  protected final String TEXT_1003 = ", ";
  protected final String TEXT_1004 = ",insertSQLSplits_";
  protected final String TEXT_1005 = ");";
  protected final String TEXT_1006 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1007 = ".";
  protected final String TEXT_1008 = ", pstmt_";
  protected final String TEXT_1009 = ", ";
  protected final String TEXT_1010 = ", \"";
  protected final String TEXT_1011 = "\");";
  protected final String TEXT_1012 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1013 = "_QUERY\", query_";
  protected final String TEXT_1014 = ".toString().trim());";
  protected final String TEXT_1015 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_1016 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_1017 = " = insertedCount_";
  protected final String TEXT_1018 = " + pstmt_";
  protected final String TEXT_1019 = ".executeUpdate();";
  protected final String TEXT_1020 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1021 = " = true;";
  protected final String TEXT_1022 = NL + "                        throw(e);";
  protected final String TEXT_1023 = NL + "                            ";
  protected final String TEXT_1024 = " = new ";
  protected final String TEXT_1025 = "Struct();";
  protected final String TEXT_1026 = NL + "                                ";
  protected final String TEXT_1027 = ".";
  protected final String TEXT_1028 = " = ";
  protected final String TEXT_1029 = ".";
  protected final String TEXT_1030 = ";";
  protected final String TEXT_1031 = NL + "                            rejectedCount_";
  protected final String TEXT_1032 = " =  rejectedCount_";
  protected final String TEXT_1033 = "+ 1;";
  protected final String TEXT_1034 = NL + "                            ";
  protected final String TEXT_1035 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_1074 = NL + "                globalMap.put(\"";
  protected final String TEXT_1075 = "_QUERY\", query_";
  protected final String TEXT_1076 = ".toString().trim());";
  protected final String TEXT_1077 = NL;
  protected final String TEXT_1078 = NL + "            pstmt_";
  protected final String TEXT_1079 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1080 = "++;" + NL;
  protected final String TEXT_1081 = NL + "              batchSizeCounter_";
  protected final String TEXT_1082 = "++;";
  protected final String TEXT_1083 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_1084 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_1085 = " = updatedCount_";
  protected final String TEXT_1086 = " + pstmt_";
  protected final String TEXT_1087 = ".executeUpdate();";
  protected final String TEXT_1088 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1089 = " = true;";
  protected final String TEXT_1090 = NL + "                    throw(e);";
  protected final String TEXT_1091 = NL + "                        ";
  protected final String TEXT_1092 = " = new ";
  protected final String TEXT_1093 = "Struct();";
  protected final String TEXT_1094 = NL + "                            ";
  protected final String TEXT_1095 = ".";
  protected final String TEXT_1096 = " = ";
  protected final String TEXT_1097 = ".";
  protected final String TEXT_1098 = ";";
  protected final String TEXT_1099 = NL + "                        rejectedCount_";
  protected final String TEXT_1100 = " =  rejectedCount_";
  protected final String TEXT_1101 = "+ 1;";
  protected final String TEXT_1102 = NL + "                        ";
  protected final String TEXT_1103 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1104 = NL + "                        ";
  protected final String TEXT_1105 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1106 = ";";
  protected final String TEXT_1107 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1108 = NL + "            }";
  protected final String TEXT_1109 = NL + "                        ";
  protected final String TEXT_1110 = NL + "                    ";
  protected final String TEXT_1111 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_1112 = " = pstmt_";
  protected final String TEXT_1113 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_1114 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_1115 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_1116 = " = rs_";
  protected final String TEXT_1117 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_1118 = " > 0) {";
  ...
  protected final String TEXT_1151 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1152 = "_QUERY\", query_";
  protected final String TEXT_1153 = ".toString().trim());";
  protected final String TEXT_1154 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_1155 = " = updatedCount_";
  protected final String TEXT_1156 = " + pstmtUpdate_";
  protected final String TEXT_1157 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1158 = "++;";
  protected final String TEXT_1159 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1160 = " = true;";
  protected final String TEXT_1161 = NL + "                        throw(e);";
  protected final String TEXT_1162 = NL + "                        nb_line_";
  protected final String TEXT_1163 = "++;";
  protected final String TEXT_1164 = NL + "                        ";
  protected final String TEXT_1165 = " = new ";
  protected final String TEXT_1166 = "Struct();";
  protected final String TEXT_1167 = NL + "                                ";
  protected final String TEXT_1168 = ".";
  protected final String TEXT_1169 = " = ";
  protected final String TEXT_1170 = ".";
  protected final String TEXT_1171 = ";";
  protected final String TEXT_1172 = NL + "                            rejectedCount_";
  protected final String TEXT_1173 = " =  rejectedCount_";
  protected final String TEXT_1174 = "+ 1;";
  protected final String TEXT_1175 = NL + "                            ";
  protected final String TEXT_1176 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1177 = NL + "                            ";
  protected final String TEXT_1178 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1179 = ";";
  protected final String TEXT_1180 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1181 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_1230 = "=0;";
  ...
  protected final String TEXT_1235 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1236 = ",";
  protected final String TEXT_1237 = ".";
  protected final String TEXT_1238 = ", ";
  protected final String TEXT_1239 = ",updateSQLSplits_";
  protected final String TEXT_1240 = ");";
  protected final String TEXT_1241 = NL + NL + "                    int count_";
  protected final String TEXT_1242 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1243 = ".";
  protected final String TEXT_1244 = ", pstmtUpdate_";
  ...
  protected final String TEXT_1264 = NL + "                globalMap.put(\"";
  protected final String TEXT_1265 = "_QUERY\", query_";
  protected final String TEXT_1266 = ".toString().trim());";
  protected final String TEXT_1267 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_1268 = "=pstmtUpdate_";
  protected final String TEXT_1269 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1270 = " = updatedCount_";
  protected final String TEXT_1271 = "+updateFlag_";
  protected final String TEXT_1272 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_1273 = " == 0) {" + NL;
  protected final String TEXT_1274 = NL + "                query_";
  protected final String TEXT_1275 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_1280 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1281 = ",";
  protected final String TEXT_1282 = ".";
  protected final String TEXT_1283 = ", ";
  protected final String TEXT_1284 = ",insertSQLSplits_";
  protected final String TEXT_1285 = ");";
  protected final String TEXT_1286 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1287 = ".";
  protected final String TEXT_1288 = ", pstmtInsert_";
  ...
  protected final String TEXT_1295 = NL + "                    insertedCount_";
  protected final String TEXT_1296 = " = insertedCount_";
  protected final String TEXT_1297 = " + pstmtInsert_";
  protected final String TEXT_1298 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1299 = "++;";
  protected final String TEXT_1300 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_1301 = "++;";
  protected final String TEXT_1302 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1303 = " = true;";
  protected final String TEXT_1304 = NL + "                        throw(e);";
  protected final String TEXT_1305 = NL + "                        nb_line_";
  protected final String TEXT_1306 = "++;";
  protected final String TEXT_1307 = NL + "                        ";
  protected final String TEXT_1308 = " = new ";
  protected final String TEXT_1309 = "Struct();";
  ...
  protected final String TEXT_1315 = NL + "                            rejectedCount_";
  protected final String TEXT_1316 = " =  rejectedCount_";
  protected final String TEXT_1317 = "+ 1;";
  protected final String TEXT_1318 = NL + "                            ";
  protected final String TEXT_1319 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1320 = NL + "                            ";
  protected final String TEXT_1321 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1322 = ";";
  protected final String TEXT_1323 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1324 = NL + "                }";
  protected final String TEXT_1325 = NL + "                        ";
  protected final String TEXT_1326 = NL + "                            query_";
  protected final String TEXT_1327 = " = ";
  protected final String TEXT_1328 = ";";
  protected final String TEXT_1329 = NL + "                    ";
  protected final String TEXT_1330 = NL + "                        query_";
  protected final String TEXT_1331 = " = ";
  protected final String TEXT_1332 = ";";
  protected final String TEXT_1333 = NL + "                globalMap.put(\"";
  protected final String TEXT_1334 = "_QUERY\", query_";
  protected final String TEXT_1335 = ".toString().trim());";
  protected final String TEXT_1336 = NL + "            pstmt_";
  protected final String TEXT_1337 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1338 = "++;";
  protected final String TEXT_1339 = NL + "              batchSizeCounter_";
  protected final String TEXT_1340 = "++;";
  protected final String TEXT_1341 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1342 = " = deletedCount_";
  protected final String TEXT_1343 = " + pstmt_";
  protected final String TEXT_1344 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1345 = "++;";
  protected final String TEXT_1346 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1347 = " = true;";
  protected final String TEXT_1348 = NL + "                    throw(e);";
  protected final String TEXT_1349 = NL + "                    nb_line_";
  protected final String TEXT_1350 = "++;";
  protected final String TEXT_1351 = NL + "                        ";
  protected final String TEXT_1352 = " = new ";
  protected final String TEXT_1353 = "Struct();";
  ...
  protected final String TEXT_1359 = NL + "                        rejectedCount_";
  protected final String TEXT_1360 = " =  rejectedCount_";
  protected final String TEXT_1361 = "+ 1;";
  protected final String TEXT_1362 = NL + "                        ";
  protected final String TEXT_1363 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_1370 = NL + "                        query_";
  protected final String TEXT_1371 = " = ";
  protected final String TEXT_1372 = ";";
  protected final String TEXT_1373 = NL + "                globalMap.put(\"";
  protected final String TEXT_1374 = "_QUERY\", query_";
  protected final String TEXT_1375 = ".toString().trim());";
  protected final String TEXT_1376 = NL + "            int replaceCount_";
  protected final String TEXT_1377 = " = 0;" + NL + "            try {" + NL + "                replaceCount_";
  protected final String TEXT_1378 = " = pstmt_";
  protected final String TEXT_1379 = ".executeUpdate();";
  protected final String TEXT_1380 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1381 = " = true;";
  ...
  protected final String TEXT_1400 = NL + "            }" + NL + "            if(replaceCount_";
  protected final String TEXT_1401 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1402 = " += replaceCount_";
  protected final String TEXT_1403 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1404 = " += 1;" + NL + "                deletedCount_";
  protected final String TEXT_1405 = " += replaceCount_";
  protected final String TEXT_1406 = " - 1;" + NL + "            }";
  protected final String TEXT_1407 = NL + "                    ";
  protected final String TEXT_1408 = NL + "                        query_";
  protected final String TEXT_1409 = " = ";
  protected final String TEXT_1410 = ";";
  protected final String TEXT_1411 = NL + "                    ";
  protected final String TEXT_1412 = NL + "                        query_";
  protected final String TEXT_1413 = " = ";
  protected final String TEXT_1414 = ";";
  protected final String TEXT_1415 = NL + "                globalMap.put(\"";
  protected final String TEXT_1416 = "_QUERY\", query_";
  protected final String TEXT_1417 = ".toString().trim());";
  protected final String TEXT_1418 = NL + "            int count_on_duplicate_key_";
  protected final String TEXT_1419 = " = 0;" + NL + "            try {" + NL + "                count_on_duplicate_key_";
  protected final String TEXT_1420 = " = pstmt_";
  protected final String TEXT_1421 = ".executeUpdate();";
  protected final String TEXT_1422 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1423 = " = true;";
  protected final String TEXT_1424 = NL + "                    throw(e);";
  protected final String TEXT_1425 = NL + "                        ";
  protected final String TEXT_1426 = " = new ";
  protected final String TEXT_1427 = "Struct();";
  ...
  protected final String TEXT_1433 = NL + "                        rejectedCount_";
  protected final String TEXT_1434 = " =  rejectedCount_";
  protected final String TEXT_1435 = "+ 1;";
  protected final String TEXT_1436 = NL + "                        ";
  protected final String TEXT_1437 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1438 = NL + "                        ";
  protected final String TEXT_1439 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1440 = ";";
  protected final String TEXT_1441 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1442 = NL + "            }" + NL + "            if(count_on_duplicate_key_";
  protected final String TEXT_1443 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1444 = " += count_on_duplicate_key_";
  protected final String TEXT_1445 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1446 = " += 1;" + NL + "                updatedCount_";
  protected final String TEXT_1447 = " += count_on_duplicate_key_";
  protected final String TEXT_1448 = " - 1;" + NL + "            }";
  protected final String TEXT_1449 = NL + "                        ";
  protected final String TEXT_1450 = NL + "                            query_";
  protected final String TEXT_1451 = " = ";
  protected final String TEXT_1452 = ";";
  protected final String TEXT_1453 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1454 = "_QUERY\", query_";
  protected final String TEXT_1455 = ".toString().trim());";
  protected final String TEXT_1456 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_1457 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_1458 = " = insertedCount_";
  protected final String TEXT_1459 = " + pstmt_";
  protected final String TEXT_1460 = ".executeUpdate();";
  protected final String TEXT_1461 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1462 = " = true;";
  protected final String TEXT_1463 = NL + "                        throw(e);";
  protected final String TEXT_1464 = NL + "                            ";
  protected final String TEXT_1465 = " = new ";
  protected final String TEXT_1466 = "Struct();";
  ...
  protected final String TEXT_1472 = NL + "                            rejectedCount_";
  protected final String TEXT_1473 = " =  rejectedCount_";
  protected final String TEXT_1474 = "+ 1;";
  protected final String TEXT_1475 = NL + "                            ";
  protected final String TEXT_1476 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1477 = NL + "                            ";
  protected final String TEXT_1478 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1479 = ";";
  protected final String TEXT_1480 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1481 = NL + "                }";
  protected final String TEXT_1482 = NL + "            if(!whetherReject_";
  protected final String TEXT_1483 = ") {";
  protected final String TEXT_1484 = NL + "                            ";
  protected final String TEXT_1485 = " = new ";
  protected final String TEXT_1486 = "Struct();";
  ...
  protected final String TEXT_1493 = NL + "                if ( batchSize_";
  protected final String TEXT_1494 = " <= batchSizeCounter_";
  protected final String TEXT_1495 = ") {";
  protected final String TEXT_1496 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1497 = " = 0;";
  protected final String TEXT_1498 = NL + "                        for(int countEach_";
  protected final String TEXT_1499 = ": pstmt_";
  protected final String TEXT_1500 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_1501 = " += (countEach_";
  protected final String TEXT_1502 = " < 0 ? 0 : 1);" + NL + "                        }";
  protected final String TEXT_1503 = NL + "                        insertedCount_";
  protected final String TEXT_1504 = " += countSum_";
  protected final String TEXT_1505 = ";";
  protected final String TEXT_1506 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1507 = NL + "                        throw(e);";
  protected final String TEXT_1508 = NL + "                    int countSum_";
  protected final String TEXT_1509 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1510 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_1511 = " += (countEach_";
  protected final String TEXT_1512 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1513 = ");" + NL + "                    }";
  protected final String TEXT_1514 = NL + "                    insertedCount_";
  protected final String TEXT_1515 = " += countSum_";
  protected final String TEXT_1516 = ";";
  protected final String TEXT_1517 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1518 = NL + "                }";
  protected final String TEXT_1519 = NL + NL + "                batchSizeCounter_";
  protected final String TEXT_1520 = " = 0;" + NL + "            }";
  protected final String TEXT_1521 = NL + "                if ( batchSize_";
  protected final String TEXT_1522 = " <= batchSizeCounter_";
  protected final String TEXT_1523 = ") {";
  protected final String TEXT_1524 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1525 = " = 0;";
  protected final String TEXT_1526 = NL + "                        for(int countEach_";
  protected final String TEXT_1527 = ": pstmt_";
  protected final String TEXT_1528 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1538 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1539 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1540 = NL + "                        throw(e);";
  protected final String TEXT_1541 = NL + "                    int countSum_";
  protected final String TEXT_1542 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1543 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_1544 = " += (countEach_";
  protected final String TEXT_1545 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1553 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1554 = NL + "                }";
  protected final String TEXT_1555 = NL + NL + NL + NL + "                }";
  protected final String TEXT_1556 = NL + "                commitCounter_";
  protected final String TEXT_1557 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_1558 = " <= commitCounter_";
  protected final String TEXT_1559 = ") {" + NL;
  protected final String TEXT_1560 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1561 = " = 0;";
  ...
  protected final String TEXT_1577 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1578 = NL + "                        throw(e);";
  protected final String TEXT_1579 = NL + "                    int countSum_";
  protected final String TEXT_1580 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_1581 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_1582 = " += (countEach_";
  protected final String TEXT_1583 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1594 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1595 = NL + NL + "                }";
  protected final String TEXT_1596 = NL + "                    conn_";
  protected final String TEXT_1597 = ".commit();";
  protected final String TEXT_1598 = NL + "                    commitCounter_";
  protected final String TEXT_1599 = "=0;" + NL + "" + NL + "                }" + NL;
