...
public class TMDMWriteConfBeginJava
{
  ...
  protected final String TEXT_183 = " == null){" + NL + "                if((Boolean)globalMap.get(\"useClientTranId_";
  protected final String TEXT_184 = "\")){" + NL + "                    List<String> cookies_";
  protected final String TEXT_185 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getCookies(turl_";
  protected final String TEXT_186 = ",username_";
  protected final String TEXT_187 = ",password_";
  protected final String TEXT_188 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_189 = " = new com.talend.mdm.transaction.client.MDMTransaction();" + NL + "                    mdmTransaction_";
  protected final String TEXT_190 = ".setUrl(turl_";
  protected final String TEXT_191 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_192 = ".setId(\"";
  protected final String TEXT_193 = "_\" + java.util.UUID.randomUUID());" + NL + "                    mdmTransaction_";
  protected final String TEXT_194 = ".setUsername(username_";
  protected final String TEXT_195 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_196 = ".setPassword(password_";
  protected final String TEXT_197 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_198 = ".setCookies(cookies_";
  protected final String TEXT_199 = ");" + NL + "                }else{";
  protected final String TEXT_200 = NL + "                    mdmTransaction_";
  protected final String TEXT_201 = " = com.talend.mdm.transaction.client.MDMTransactionClient.newTransaction(turl_";
  protected final String TEXT_202 = ",username_";
  protected final String TEXT_203 = ",password_";
  protected final String TEXT_204 = ");" + NL + "                }" + NL + "                java.util.List<org.apache.cxf.headers.Header> soapHeaders_";
  protected final String TEXT_205 = " = new java.util.ArrayList<org.apache.cxf.headers.Header>();" + NL + "                javax.xml.namespace.QName qName_";
  protected final String TEXT_206 = " = new javax.xml.namespace.QName(\"http://www.talend.com/mdm\", \"transaction-id\");" + NL + "                org.apache.cxf.databinding.DataBinding dataBinding_";
  protected final String TEXT_207 = " = new org.apache.cxf.jaxb.JAXBDataBinding(String.class);" + NL + "                soapHeaders_";
  protected final String TEXT_208 = ".add(new org.apache.cxf.headers.Header(qName_";
  protected final String TEXT_209 = ", mdmTransaction_";
  protected final String TEXT_210 = ".getId(), dataBinding_";
  protected final String TEXT_211 = "));" + NL + "                context_";
  protected final String TEXT_212 = ".put(org.apache.cxf.headers.Header.HEADER_LIST, soapHeaders_";
  protected final String TEXT_213 = ");" + NL + "" + NL + "                java.util.Map<String, java.util.List<String>> httpHeaders_";
  protected final String TEXT_214 = " = new java.util.HashMap<String, java.util.List<String>>();" + NL + "                httpHeaders_";
  protected final String TEXT_215 = ".put(\"Cookie\", mdmTransaction_";
  protected final String TEXT_216 = ".getCookies());" + NL + "                context_";
  protected final String TEXT_217 = ".put(org.apache.cxf.message.Message.PROTOCOL_HEADERS, httpHeaders_";
  protected final String TEXT_218 = ");" + NL + "" + NL + "                globalMap.put(transKey_";
  protected final String TEXT_219 = ", mdmTransaction_";
  protected final String TEXT_220 = ");";
  protected final String TEXT_221 = NL + "            }" + NL + "        }" + NL + "        service_";
  protected final String TEXT_222 = ".ping(new org.talend.mdm.webservice.WSPing());";
  protected final String TEXT_223 = NL + "        globalMap.put(connKey_";
  protected final String TEXT_224 = ", service_";
  protected final String TEXT_225 = ");" + NL + "    }";
  protected final String TEXT_226 = NL + NL + "org.talend.mdm.webservice.WSDataClusterPK dataCluster_";
  protected final String TEXT_227 = " = new org.talend.mdm.webservice.WSDataClusterPK(";
  protected final String TEXT_228 = " + \"";
  protected final String TEXT_229 = "\");" + NL + "org.talend.mdm.webservice.WSDataModelPK dataModel_";
  protected final String TEXT_230 = " = new org.talend.mdm.webservice.WSDataModelPK(";
  protected final String TEXT_231 = ");" + NL + "" + NL + "String input_";
  protected final String TEXT_232 = ";" + NL + "" + NL + "java.util.List<org.talend.mdm.webservice.WSItemPK> wspks_";
  protected final String TEXT_233 = ";" + NL + "org.talend.mdm.webservice.WSItemPK wspk_";
  protected final String TEXT_234 = ";" + NL;
  protected final String TEXT_235 = NL + "    java.util.Queue<String> queue_";
  protected final String TEXT_236 = " = new java.util.concurrent.ConcurrentLinkedQueue<String>();";
  protected final String TEXT_237 = NL + "        java.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_238 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<java.util.Map<String,String>>());" + NL + "        int flowNum_";
  protected final String TEXT_239 = " = 0;";
  protected final String TEXT_240 = NL + "    class ThreadXMLField_";
  protected final String TEXT_241 = " extends Thread {" + NL + "        java.util.Queue<String> queue;" + NL + "        java.util.List<java.util.Map<String,String>> flows;" + NL + "        java.lang.Exception lastException;" + NL + "        String currentComponent;" + NL + "" + NL + "        ThreadXMLField_";
  protected final String TEXT_242 = "(java.util.Queue q) {" + NL + "            this.queue = q;" + NL + "            globalMap.put(\"queue_";
  protected final String TEXT_243 = "\", queue);" + NL + "            lastException = null;" + NL + "        }" + NL + "" + NL + "        ThreadXMLField_";
  protected final String TEXT_244 = "(java.util.Queue q, java.util.List<java.util.Map<String,String>> l) {" + NL + "            this.queue = q;" + NL + "            this.flows = l;" + NL + "            lastException = null;" + NL + "            globalMap.put(\"queue_";
  protected final String TEXT_245 = "\", queue);" + NL + "            globalMap.put(\"flows_";
  protected final String TEXT_246 = "\", flows);" + NL + "        }" + NL + "" + NL + "        public java.lang.Exception getLastException() {" + NL + "            return this.lastException;" + NL + "        }" + NL + "        public String getCurrentComponent() {" + NL + "            return this.currentComponent;" + NL + "        }" + NL + "" + NL + "        @Override" + NL + "        public void run() {" + NL + "            try {";
  protected final String TEXT_247 = NL + "                ";
  protected final String TEXT_248 = "Process(globalMap);" + NL + "            } catch (TalendException te) {" + NL + "                this.lastException = te.getException();" + NL + "                this.currentComponent = te.getCurrentComponent();" + NL + "                globalMap.put(\"";
  protected final String TEXT_249 = "_FINISH\" + (this.queue==null?\"\":this.queue.hashCode()), \"true\");" + NL + "            }" + NL + "        }" + NL + "    }";
  protected final String TEXT_250 = NL + "        ThreadXMLField_";
  protected final String TEXT_251 = " txf_";
  protected final String TEXT_252 = " = new ThreadXMLField_";
  protected final String TEXT_253 = "(queue_";
  protected final String TEXT_254 = ", xmlFlowList_";
  protected final String TEXT_255 = ");";
  protected final String TEXT_256 = NL + "        ThreadXMLField_";
  protected final String TEXT_257 = " txf_";
  protected final String TEXT_258 = " = new ThreadXMLField_";
  protected final String TEXT_259 = "(queue_";
  protected final String TEXT_260 = ");";
  protected final String TEXT_261 = NL + "    txf_";
  protected final String TEXT_262 = ".start();";
  protected final String TEXT_263 = NL + "        java.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_264 = " = (java.util.List<java.util.Map<String,String>>)globalMap.get(\"flows_";
  protected final String TEXT_265 = "\");" + NL + "        int flowNum_";
  protected final String TEXT_266 = " = 0;";
  protected final String TEXT_267 = NL + "    java.util.Queue<String> queue_";
  protected final String TEXT_268 = " = (java.util.Queue<String>) globalMap.get(\"queue_";
  protected final String TEXT_269 = "\");";
  protected final String TEXT_270 = NL + "    String readFinishMarkWithPipeId_";
  protected final String TEXT_271 = " = \"";
  protected final String TEXT_272 = "_FINISH\"+(queue_";
  protected final String TEXT_273 = "==null?\"\":queue_";
  protected final String TEXT_274 = ".hashCode());" + NL + "    while(!globalMap.containsKey(readFinishMarkWithPipeId_";
  protected final String TEXT_275 = ") || !queue_";
  protected final String TEXT_276 = ".isEmpty()) {" + NL + "        if (!queue_";
  protected final String TEXT_277 = ".isEmpty()) {";
