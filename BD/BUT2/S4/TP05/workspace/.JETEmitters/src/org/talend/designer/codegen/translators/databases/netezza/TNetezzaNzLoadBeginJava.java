...
public class TNetezzaNzLoadBeginJava {
  ...
  protected final String TEXT_278 = " = new StringBuilder(200);" + NL + "\tfinal java.util.concurrent.atomic.AtomicInteger nb_line_";
  protected final String TEXT_279 = " = new java.util.concurrent.atomic.AtomicInteger();" + NL + "\t//final " + NL + "\t";
  protected final String TEXT_280 = NL + "    ";
  protected final String TEXT_281 = " " + NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_282 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_283 = ");";
  protected final String TEXT_284 = NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_285 = " = ";
  protected final String TEXT_286 = "; ";
  protected final String TEXT_287 = NL + "\t" + NL + "\tThread nzloadThread_";
  protected final String TEXT_288 = " = new Thread() {" + NL + "\t\tpublic void run() {";
  protected final String TEXT_289 = NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_290 = " ";
  protected final String TEXT_291 = ",";
  protected final String TEXT_292 = "};" + NL + "\t\t\t\t" + NL + "\t\t\t\t// added \"print command\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_293 = NL + "\t\t\t\t    System.out.println(\"INFO: executing nzload command:\");" + NL + "\t\t\t\t    for( String cmd : cmds ) {" + NL + "\t\t\t\t\t       System.out.print(cmd + \" \");" + NL + "\t\t\t\t\t }" + NL + "\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\t" + NL + "\t\t\t\tps.waitFor();" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\t// fixed no showing of error messages" + NL + "\t\t\t\tjava.io.BufferedReader errReader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getErrorStream()));" + NL + "\t\t\t\t" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\tString errLine = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_295 = ".append(line);";
  protected final String TEXT_296 = NL + "\t\t\t\t\t\tlog.info(line);";
  protected final String TEXT_297 = NL + "\t\t\t\t\t\tSystem.out.println(line);";
  protected final String TEXT_298 = NL + "\t\t\t\t}" + NL + "\t\t\t\twhile((errLine = errReader.readLine()) != null) {" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_299 = ".append(errLine);";
  protected final String TEXT_300 = NL + "\t\t\t\t\t\tlog.error(errLine);";
  protected final String TEXT_301 = NL + "\t\t\t\t\t\tSystem.err.println(errLine);";
  protected final String TEXT_302 = NL + "\t\t\t\t}";
  protected final String TEXT_303 = NL + "\t\t\t\tnb_line_";
  protected final String TEXT_304 = ".set(getProcessedRowsCount(";
  protected final String TEXT_305 = "));" + NL + "" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_306 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tprivate int getProcessedRowsCount(String pathToLogFile) {" + NL + "\t\t\tint processedRowsCount = 0;" + NL + "\t\t\ttry (org.apache.commons.io.input.ReversedLinesFileReader reversedLinesFileReader_";
  protected final String TEXT_307 = " = new org.apache.commons.io.input.ReversedLinesFileReader(new java.io.File(pathToLogFile))) {" + NL + "\t\t\t\tString logLine = null;" + NL + "\t\t\t\twhile(null != (logLine = reversedLinesFileReader_";
  protected final String TEXT_308 = ".readLine())) {" + NL + "\t\t\t\t\tif (logLine.contains(\"  number of records read:\")) {" + NL + "\t\t\t\t\t\tprocessedRowsCount = Integer.parseInt(logLine.split(\":\")[1].trim());" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch(IOException e) {";
  protected final String TEXT_309 = NL + "\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_310 = "\");";
  protected final String TEXT_311 = NL + "\t\t\t\t\tSystem.err.println(\"";
  protected final String TEXT_312 = "\");";
  protected final String TEXT_313 = NL + "\t\t\t\treturn 0;" + NL + "\t\t\t}" + NL + "\t\t\treturn processedRowsCount;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t};" + NL + "\t";
  protected final String TEXT_314 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_315 = " = new StringBuffer(";
  protected final String TEXT_316 = ");" + NL + "\t\t";
  protected final String TEXT_317 = NL + "\t\t\tcommand_";
  protected final String TEXT_318 = ".append(";
  protected final String TEXT_319 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_320 = NL + "\t";
  protected final String TEXT_321 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_322 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_323 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_324 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_325 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_326 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_327 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_328 = NL + "\t\t";
  protected final String TEXT_329 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_330 = " - Executing '\"+command_";
  protected final String TEXT_331 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_332 = NL + "\t\tnzloadThread_";
  protected final String TEXT_333 = ".start();" + NL + "\t\tnzloadThread_";
  protected final String TEXT_334 = ".join(0);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_335 = "_NB_LINE\", nb_line_";
  protected final String TEXT_336 = ".get());" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_337 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_338 = ".toString());" + NL + "\t\t";
  protected final String TEXT_339 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_340 = " - Execute '\"+command_";
  protected final String TEXT_341 = ".toString()+\"' has finished.\");" + NL + "\t\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(actualLogFilePath);
