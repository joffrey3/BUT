...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_180 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_191 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_192 = " =  conn_";
  protected final String TEXT_193 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_194 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_195 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_196 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  ...
  protected final String TEXT_199 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_200 = NL + "               ";
  protected final String TEXT_201 = " + \"=\" + ";
  protected final String TEXT_202 = " + \";\" +";
  protected final String TEXT_203 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_204 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "\t\t    ";
  protected final String TEXT_207 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_208 = " = ";
  protected final String TEXT_209 = ";" + NL + "\t\t\t";
  protected final String TEXT_210 = NL + "                log.debug(\"";
  protected final String TEXT_211 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_212 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_213 = NL;
  protected final String TEXT_214 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_215 = "_QUERY\",dbquery_";
  protected final String TEXT_216 = ");";
  protected final String TEXT_217 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_218 = "_QUERY\",dbquery_";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_221 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_222 = " = stmt_";
  protected final String TEXT_223 = ".executeQuery(dbquery_";
  protected final String TEXT_224 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_225 = " = rs_";
  protected final String TEXT_226 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_227 = " = rsmd_";
  protected final String TEXT_228 = ".getColumnCount();" + NL;
  protected final String TEXT_229 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_230 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_231 = ".setDbmsId(\"";
  protected final String TEXT_232 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_233 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_234 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_235 = ".add(\"";
  protected final String TEXT_236 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_237 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_238 = " = ";
  protected final String TEXT_239 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_240 = "; i <= rsmd_";
  protected final String TEXT_241 = ".getColumnCount()-";
  protected final String TEXT_242 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_243 = ".contains(rsmd_";
  protected final String TEXT_244 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_245 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_246 = ".setName(rsmd_";
  protected final String TEXT_247 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_248 = ".setDbName(rsmd_";
  protected final String TEXT_249 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_250 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_251 = "\", rsmd_";
  protected final String TEXT_252 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_253 = ".getPrecision(i), rsmd_";
  protected final String TEXT_254 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_255 = ".setDbType(rsmd_";
  protected final String TEXT_256 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_257 = ".setDbTypeId(rsmd_";
  protected final String TEXT_258 = ".getColumnType(i));";
  protected final String TEXT_259 = NL + "                \tdcm_";
  protected final String TEXT_260 = ".setFormat(";
  protected final String TEXT_261 = ");";
  protected final String TEXT_262 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_263 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_264 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_265 = ".setLength(rsmd_";
  protected final String TEXT_266 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_267 = ".setLength(rsmd_";
  protected final String TEXT_268 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_269 = NL + "\t\t\tdcm_";
  protected final String TEXT_270 = ".setLength(rsmd_";
  protected final String TEXT_271 = ".getPrecision(i));";
  protected final String TEXT_272 = NL + "                \tdcm_";
  protected final String TEXT_273 = ".setPrecision(rsmd_";
  protected final String TEXT_274 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_275 = ".setNullable(rsmd_";
  protected final String TEXT_276 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_277 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_278 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_279 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_280 = ".metadatas.add(dcm_";
  protected final String TEXT_281 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_282 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_283 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_284 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_285 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_286 = NL + "\t\t    ";
  protected final String TEXT_287 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_288 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_289 = NL + "\t\t    while (rs_";
  protected final String TEXT_290 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_291 = "++;" + NL + "\t\t        ";
  protected final String TEXT_292 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_293 = " = ";
  protected final String TEXT_294 = " + dcg_";
  protected final String TEXT_295 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_296 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_297 = " = ";
  protected final String TEXT_298 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_300 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_312 = " = (List)rs_";
  ...
  protected final String TEXT_341 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_342 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_359 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_360 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_361 = ".getColumnTypeName(i_";
  protected final String TEXT_362 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_363 = ".add(rs_";
  protected final String TEXT_364 = ".getString(i_";
  protected final String TEXT_365 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_366 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
