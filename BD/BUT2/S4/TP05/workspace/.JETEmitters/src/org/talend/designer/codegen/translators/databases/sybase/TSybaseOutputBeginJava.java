...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_90 = NL + "\t\tjava.lang.Class.forName(\"com.sybase.jdbc4.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_91 = NL + "\t    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_92 = NL + "\t\tString url_";
  protected final String TEXT_93 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_94 = " + \":\" + ";
  protected final String TEXT_95 = " + \"/\" + ";
  protected final String TEXT_96 = ";";
  protected final String TEXT_97 = NL + "\t\tString url_";
  protected final String TEXT_98 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_114 = NL + "        int commitEvery_";
  protected final String TEXT_115 = " = ";
  protected final String TEXT_116 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_117 = " = 0;";
  protected final String TEXT_118 = NL;
  protected final String TEXT_119 = NL + "   int batchSize_";
  protected final String TEXT_120 = " = ";
  protected final String TEXT_121 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_122 = "=0;";
  protected final String TEXT_123 = NL + NL + "if(dbschema_";
  ...
  protected final String TEXT_129 = NL + "int count_";
  ...
  protected final String TEXT_478 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_479 = " + \" (";
  protected final String TEXT_480 = ") VALUES (";
  protected final String TEXT_481 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_501 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_516 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_523 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_527 = NL + "\t    String delete_";
  protected final String TEXT_528 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_532 = ".prepareStatement(delete_";
  protected final String TEXT_533 = ");" + NL + "\t    ";
  protected final String TEXT_534 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_546 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_547 = " = insert_";
  protected final String TEXT_548 = ".split(\"\\\\?\");";
  protected final String TEXT_549 = NL + "\t\t\tdelete_";
  protected final String TEXT_550 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_551 = " = delete_";
  protected final String TEXT_552 = ".split(\"\\\\?\");";
  protected final String TEXT_553 = NL + "\t\t\treplace_";
  protected final String TEXT_554 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_555 = " = replace_";
  protected final String TEXT_556 = ".split(\"\\\\?\");";
  protected final String TEXT_557 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_558 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_559 = " = insertIgnore_";
  ...
  protected final String TEXT_564 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_565 = " = conn_";
  protected final String TEXT_566 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_567 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_568 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_569 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_570 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_571 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_572 = " =null;" + NL + "\t";
  protected final String TEXT_573 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_580 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_584 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_585 = " = null;";
  protected final String TEXT_586 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
