...
public class TS3PutBeginJava
{
  ...
  protected final String TEXT_177 = ".setEndpoint(";
  protected final String TEXT_178 = ");" + NL + "\t\t";
  protected final String TEXT_179 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_180 = " - Creating new connection successfully.\");" + NL + "\t\t";
  protected final String TEXT_181 = NL + "\tboolean multiUpload_";
  protected final String TEXT_182 = " = false;" + NL + "\tlong partSizeInBytes_";
  protected final String TEXT_183 = " = ";
  protected final String TEXT_184 = " * 1024 * 1024;" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_185 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_186 = " - Uploading an object with key:\" + ";
  protected final String TEXT_187 = ");" + NL + "\t\t";
  protected final String TEXT_188 = NL + "\t\tjava.io.File inputFile_";
  protected final String TEXT_189 = " = new java.io.File(";
  protected final String TEXT_190 = ");" + NL + "\t\tmultiUpload_";
  protected final String TEXT_191 = " = (inputFile_";
  protected final String TEXT_192 = ".length() > partSizeInBytes_";
  protected final String TEXT_193 = ") && (partSizeInBytes_";
  protected final String TEXT_194 = " >= 5 * 1024 * 1024);" + NL + "\t\tif(!multiUpload_";
  protected final String TEXT_195 = ") {" + NL + "\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_196 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_197 = ", ";
  protected final String TEXT_198 = ", inputFile_";
  protected final String TEXT_199 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_201 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_202 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\tputRequest_";
  protected final String TEXT_203 = ".setMetadata(objectMetadata_";
  protected final String TEXT_204 = ");" + NL + "\t\t";
  protected final String TEXT_205 = NL + "\t\t" + NL + "\t\tconn_";
  protected final String TEXT_206 = ".putObject(putRequest_";
  protected final String TEXT_207 = ");" + NL + "\t\t} else {" + NL + "\t\t\tlong filePosition_";
  protected final String TEXT_208 = " = 0;" + NL + "\t\t\tjava.util.List<com.amazonaws.services.s3.model.PartETag> partTags_";
  protected final String TEXT_209 = " = new java.util.ArrayList<com.amazonaws.services.s3.model.PartETag>();" + NL + "\t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadRequest initRequest_";
  protected final String TEXT_210 = " = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(";
  protected final String TEXT_211 = ", ";
  protected final String TEXT_212 = ");" + NL + "\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_214 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\t\tobjectMetadata_";
  protected final String TEXT_215 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\t\tinitRequest_";
  protected final String TEXT_216 = ".setObjectMetadata(objectMetadata_";
  protected final String TEXT_217 = ");" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadResult initResponse_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".initiateMultipartUpload(initRequest_";
  protected final String TEXT_221 = ");" + NL + "\t\t\tString uploadId_";
  protected final String TEXT_222 = " = initResponse_";
  protected final String TEXT_223 = ".getUploadId();" + NL + "\t\t\tint partNumber_";
  protected final String TEXT_224 = " = 1;" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile (filePosition_";
  protected final String TEXT_225 = " < inputFile_";
  protected final String TEXT_226 = ".length()) {" + NL + "            \t\tlong curPartSize_";
  protected final String TEXT_227 = " = Math.min(partSizeInBytes_";
  protected final String TEXT_228 = ", inputFile_";
  protected final String TEXT_229 = ".length() - filePosition_";
  protected final String TEXT_230 = ");" + NL + "            \t\tcom.amazonaws.services.s3.model.UploadPartRequest uploadRequest = new com.amazonaws.services.s3.model.UploadPartRequest()" + NL + "                    \t.withBucketName(";
  protected final String TEXT_231 = ")" + NL + "                    \t.withKey(";
  protected final String TEXT_232 = ").withUploadId(uploadId_";
  protected final String TEXT_233 = ")" + NL + "                    \t.withPartNumber(partNumber_";
  protected final String TEXT_234 = ").withFileOffset(filePosition_";
  protected final String TEXT_235 = ").withFile(inputFile_";
  protected final String TEXT_236 = ").withPartSize(curPartSize_";
  protected final String TEXT_237 = ");" + NL + "" + NL + "            \t\t// Upload part and add response to our list." + NL + "            \t\tpartTags_";
  protected final String TEXT_238 = ".add(conn_";
  protected final String TEXT_239 = ".uploadPart(uploadRequest).getPartETag());" + NL + "            \t\tpartNumber_";
  protected final String TEXT_240 = "++;" + NL + "" + NL + "            \t\tfilePosition_";
  protected final String TEXT_241 = " += curPartSize_";
  protected final String TEXT_242 = ";" + NL + "        \t\t}" + NL + "        \t\tcom.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_";
  protected final String TEXT_243 = " = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(";
  protected final String TEXT_244 = ", ";
  protected final String TEXT_245 = "," + NL + "                    uploadId_";
  protected final String TEXT_246 = ", partTags_";
  protected final String TEXT_247 = ");" + NL + "            \tconn_";
  protected final String TEXT_248 = ".completeMultipartUpload(compRequest_";
  protected final String TEXT_249 = ");" + NL + "            } catch(java.lang.Exception uploadException_";
  protected final String TEXT_250 = ") {" + NL + "\t\t\t\tconn_";
  protected final String TEXT_251 = ".abortMultipartUpload(new com.amazonaws.services.s3.model.AbortMultipartUploadRequest(";
  protected final String TEXT_252 = ", ";
  protected final String TEXT_253 = ", uploadId_";
  protected final String TEXT_254 = "));" + NL + "\t\t\t\tthrow uploadException_";
  protected final String TEXT_255 = ";" + NL + "            }" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_256 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_257 = " - Upload the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_258 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_259 = "){" + NL + "\t\t";
  protected final String TEXT_260 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_261 = ");" + NL + "\t\t";
  protected final String TEXT_262 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_263 = " - \" + e_";
  protected final String TEXT_264 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_265 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_266 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_267 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_268 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_269 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
