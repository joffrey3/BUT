...
public class TJMSInputBeginJava
{
  ...
  protected final String TEXT_72 = ");" + NL + "    resourceMap.put(\"connection_";
  protected final String TEXT_73 = "\",connection_";
  protected final String TEXT_74 = ");" + NL + "\t";
  protected final String TEXT_75 = NL + "\tconnection_";
  protected final String TEXT_76 = ".setClientID(";
  protected final String TEXT_77 = ");" + NL + "\t";
  protected final String TEXT_78 = NL + "\t" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_79 = " = connection_";
  protected final String TEXT_80 = ".createSession(false, javax.jms.Session.CLIENT_ACKNOWLEDGE);" + NL + "    resourceMap.put(\"session_";
  protected final String TEXT_81 = "\",session_";
  protected final String TEXT_82 = ");" + NL + "\t";
  protected final String TEXT_83 = NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_84 = " = (javax.jms.Destination)context_";
  protected final String TEXT_85 = ".lookup(";
  protected final String TEXT_86 = ");" + NL + "\t";
  protected final String TEXT_87 = NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_88 = " = session_";
  protected final String TEXT_89 = ".create";
  protected final String TEXT_90 = "(";
  protected final String TEXT_91 = ");" + NL + "\t";
  protected final String TEXT_92 = NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_93 = " = session_";
  protected final String TEXT_94 = ".createDurableSubscriber((javax.jms.Topic)dest_";
  protected final String TEXT_95 = ",";
  protected final String TEXT_96 = ",";
  protected final String TEXT_97 = ",false);" + NL + "\t";
  protected final String TEXT_98 = NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_99 = "\t= session_";
  protected final String TEXT_100 = ".createConsumer(dest_";
  protected final String TEXT_101 = ", ";
  protected final String TEXT_102 = ");" + NL + "\t";
  protected final String TEXT_103 = NL + "    resourceMap.put(\"consumer_";
  protected final String TEXT_104 = "\",consumer_";
  protected final String TEXT_105 = ");" + NL + "" + NL + "\tconnection_";
  protected final String TEXT_106 = ".start();" + NL + "" + NL + "\tSystem.out.println(\"Ready to receive message\");" + NL + "\tSystem.out.println(\"Waiting...\");" + NL + "\t";
  protected final String TEXT_107 = NL + "\t";
  protected final String TEXT_108 = NL + NL + "\tjavax.jms.Message message_";
  protected final String TEXT_109 = ";" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_110 = " = 0;" + NL + "" + NL + "\twhile ((message_";
  protected final String TEXT_111 = " = consumer_";
  protected final String TEXT_112 = ".receive(";
  protected final String TEXT_113 = "*1000)) != null) {" + NL + "\t\t";
  protected final String TEXT_114 = NL + "\t\t";
  protected final String TEXT_115 = ".message=message_";
  protected final String TEXT_116 = ";\t";
  protected final String TEXT_117 = NL + "\t\t";
  protected final String TEXT_118 = ".messageContent=ParserUtils.parseTo_Document(((javax.jms.ObjectMessage) message_";
  protected final String TEXT_119 = ").getObject().toString());";
  protected final String TEXT_120 = NL + "\t\t";
  protected final String TEXT_121 = ".messageContent=((javax.jms.TextMessage) message_";
  protected final String TEXT_122 = ").getText();";
