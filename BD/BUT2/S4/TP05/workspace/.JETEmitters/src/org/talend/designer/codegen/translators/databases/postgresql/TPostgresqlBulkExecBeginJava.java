...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_352 = ".getTables(null, dbschema_";
  protected final String TEXT_353 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_354 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_355 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_356 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  protected final String TEXT_357 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_358 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_359 = ".close();";
  protected final String TEXT_360 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_361 = " = conn_";
  protected final String TEXT_362 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_363 = " = dbMetaData_";
  protected final String TEXT_364 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_365 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_366 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_367 = " = rsTable_";
  protected final String TEXT_368 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_369 = ".equals";
  protected final String TEXT_370 = "IgnoreCase";
  protected final String TEXT_371 = "(";
  protected final String TEXT_372 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_373 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_374 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_375 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_376 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_380 = " - Creating table ";
  ...
  protected final String TEXT_388 = " - Create table ";
  ...
  protected final String TEXT_393 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_395 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_416 = " - Creating table ";
  ...
  protected final String TEXT_424 = " - Create table ";
  protected final String TEXT_425 = "\" + tableName_";
  protected final String TEXT_426 = " + \"";
  protected final String TEXT_427 = " has succeeded.\");" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_434 = " - Clearing table ";
  ...
  protected final String TEXT_442 = "- Clear table ";
  protected final String TEXT_443 = "\" + tableName_";
  protected final String TEXT_444 = " + \"";
  protected final String TEXT_445 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_446 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_447 = ".close();" + NL + "\t\t";
  protected final String TEXT_448 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_449 = " = conn_";
  protected final String TEXT_450 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_451 = " = stmtTruncCount_";
  protected final String TEXT_452 = ".executeQuery(\"";
  protected final String TEXT_453 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_454 = " = conn_";
  protected final String TEXT_455 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_456 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_457 = " - Trancating table ";
  ...
  protected final String TEXT_465 = " - Truncate table ";
  protected final String TEXT_466 = "\" + tableName_";
  protected final String TEXT_467 = " + \"";
  protected final String TEXT_468 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_469 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_470 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  ...
  protected final String TEXT_474 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_475 = ".close();" + NL + "\t\t";
  protected final String TEXT_476 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_477 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_478 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_479 = NL + "\t";
  protected final String TEXT_480 = NL + "        int keyCount_";
  protected final String TEXT_481 = " = ";
  protected final String TEXT_482 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_483 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        tmpTableName_";
  protected final String TEXT_484 = " = tableName_";
  protected final String TEXT_485 = ";" + NL + "        tableName_";
  protected final String TEXT_486 = " = \"tmp_";
  protected final String TEXT_487 = "\" + \"_\" + pid + Thread.currentThread().getId() ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_488 = " = conn_";
  protected final String TEXT_489 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_490 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_491 = " - Creating temp table ";
  protected final String TEXT_492 = "\" + tableName_";
  protected final String TEXT_493 = " + \"";
  protected final String TEXT_494 = ".\" );" + NL + "\t\t";
  protected final String TEXT_495 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_496 = ".execute(\"";
  ...
  protected final String TEXT_500 = " - Create temp table ";
  protected final String TEXT_501 = "\" + tableName_";
  protected final String TEXT_502 = " + \"";
  protected final String TEXT_503 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_504 = NL + "        ";
  protected final String TEXT_505 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_506 = " =conn_";
  protected final String TEXT_507 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_508 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_509 = ".close();" + NL + "   \t\t";
  protected final String TEXT_510 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  ...
  protected final String TEXT_520 = NL + "        stmtTmpBulk_";
  protected final String TEXT_521 = ".execute(bulkSQL_";
  protected final String TEXT_522 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_523 = ".close();" + NL + "        " + NL + "\t\t";
  protected final String TEXT_524 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_525 = " - Bulk insert data into ";
  protected final String TEXT_526 = "\" + tableName_";
  protected final String TEXT_527 = " + \"";
  protected final String TEXT_528 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_529 = NL + "        tableName_";
  protected final String TEXT_530 = " = tmpTableName_";
  protected final String TEXT_531 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_532 = " = \"tmp_";
  protected final String TEXT_533 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_534 = " = conn_";
  protected final String TEXT_535 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_536 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_537 = " - Updating ";
  protected final String TEXT_538 = "\" + tableName_";
  protected final String TEXT_539 = " + \"";
  protected final String TEXT_540 = " from ";
  protected final String TEXT_541 = "\"+tmpTableName_";
  protected final String TEXT_542 = "+\"";
  protected final String TEXT_543 = ".\");" + NL + "\t\t";
  protected final String TEXT_544 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_545 = ".executeUpdate(\"";
  protected final String TEXT_546 = "\");" + NL + "\t\t";
  protected final String TEXT_547 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_548 = ".close();" + NL + "        tableName_";
  protected final String TEXT_549 = " = tmpTableName_";
  protected final String TEXT_550 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_551 = " = conn_";
  protected final String TEXT_552 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_553 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_554 = " - Droping temp table ";
  protected final String TEXT_555 = "\" + tableName_";
  protected final String TEXT_556 = " + \"";
  protected final String TEXT_557 = ".\");" + NL + "\t\t";
  protected final String TEXT_558 = NL + "        stmtTmpDrop_";
  protected final String TEXT_559 = ".execute(\"";
  protected final String TEXT_560 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_561 = ".close();" + NL + "\t\t";
  protected final String TEXT_562 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_563 = " - Drop temp table ";
  protected final String TEXT_564 = "\" + tableName_";
  protected final String TEXT_565 = "+ \"";
  protected final String TEXT_566 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_567 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_568 = " =conn_";
  protected final String TEXT_569 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_570 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_571 = ".close();";
  protected final String TEXT_572 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_573 = " = conn_";
  protected final String TEXT_574 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t";
  protected final String TEXT_575 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_576 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_577 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_578 = " - Inserting records in table ";
  protected final String TEXT_579 = "\" + tableName_";
  protected final String TEXT_580 = " + \"";
  protected final String TEXT_581 = ".\");" + NL + "\t";
  protected final String TEXT_582 = NL + "    stmtBulk_";
  protected final String TEXT_583 = ".execute(bulkSQL_";
  protected final String TEXT_584 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_585 = ".close();    " + NL + "\t";
  protected final String TEXT_586 = NL + "\t\tlog.info(\"";
  protected final String TEXT_587 = " - Insert records in table ";
  protected final String TEXT_588 = "\" + tableName_";
  protected final String TEXT_589 = " + \"";
  protected final String TEXT_590 = " has finished.\");" + NL + "\t";
