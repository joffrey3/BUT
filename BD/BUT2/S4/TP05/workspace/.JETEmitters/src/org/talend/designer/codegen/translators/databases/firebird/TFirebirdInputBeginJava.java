...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_180 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_210 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_211 = " = ";
  protected final String TEXT_212 = ";" + NL + "\t\t\t";
  protected final String TEXT_213 = NL + "                log.debug(\"";
  protected final String TEXT_214 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_215 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_216 = NL;
  protected final String TEXT_217 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_218 = "_QUERY\",dbquery_";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_221 = "_QUERY\",dbquery_";
  protected final String TEXT_222 = ");";
  protected final String TEXT_223 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_224 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_225 = " = stmt_";
  protected final String TEXT_226 = ".executeQuery(dbquery_";
  protected final String TEXT_227 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_228 = " = rs_";
  protected final String TEXT_229 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_230 = " = rsmd_";
  protected final String TEXT_231 = ".getColumnCount();" + NL;
  protected final String TEXT_232 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_233 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_234 = ".setDbmsId(\"";
  protected final String TEXT_235 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_236 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_237 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_238 = ".add(\"";
  protected final String TEXT_239 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_240 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_241 = " = ";
  protected final String TEXT_242 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_243 = "; i <= rsmd_";
  protected final String TEXT_244 = ".getColumnCount()-";
  protected final String TEXT_245 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_246 = ".contains(rsmd_";
  protected final String TEXT_247 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_248 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_249 = ".setName(rsmd_";
  protected final String TEXT_250 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_251 = ".setDbName(rsmd_";
  protected final String TEXT_252 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_253 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_254 = "\", rsmd_";
  protected final String TEXT_255 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_256 = ".getPrecision(i), rsmd_";
  protected final String TEXT_257 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_258 = ".setDbType(rsmd_";
  protected final String TEXT_259 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_260 = ".setDbTypeId(rsmd_";
  protected final String TEXT_261 = ".getColumnType(i));";
  protected final String TEXT_262 = NL + "                \tdcm_";
  protected final String TEXT_263 = ".setFormat(";
  protected final String TEXT_264 = ");";
  protected final String TEXT_265 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_266 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_267 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_268 = ".setLength(rsmd_";
  protected final String TEXT_269 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_270 = ".setLength(rsmd_";
  protected final String TEXT_271 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_272 = NL + "\t\t\tdcm_";
  protected final String TEXT_273 = ".setLength(rsmd_";
  protected final String TEXT_274 = ".getPrecision(i));";
  protected final String TEXT_275 = NL + "                \tdcm_";
  protected final String TEXT_276 = ".setPrecision(rsmd_";
  protected final String TEXT_277 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_278 = ".setNullable(rsmd_";
  protected final String TEXT_279 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_280 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_282 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_283 = ".metadatas.add(dcm_";
  protected final String TEXT_284 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_285 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_286 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_287 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_288 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_289 = NL + "\t\t    ";
  protected final String TEXT_290 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_291 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_292 = NL + "\t\t    while (rs_";
  protected final String TEXT_293 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_294 = "++;" + NL + "\t\t        ";
  protected final String TEXT_295 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_296 = " = ";
  protected final String TEXT_297 = " + dcg_";
  protected final String TEXT_298 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_300 = " = ";
  protected final String TEXT_301 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_315 = " = (List)rs_";
  protected final String TEXT_316 = ".getObject(";
  protected final String TEXT_317 = "column_index_";
  protected final String TEXT_318 = ");";
  protected final String TEXT_319 = NL + "\t                         \t\t";
  protected final String TEXT_320 = NL + "\t                         \t\t";
  protected final String TEXT_321 = NL + "\t                         \t\t";
  protected final String TEXT_322 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_323 = ".getObject(";
  protected final String TEXT_324 = "column_index_";
  protected final String TEXT_325 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_326 = NL + "                                    ";
  protected final String TEXT_327 = ".";
  protected final String TEXT_328 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_337 = ".setEPSG(";
  ...
  protected final String TEXT_344 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_345 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_346 = " = ";
  protected final String TEXT_347 = "; i_";
  protected final String TEXT_348 = "  <= rsmd_";
  protected final String TEXT_349 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_362 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_363 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_364 = ".getColumnTypeName(i_";
  protected final String TEXT_365 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_366 = ".add(rs_";
  protected final String TEXT_367 = ".getString(i_";
  protected final String TEXT_368 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_369 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
