...
public class TDBSQLRowBeginJava
{
  ...
  protected final String TEXT_118 = NL + "\t\t\tString url_";
  protected final String TEXT_119 = " = \"jdbc:odbc:\"+";
  ...
  protected final String TEXT_132 = ";" + NL + "" + NL + "\t\t\tString driverClass_";
  protected final String TEXT_133 = " = \"";
  protected final String TEXT_134 = "\";" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_138 = " == null || dbProperties_";
  protected final String TEXT_139 = ".trim().length() == 0) {" + NL + "\t\t\t\tconn_";
  protected final String TEXT_140 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_141 = ",dbUser_";
  protected final String TEXT_142 = ",dbPwd_";
  protected final String TEXT_143 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tdbProperties_";
  protected final String TEXT_144 = " = dbProperties_";
  protected final String TEXT_145 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_146 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_147 = ".put(\"user\",dbUser_";
  protected final String TEXT_148 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_149 = ".put(\"password\",dbPwd_";
  protected final String TEXT_150 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_151 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  protected final String TEXT_152 = ".getBytes()));" + NL + "\t\t\t\tconn_";
  ...
  protected final String TEXT_162 = ".prepareStatement(";
