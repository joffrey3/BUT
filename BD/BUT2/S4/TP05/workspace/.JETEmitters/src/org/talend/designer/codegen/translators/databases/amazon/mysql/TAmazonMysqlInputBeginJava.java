...
public class TAmazonMysqlInputBeginJava
{
  ...
  protected final String TEXT_190 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_191 = " + \":\" + ";
  protected final String TEXT_192 = " + \"/\" + ";
  protected final String TEXT_193 = " + \"?\" + ";
  protected final String TEXT_194 = ";";
  protected final String TEXT_195 = NL + "\t\t        if(stmt_";
  protected final String TEXT_196 = " instanceof com.mysql.jdbc.Statement){" + NL + "\t\t\t\t    ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_197 = ").enableStreamingResults();" + NL + "\t\t\t\t}else if(stmt_";
  protected final String TEXT_198 = " instanceof com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper){" + NL + "\t\t\t\t    ((com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper)stmt_";
  protected final String TEXT_199 = ").enableStreamingResults();" + NL + "\t\t\t\t}";
  ...
  protected final String TEXT_203 = ") != null) {" + NL + "\t            String dateString_";
  protected final String TEXT_204 = " = rs_";
  protected final String TEXT_205 = ".getString(";
  ...
  protected final String TEXT_216 = " = (java.util.Date) year0_";
  protected final String TEXT_217 = ".clone();" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            ";
  ...
  protected final String TEXT_228 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_229 = " =  conn_";
  protected final String TEXT_230 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_231 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_232 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_233 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_234 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_235 = NL + "                 conn_";
  protected final String TEXT_236 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_237 = NL + "               ";
  protected final String TEXT_238 = " + \"=\" + ";
  protected final String TEXT_239 = " + \";\" +";
  protected final String TEXT_240 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_241 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_242 = ");";
  protected final String TEXT_243 = NL + "\t\t    ";
  protected final String TEXT_244 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";" + NL + "\t\t\t";
  protected final String TEXT_247 = NL + "                log.debug(\"";
  protected final String TEXT_248 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_249 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_250 = NL;
  protected final String TEXT_251 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_252 = "_QUERY\",dbquery_";
  protected final String TEXT_253 = ");";
  protected final String TEXT_254 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_255 = "_QUERY\",dbquery_";
  protected final String TEXT_256 = ");";
  protected final String TEXT_257 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_258 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_259 = " = stmt_";
  protected final String TEXT_260 = ".executeQuery(dbquery_";
  protected final String TEXT_261 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_262 = " = rs_";
  protected final String TEXT_263 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_264 = " = rsmd_";
  protected final String TEXT_265 = ".getColumnCount();" + NL;
  protected final String TEXT_266 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_267 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_268 = ".setDbmsId(\"";
  protected final String TEXT_269 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_270 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_271 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_272 = ".add(\"";
  protected final String TEXT_273 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_274 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_275 = " = ";
  protected final String TEXT_276 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_277 = "; i <= rsmd_";
  protected final String TEXT_278 = ".getColumnCount()-";
  protected final String TEXT_279 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_280 = ".contains(rsmd_";
  protected final String TEXT_281 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_282 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setName(rsmd_";
  protected final String TEXT_284 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_285 = ".setDbName(rsmd_";
  protected final String TEXT_286 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_287 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_288 = "\", rsmd_";
  protected final String TEXT_289 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_290 = ".getPrecision(i), rsmd_";
  protected final String TEXT_291 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setDbType(rsmd_";
  protected final String TEXT_293 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_294 = ".setDbTypeId(rsmd_";
  protected final String TEXT_295 = ".getColumnType(i));";
  protected final String TEXT_296 = NL + "                \tdcm_";
  protected final String TEXT_297 = ".setFormat(";
  protected final String TEXT_298 = ");";
  protected final String TEXT_299 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_300 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_301 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_302 = ".setLength(rsmd_";
  protected final String TEXT_303 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_304 = ".setLength(rsmd_";
  protected final String TEXT_305 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_306 = NL + "\t\t\tdcm_";
  protected final String TEXT_307 = ".setLength(rsmd_";
  protected final String TEXT_308 = ".getPrecision(i));";
  protected final String TEXT_309 = NL + "                \tdcm_";
  protected final String TEXT_310 = ".setPrecision(rsmd_";
  protected final String TEXT_311 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setNullable(rsmd_";
  protected final String TEXT_313 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_314 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_315 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_316 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_317 = ".metadatas.add(dcm_";
  protected final String TEXT_318 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_319 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_320 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_321 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_322 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_323 = NL + "\t\t    ";
  protected final String TEXT_324 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_325 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_326 = NL + "\t\t    while (rs_";
  protected final String TEXT_327 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_328 = "++;" + NL + "\t\t        ";
  protected final String TEXT_329 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_330 = " = ";
  protected final String TEXT_331 = " + dcg_";
  protected final String TEXT_332 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_333 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_334 = " = ";
  protected final String TEXT_335 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_336 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_337 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_356 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_357 = ".getObject(";
  protected final String TEXT_358 = "column_index_";
  protected final String TEXT_359 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_360 = NL + "                                    ";
  protected final String TEXT_361 = ".";
  protected final String TEXT_362 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_371 = ".setEPSG(";
  protected final String TEXT_372 = ");" + NL + "                                        }";
  protected final String TEXT_373 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_374 = NL + "                                  ";
  protected final String TEXT_375 = ".";
  protected final String TEXT_376 = "=dcg_";
  protected final String TEXT_377 = ";";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_379 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_380 = " = ";
  protected final String TEXT_381 = "; i_";
  protected final String TEXT_382 = "  <= rsmd_";
  protected final String TEXT_383 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_396 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_397 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_398 = ".getColumnTypeName(i_";
  protected final String TEXT_399 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_400 = ".add(rs_";
  protected final String TEXT_401 = ".getString(i_";
  protected final String TEXT_402 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_403 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
