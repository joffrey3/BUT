...
public class TNetezzaRowBeginJava
{
  ...
  protected final String TEXT_117 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_118 = " = ";
  protected final String TEXT_119 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_120 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_121 = " == null || dbProperties_";
  protected final String TEXT_122 = ".trim().length() == 0) {" + NL + "\t\t\t    url_";
  protected final String TEXT_123 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_132 = NL + "\t\t\tint nb_";
