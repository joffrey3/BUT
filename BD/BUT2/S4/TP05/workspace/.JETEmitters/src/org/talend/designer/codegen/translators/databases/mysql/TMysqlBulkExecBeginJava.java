...
public class TMysqlBulkExecBeginJava {
  ...
  protected final String TEXT_282 = ".getTables(null, dbschema_";
  protected final String TEXT_283 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_284 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_285 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_286 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_298 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_310 = " - Creating table ";
  ...
  protected final String TEXT_318 = " - Create table ";
  ...
  protected final String TEXT_323 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_325 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_329 = " - Droping table ";
  protected final String TEXT_330 = "\" + tableName_";
  ...
  protected final String TEXT_337 = " - Drop table ";
  ...
  protected final String TEXT_342 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_360 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_406 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_407 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_408 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_409 = NL + "String lines_separator_";
  protected final String TEXT_410 = " = ";
  protected final String TEXT_411 = ";" + NL + "String field_separator_";
  protected final String TEXT_412 = " = ";
  protected final String TEXT_413 = ";" + NL + "String escaped_str_";
  protected final String TEXT_414 = " = ";
  protected final String TEXT_415 = ";" + NL + "String enclosed_str_";
  protected final String TEXT_416 = " = ";
  protected final String TEXT_417 = ";" + NL + "String file_";
  protected final String TEXT_418 = " = ";
  protected final String TEXT_419 = ";" + NL + "file_";
  protected final String TEXT_420 = " = file_";
  protected final String TEXT_421 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "String replace_";
  protected final String TEXT_422 = " = null;";
  protected final String TEXT_423 = NL + "\t\tint keyCount_";
  protected final String TEXT_424 = " = ";
  protected final String TEXT_425 = ";" + NL + "\t\tif(keyCount_";
  protected final String TEXT_426 = " == 0) {" + NL + "\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "\t\t}" + NL + "\t\ttableName_";
  protected final String TEXT_427 = " = \"tmp_";
  protected final String TEXT_428 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtTmpCreate_";
  ...
  protected final String TEXT_432 = " - Creating temp table \" + tableName_";
  protected final String TEXT_433 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_434 = NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_435 = ".execute(\"";
  protected final String TEXT_436 = ")\");" + NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_437 = ".close();" + NL + "" + NL + "\t\tjava.sql.Statement stmtTmpBulk_";
  ...
  protected final String TEXT_441 = " - Create temp table \" + tableName_";
  protected final String TEXT_442 = " + \" has succeeded.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_443 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_444 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_445 = NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_446 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_447 = ");" + NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_448 = ".execute(" + NL + "\t\t\t\"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_449 = " + \"' \"" + NL + "\t\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_450 = NL + "\t\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_451 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_452 = ")?\"\\\\\":\"\")+ enclosed_str_";
  protected final String TEXT_453 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ESCAPED BY '\" +(\"'\".equals(escaped_str_";
  protected final String TEXT_454 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_455 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\")+ \"'\"" + NL + "\t\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_456 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_457 = "\"";
  protected final String TEXT_458 = NL + "\t\t\t+ \" SET\"";
  protected final String TEXT_459 = NL + "\t\t\t+ \" ";
  protected final String TEXT_460 = "=CAST(@";
  protected final String TEXT_461 = "_";
  protected final String TEXT_462 = " AS UNSIGNED)\"";
  protected final String TEXT_463 = NL + "\t\t\t+ \",\"";
  protected final String TEXT_464 = NL + "\t\t);" + NL + "\t\t";
  protected final String TEXT_465 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_466 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_467 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_468 = NL + "\t\ttableName_";
  protected final String TEXT_469 = " = ";
  protected final String TEXT_470 = ";" + NL + "\t\tString tmpTableName_";
  protected final String TEXT_471 = " = \"tmp_";
  protected final String TEXT_472 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_476 = " - Updating \" + tableName_";
  protected final String TEXT_477 = " + \" from \"+tmpTableName_";
  protected final String TEXT_478 = "+\".\");" + NL + "\t\t";
  protected final String TEXT_479 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_480 = ".executeUpdate(\"";
  protected final String TEXT_481 = "\");" + NL + "\t\t";
  protected final String TEXT_482 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_483 = ".close();" + NL + "\t\ttableName_";
  protected final String TEXT_484 = " = tmpTableName_";
  protected final String TEXT_485 = ";" + NL + "\t\tjava.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_489 = " - Droping temp table \" + tableName_";
  protected final String TEXT_490 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_491 = NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_492 = ".execute(\"";
  protected final String TEXT_493 = "\");" + NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_494 = ".close();" + NL + "\t\t";
  protected final String TEXT_495 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_496 = " - Drop temp table \" + tableName_";
  protected final String TEXT_497 = "+ \" has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_498 = NL + "\t\t";
  protected final String TEXT_499 = NL + "\t\treplace_";
  protected final String TEXT_500 = " = \"REPLACE\";" + NL + "\t\t";
  protected final String TEXT_501 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_502 = " - Replacing records in table \" + tableName_";
  protected final String TEXT_503 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_504 = NL + "\t\treplace_";
  protected final String TEXT_505 = " = \"IGNORE\";" + NL + "\t\t";
  protected final String TEXT_506 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_507 = " - Loading data ignore records in table \" + tableName_";
  protected final String TEXT_508 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_509 = NL + "\t\treplace_";
  protected final String TEXT_510 = " = \"\";" + NL + "\t\t";
  protected final String TEXT_511 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_512 = " - Inserting records in table \" + tableName_";
  protected final String TEXT_513 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_514 = NL + "\tString bulkSQL_";
  protected final String TEXT_515 = " = \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_516 = " + \"' \"" + NL + "\t\t+ replace_";
  protected final String TEXT_517 = NL + "\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_518 = NL + "\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_519 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_520 = ")?\"\\\\\":\"\") + enclosed_str_";
  protected final String TEXT_521 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ESCAPED BY '\" + (\"'\".equals(escaped_str_";
  protected final String TEXT_522 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_523 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_524 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_525 = "\"";
  protected final String TEXT_526 = NL + "\t\t+ \" SET\"";
  protected final String TEXT_527 = NL + "\t\t+ \" ";
  protected final String TEXT_528 = "=CAST(@";
  protected final String TEXT_529 = "_";
  protected final String TEXT_530 = " AS UNSIGNED)\"";
  protected final String TEXT_531 = NL + "\t\t+ \",\"";
  protected final String TEXT_532 = ";" + NL + "\t";
  protected final String TEXT_533 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_534 = "=conn_";
  protected final String TEXT_535 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_536 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_537 = ");" + NL + "\t" + NL + "\tstmt_";
  protected final String TEXT_538 = ".execute(bulkSQL_";
  protected final String TEXT_539 = ");" + NL + "\t";
  protected final String TEXT_540 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_541 = " - Replace records in table \" + tableName_";
  protected final String TEXT_542 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_543 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_544 = " - Load data ignore records in table \" + tableName_";
  protected final String TEXT_545 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_546 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_547 = " - Insert records in table \" + tableName_";
