...
public class TS3CopyBeginJava
{
  ...
  protected final String TEXT_181 = NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_182 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_183 = " - Copying an object with key:\" + ";
  protected final String TEXT_184 = ");" + NL + "\t\t";
  protected final String TEXT_185 = NL + "\t\tcom.amazonaws.services.s3.model.CopyObjectRequest copyRequest_";
  protected final String TEXT_186 = " = new com.amazonaws.services.s3.model.CopyObjectRequest(";
  protected final String TEXT_187 = ", ";
  protected final String TEXT_188 = ", ";
  protected final String TEXT_189 = ", ";
  protected final String TEXT_190 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_192 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_193 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\tcopyRequest_";
  protected final String TEXT_194 = ".setNewObjectMetadata(objectMetadata_";
  protected final String TEXT_195 = ");" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t\t" + NL + "\t\tconn_";
  protected final String TEXT_197 = ".copyObject(copyRequest_";
  protected final String TEXT_198 = ");" + NL + "\t\t";
  protected final String TEXT_199 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_200 = " - Copied the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_201 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_202 = "){" + NL + "\t\t";
  protected final String TEXT_203 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_204 = ");" + NL + "\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_206 = " - \" + e_";
  protected final String TEXT_207 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_209 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_210 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_211 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_212 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
