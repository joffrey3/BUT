...
public class TRedshiftCloseMainJava
{
  ...
  protected final String TEXT_49 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_50 = " != null && !conn_";
  protected final String TEXT_51 = ".isClosed())" + NL + "\t{";
  protected final String TEXT_52 = NL + "        conn_";
  protected final String TEXT_53 = ".close();";
  protected final String TEXT_54 = NL + "\t}" + NL + "" + NL + "if (null != java.sql.DriverManager.getLogWriter()) {" + NL + "\tjava.sql.DriverManager.getLogWriter().close();" + NL + "}" + NL;
  protected final String TEXT_55 = NL + "java.io.PrintWriter logWriter_";
  protected final String TEXT_56 = " = (java.io.PrintWriter) globalMap.get(\"logWriter_";
  protected final String TEXT_57 = "\");" + NL + "if (logWriter_";
  protected final String TEXT_58 = " != null) {" + NL + "\tlogWriter_";
...
DBLogUtil dbLog = null;
    ...
    stringBuffer.append(connectionComponent );
