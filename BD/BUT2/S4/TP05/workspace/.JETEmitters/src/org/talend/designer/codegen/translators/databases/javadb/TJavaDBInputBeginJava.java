...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_179 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_180 = ");";
  protected final String TEXT_181 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_182 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_183 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_184 = "),Integer.parseInt(";
  protected final String TEXT_185 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_186 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_187 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_188 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_189 = " && timeOut_";
  protected final String TEXT_190 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_191 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_192 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_193 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_194 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_195 = NL + "\t\t\t\tString url_";
  protected final String TEXT_196 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_197 = ";";
  protected final String TEXT_198 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_199 = " = \"jdbc:derby:net://\" + ";
  ...
  protected final String TEXT_211 = ").newInstance();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_226 = NL + "\t\t    int nb_line_";
  protected final String TEXT_227 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_236 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_237 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_238 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_239 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_240 = NL + "                 conn_";
  protected final String TEXT_241 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_242 = NL + "               ";
  protected final String TEXT_243 = " + \"=\" + ";
  protected final String TEXT_244 = " + \";\" +";
  protected final String TEXT_245 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_246 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_247 = ");";
  protected final String TEXT_248 = NL + "\t\t    ";
  protected final String TEXT_249 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_250 = " = ";
  protected final String TEXT_251 = ";" + NL + "\t\t\t";
  protected final String TEXT_252 = NL + "                log.debug(\"";
  protected final String TEXT_253 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_262 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_263 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_264 = " = stmt_";
  protected final String TEXT_265 = ".executeQuery(dbquery_";
  protected final String TEXT_266 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_267 = " = rs_";
  protected final String TEXT_268 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_269 = " = rsmd_";
  protected final String TEXT_270 = ".getColumnCount();" + NL;
  protected final String TEXT_271 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_272 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_273 = ".setDbmsId(\"";
  protected final String TEXT_274 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_275 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_276 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_277 = ".add(\"";
  protected final String TEXT_278 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_279 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_280 = " = ";
  protected final String TEXT_281 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_282 = "; i <= rsmd_";
  protected final String TEXT_283 = ".getColumnCount()-";
  protected final String TEXT_284 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_285 = ".contains(rsmd_";
  protected final String TEXT_286 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_287 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_288 = ".setName(rsmd_";
  protected final String TEXT_289 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_290 = ".setDbName(rsmd_";
  protected final String TEXT_291 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_293 = "\", rsmd_";
  protected final String TEXT_294 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_295 = ".getPrecision(i), rsmd_";
  protected final String TEXT_296 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_297 = ".setDbType(rsmd_";
  protected final String TEXT_298 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_299 = ".setDbTypeId(rsmd_";
  protected final String TEXT_300 = ".getColumnType(i));";
  protected final String TEXT_301 = NL + "                \tdcm_";
  protected final String TEXT_302 = ".setFormat(";
  protected final String TEXT_303 = ");";
  protected final String TEXT_304 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_305 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_306 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_307 = ".setLength(rsmd_";
  protected final String TEXT_308 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_309 = ".setLength(rsmd_";
  protected final String TEXT_310 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_311 = NL + "\t\t\tdcm_";
  protected final String TEXT_312 = ".setLength(rsmd_";
  protected final String TEXT_313 = ".getPrecision(i));";
  protected final String TEXT_314 = NL + "                \tdcm_";
  protected final String TEXT_315 = ".setPrecision(rsmd_";
  protected final String TEXT_316 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_317 = ".setNullable(rsmd_";
  protected final String TEXT_318 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_319 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_320 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_321 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_322 = ".metadatas.add(dcm_";
  protected final String TEXT_323 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_324 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_325 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_326 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_327 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_328 = NL + "\t\t    ";
  protected final String TEXT_329 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_330 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_331 = NL + "\t\t    while (rs_";
  protected final String TEXT_332 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_333 = "++;" + NL + "\t\t        ";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_335 = " = ";
  protected final String TEXT_336 = " + dcg_";
  protected final String TEXT_337 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_338 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_339 = " = ";
  protected final String TEXT_340 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_354 = " = (List)rs_";
  ...
  protected final String TEXT_361 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_362 = ".getObject(";
  protected final String TEXT_363 = "column_index_";
  protected final String TEXT_364 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_365 = NL + "                                    ";
  protected final String TEXT_366 = ".";
  protected final String TEXT_367 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_384 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_392 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_393 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_394 = ".getClob(i_";
  protected final String TEXT_395 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_396 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_397 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_398 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_399 = ".add(tNTextImpl_";
  protected final String TEXT_400 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_401 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_402 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_403 = ".getColumnTypeName(i_";
  protected final String TEXT_404 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_405 = ".add(rs_";
  protected final String TEXT_406 = ".getString(i_";
  protected final String TEXT_407 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_408 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_409 = ".";
  protected final String TEXT_410 = ", rs_";
  protected final String TEXT_411 = ", fixedColumnCount_";
  protected final String TEXT_412 = ",list_";
  protected final String TEXT_413 = ",";
  protected final String TEXT_414 = ");";
  protected final String TEXT_415 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_430 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_431 = ".";
  protected final String TEXT_432 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_438 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_439 = " - Retrieving the record \" + nb_line_";
