...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_181 = NL + "\tint nb_bucket_";
  protected final String TEXT_182 = " = 0;" + NL + "\t";
  protected final String TEXT_183 = NL + "\t\tlog.info(\"";
  protected final String TEXT_184 = " - Retrieving buckets from the server.\");" + NL + "\t";
  protected final String TEXT_185 = NL + "\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".listBuckets();" + NL + "\t";
  protected final String TEXT_188 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_189 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_190 = " : buckets_";
  protected final String TEXT_191 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_192 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_193 = " = bucket_";
  protected final String TEXT_194 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_195 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
  protected final String TEXT_196 = ");" + NL + "\t\t";
  protected final String TEXT_197 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_198 = " - Retrieving the bucket \" + nb_bucket_";
  protected final String TEXT_199 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_200 = " - Name of current bucket : \" + currentBucketName_";
