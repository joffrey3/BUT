...
public class Handle_rejects_startJava
{
  ...
  protected final String TEXT_54 = ")));" + NL + "                    }" + NL + "                    // set precision" + NL + "                    Object precision_";
  ...
  protected final String TEXT_58 = ".setPrecision(Integer.parseInt(String.valueOf(precision_";
  protected final String TEXT_59 = ")));" + NL + "                    } " + NL + "                    // add dynamic field metadata to dynamic variable";
  protected final String TEXT_60 = NL + "                    ";
  protected final String TEXT_61 = ".metadatas.add(dynamicMetadata_";
  protected final String TEXT_62 = ");" + NL + "                }" + NL + "                initDyn_";
  protected final String TEXT_63 = " = true;" + NL + "            }";
  protected final String TEXT_64 = NL + "            ";
  protected final String TEXT_65 = ".clearColumnValues();";
  protected final String TEXT_66 = NL + "                java.util.Map<String, Object> dynamicValue_";
  protected final String TEXT_67 = " = (java.util.Map<String, Object>) ";
  protected final String TEXT_68 = ".get(";
  protected final String TEXT_69 = ");" + NL + "                for (java.util.Map.Entry<String, Object> dynamicValueEntry_";
  protected final String TEXT_70 = " : dynamicValue_";
  protected final String TEXT_71 = ".entrySet()) {";
  protected final String TEXT_72 = NL + "                    ";
  protected final String TEXT_73 = ".setColumnValue(";
  protected final String TEXT_74 = ".getIndex(dynamicValueEntry_";
  protected final String TEXT_75 = ".getKey()), dynamicValueEntry_";
  protected final String TEXT_76 = ".getValue());" + NL + "                }";
  protected final String TEXT_77 = NL + "                ";
  protected final String TEXT_78 = ".";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ";";
  protected final String TEXT_81 = NL + "                Object columnValue_";
  ...
  protected final String TEXT_88 = " = ParserUtils.parseTo_Document(String.valueOf(columnValue_";
  protected final String TEXT_89 = "_";
  protected final String TEXT_90 = "));";
  protected final String TEXT_91 = NL + "                        ";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = " = (";
  protected final String TEXT_94 = ") (columnValue_";
  protected final String TEXT_95 = "_";
  protected final String TEXT_96 = ");";
  protected final String TEXT_97 = NL + "                    if (columnValue_";
  ...
  protected final String TEXT_106 = " = ParserUtils.parseTo_Document(String.valueOf(columnValue_";
  protected final String TEXT_107 = "_";
  protected final String TEXT_108 = "));";
  protected final String TEXT_109 = NL + "                            ";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = " = (";
  protected final String TEXT_112 = ") (columnValue_";
  protected final String TEXT_113 = "_";
  protected final String TEXT_114 = ");";
  protected final String TEXT_115 = NL + "                    }";
  protected final String TEXT_116 = NL + "if (writer_";
  protected final String TEXT_117 = " instanceof org.talend.components.api.component.runtime.WriterWithFeedback<?, ?, ?>) {";
  protected final String TEXT_118 = NL + "\t// Handle rejects after close" + NL + "    java.util.Iterator<?> outgoingRejectRecords_";
  protected final String TEXT_119 = " = ((org.talend.components.api.component.runtime.WriterWithFeedback<?, ?, ?>)writer_";
  protected final String TEXT_120 = ").getRejectedWrites().iterator();";
  protected final String TEXT_121 = NL + "    ";
  protected final String TEXT_122 = " = null;" + NL + "    while (outgoingRejectRecords_";
  protected final String TEXT_123 = ".hasNext()) {";
  protected final String TEXT_124 = NL + "        ";
  protected final String TEXT_125 = " = new ";
  protected final String TEXT_126 = "Struct();" + NL + "        Object outgoingReject_";
  protected final String TEXT_127 = " = outgoingRejectRecords_";
  protected final String TEXT_128 = ".next();";
