...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_316 = ".getTables(null, dbschema_";
  protected final String TEXT_317 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_318 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_319 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_320 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_328 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_329 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_330 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_331 = " = rsTable_";
  protected final String TEXT_332 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_339 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_340 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_363 = " - Droping table ";
  protected final String TEXT_364 = "\" + tableName_";
  ...
  protected final String TEXT_371 = " - Drop table ";
  ...
  protected final String TEXT_376 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_394 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_398 = " - Clearing table ";
  ...
  protected final String TEXT_406 = "- Clear table ";
  protected final String TEXT_407 = "\" + tableName_";
  protected final String TEXT_408 = " + \"";
  protected final String TEXT_409 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_421 = " - Trancating table ";
  protected final String TEXT_422 = "\" + tableName_";
  protected final String TEXT_423 = " + \"";
  protected final String TEXT_424 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_425 = NL + "\t\t\tstmtTrunc_";
  ...
  protected final String TEXT_429 = " - Truncate table ";
  protected final String TEXT_430 = "\" + tableName_";
  protected final String TEXT_431 = " + \"";
  protected final String TEXT_432 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_434 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_435 = " += rsTruncCount_";
  protected final String TEXT_436 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_437 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_438 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_439 = ".close();" + NL + "\t\t";
  protected final String TEXT_440 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_441 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_442 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_443 = NL + "\t";
  protected final String TEXT_444 = NL + "\t        int keyCount_";
  protected final String TEXT_445 = " = ";
  protected final String TEXT_446 = ";" + NL + "\t        if(keyCount_";
  protected final String TEXT_447 = " == 0) {" + NL + "\t            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "\t        }" + NL + "\t        tmpTableName_";
  protected final String TEXT_448 = " = tableName_";
  protected final String TEXT_449 = ";" + NL + "\t        tableName_";
  protected final String TEXT_450 = " = \"tmp_";
  protected final String TEXT_451 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_454 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_455 = " - Creating temp table ";
  protected final String TEXT_456 = "\" + tableName_";
  protected final String TEXT_457 = " + \"";
  protected final String TEXT_458 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_459 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_460 = ".execute(\"";
  protected final String TEXT_461 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_462 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_463 = " - Create temp table ";
  protected final String TEXT_464 = "\" + tableName_";
  protected final String TEXT_465 = " + \"";
  protected final String TEXT_466 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_467 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_468 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_469 = NL + "\t\t\t";
  protected final String TEXT_470 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_471 = " - Bulk inserting data into ";
  protected final String TEXT_472 = "\" + tableName_";
  protected final String TEXT_473 = " + \"";
  protected final String TEXT_474 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_475 = NL + "\t        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_476 = " = conn_";
  protected final String TEXT_477 = ".createStatement();" + NL + "\t        stmtTmpBulk_";
  ...
  protected final String TEXT_519 = " - Drop temp table ";
  protected final String TEXT_520 = "\" + tableName_";
  protected final String TEXT_521 = "+ \"";
  protected final String TEXT_522 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_523 = NL + "\t        stmtTmpDrop_";
  protected final String TEXT_524 = ".close();" + NL + "\t        ";
  protected final String TEXT_525 = NL + "\t    \tlog.debug(\"";
  protected final String TEXT_526 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_527 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_528 = " - Bulk inserting data into ";
  protected final String TEXT_529 = "\" + tableName_";
  protected final String TEXT_530 = " + \"";
  protected final String TEXT_531 = ".\" );" + NL + "\t\t";
  protected final String TEXT_532 = NL + "\t    java.sql.Statement stmtBulk_";
  protected final String TEXT_533 = " = conn_";
  protected final String TEXT_534 = ".createStatement();" + NL + "\t    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t    stmtBulk_";
  protected final String TEXT_535 = ".execute(bulkSQL_";
  protected final String TEXT_536 = ");" + NL + "\t    stmtBulk_";
  protected final String TEXT_537 = ".close();" + NL + "\t\t";
