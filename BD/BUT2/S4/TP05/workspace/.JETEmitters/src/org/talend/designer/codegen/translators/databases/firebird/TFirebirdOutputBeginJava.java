...
public class TFirebirdOutputBeginJava {
  ...
  protected final String TEXT_124 = NL + "                if(!conn_";
  protected final String TEXT_125 = ".getAutoCommit()){" + NL + "                    conn_";
  ...
  protected final String TEXT_147 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_157 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_163 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
