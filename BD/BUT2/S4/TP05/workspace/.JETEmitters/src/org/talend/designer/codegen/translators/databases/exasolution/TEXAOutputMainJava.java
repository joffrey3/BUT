...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_977 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_978 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_979 = " = e_";
  protected final String TEXT_980 = ".getNextException(),sqle_";
  protected final String TEXT_981 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_982 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_983 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_984 = " = new java.sql.SQLException(e_";
  protected final String TEXT_985 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_986 = ".getMessage(), ne_";
  protected final String TEXT_987 = ".getSQLState(), ne_";
  protected final String TEXT_988 = ".getErrorCode(), ne_";
  protected final String TEXT_989 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_990 = " = sqle_";
  protected final String TEXT_991 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_992 = " = e_";
  protected final String TEXT_993 = ".getMessage();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_994 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_995 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_996 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_997 = ");" + NL + "\t\t\t            }";
  protected final String TEXT_998 = NL + "                        int countSum_";
  protected final String TEXT_999 = " = 0;" + NL + "                        for(int countEach_";
  ...
  protected final String TEXT_1014 = NL + "                        System.err.println(errormessage_";
  protected final String TEXT_1015 = ");";
  protected final String TEXT_1016 = NL + "                }" + NL + "                }";
  protected final String TEXT_1017 = NL + "                commitCounter_";
  protected final String TEXT_1018 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1019 = " <= commitCounter_";
  protected final String TEXT_1020 = ") {";
  protected final String TEXT_1021 = NL + "                if ((batchSize_";
  protected final String TEXT_1022 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1023 = " > 0)) {" + NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_1024 = " = 0;";
  protected final String TEXT_1025 = NL + "                        for(int countEach_";
  protected final String TEXT_1026 = ": pstmt_";
  protected final String TEXT_1027 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1040 = NL + "                    batchSizeCounter_";
  protected final String TEXT_1041 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1042 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1043 = " = e_";
  protected final String TEXT_1044 = ".getNextException(),sqle_";
  protected final String TEXT_1045 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_1046 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1047 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_1048 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1049 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1050 = ".getMessage(), ne_";
  protected final String TEXT_1051 = ".getSQLState(), ne_";
  protected final String TEXT_1052 = ".getErrorCode(), ne_";
  protected final String TEXT_1053 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1054 = " = sqle_";
  protected final String TEXT_1055 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1056 = " = e_";
  protected final String TEXT_1057 = ".getMessage();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_1058 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1059 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1060 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_1061 = ");" + NL + "\t\t\t            }";
  protected final String TEXT_1062 = NL + "                        int countSum_";
  protected final String TEXT_1063 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_1064 = ": e_";
  protected final String TEXT_1065 = ".getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_1066 = " += (countEach_";
  protected final String TEXT_1067 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1078 = NL + "                        System.err.println(errormessage_";
  protected final String TEXT_1079 = ");";
  protected final String TEXT_1080 = NL + "                }" + NL + "            }";
  protected final String TEXT_1081 = NL + "                    conn_";
  protected final String TEXT_1082 = ".commit();";
  protected final String TEXT_1083 = NL + "                    commitCounter_";
  protected final String TEXT_1084 = "=0;" + NL + "                }";
