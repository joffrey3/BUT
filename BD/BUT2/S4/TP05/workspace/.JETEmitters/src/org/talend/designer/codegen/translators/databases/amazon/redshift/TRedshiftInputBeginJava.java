...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_179 = NL + "\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_180 = " = new java.io.FileWriter(";
  protected final String TEXT_181 = ", true);" + NL + "\t\t\t\tjava.io.PrintWriter logWriter_";
  protected final String TEXT_182 = " = new java.io.PrintWriter(output_";
  protected final String TEXT_183 = ",true);" + NL + "\t\t\t\tjava.sql.DriverManager.setLogWriter(logWriter_";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "\t\t\t" + NL + "\t\t\tStringBuilder sbuilder_";
  protected final String TEXT_186 = " = new StringBuilder();" + NL + "\t\t\tsbuilder_";
  protected final String TEXT_187 = ".append(\"jdbc:redshift://\").append(";
  protected final String TEXT_188 = ").append(\":\").append(";
  protected final String TEXT_189 = ").append(\"/\").append(";
  protected final String TEXT_190 = ").append(\"?loglevel=\").append(";
  protected final String TEXT_191 = ");" + NL + "\t\t\t";
  protected final String TEXT_192 = NL + "        \t\tsbuilder_";
  protected final String TEXT_193 = ".append(\"&\").append(";
  protected final String TEXT_194 = ");" + NL + "        \t";
  protected final String TEXT_195 = NL + "            String url_";
  protected final String TEXT_196 = " = sbuilder_";
