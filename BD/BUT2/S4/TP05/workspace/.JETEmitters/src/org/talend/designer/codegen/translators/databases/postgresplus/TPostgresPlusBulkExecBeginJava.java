...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_321 = ".getTables(null, dbschema_";
  protected final String TEXT_322 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_323 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_324 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_325 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_345 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_349 = " - Creating table ";
  ...
  protected final String TEXT_357 = " - Create table ";
  ...
  protected final String TEXT_362 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_368 = " - Droping table ";
  ...
  protected final String TEXT_376 = " - Drop table ";
  ...
  protected final String TEXT_385 = " - Creating table ";
  ...
  protected final String TEXT_393 = " - Create table ";
  ...
  protected final String TEXT_399 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_400 = " = conn_";
  protected final String TEXT_401 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_403 = " - Clearing table ";
  ...
  protected final String TEXT_411 = "- Clear table ";
  protected final String TEXT_412 = "\" + tableName_";
  protected final String TEXT_413 = " + \"";
  protected final String TEXT_414 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_415 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_426 = " - Trancating table ";
  ...
  protected final String TEXT_434 = " - Truncate table ";
  protected final String TEXT_435 = "\" + tableName_";
  protected final String TEXT_436 = " + \"";
  protected final String TEXT_437 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_439 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  ...
  protected final String TEXT_443 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_444 = ".close();" + NL + "\t\t";
  protected final String TEXT_445 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_446 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_447 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_448 = NL + "\t";
  protected final String TEXT_449 = NL + "        int keyCount_";
  protected final String TEXT_450 = " = ";
  protected final String TEXT_451 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_452 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_453 = " = tableName_";
  protected final String TEXT_454 = ";" + NL + "        tableName_";
  protected final String TEXT_455 = " = \"tmp_";
  protected final String TEXT_456 = "\" + \"_\" + pid + Thread.currentThread().getId();        " + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_460 = " - Creating temp table ";
  protected final String TEXT_461 = "\" + tableName_";
  protected final String TEXT_462 = " + \"";
  protected final String TEXT_463 = ".\" );" + NL + "\t\t";
  protected final String TEXT_464 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_465 = ".execute(\"";
  protected final String TEXT_466 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_467 = ".close();";
  protected final String TEXT_468 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_469 = " - Create temp table ";
  ...
  protected final String TEXT_474 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_475 = " =conn_";
  protected final String TEXT_476 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_477 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_478 = ".close();" + NL + "   \t\t";
  protected final String TEXT_479 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  ...
  protected final String TEXT_483 = " - Bulk SQL:\"+bulkSQL_";
  ...
  protected final String TEXT_490 = ".execute(bulkSQL_";
  protected final String TEXT_491 = ");" + NL + "        stmtTmpBulk_";
  ...
  protected final String TEXT_497 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_498 = NL + "        tableName_";
  protected final String TEXT_499 = " = tmpTableName_";
  protected final String TEXT_500 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_501 = " = \"tmp_";
  protected final String TEXT_502 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_503 = " = conn_";
  protected final String TEXT_504 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_505 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_506 = " - Updating ";
  protected final String TEXT_507 = "\" + tableName_";
  protected final String TEXT_508 = " + \"";
  protected final String TEXT_509 = " from ";
  protected final String TEXT_510 = "\"+tmpTableName_";
  protected final String TEXT_511 = "+\"";
  protected final String TEXT_512 = ".\");" + NL + "\t\t";
  protected final String TEXT_513 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_514 = ".executeUpdate(\"";
  protected final String TEXT_515 = "\");" + NL + "\t\t";
  protected final String TEXT_516 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_517 = ".close();" + NL + "        tableName_";
  protected final String TEXT_518 = " = tmpTableName_";
  protected final String TEXT_519 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_523 = " - Droping temp table ";
  ...
  protected final String TEXT_528 = ".execute(\"";
  protected final String TEXT_529 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_530 = ".close();" + NL + "\t\t";
  protected final String TEXT_531 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_532 = " - Drop temp table ";
  protected final String TEXT_533 = "\" + tableName_";
  protected final String TEXT_534 = "+ \"";
  protected final String TEXT_535 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_536 = NL + "\t    ";
  protected final String TEXT_537 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_538 = " =conn_";
  protected final String TEXT_539 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_540 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_541 = ".close();" + NL + "   \t\t";
  protected final String TEXT_542 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_543 = " = conn_";
  protected final String TEXT_544 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t";
  protected final String TEXT_545 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_546 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_547 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_548 = " - Inserting records in table ";
  protected final String TEXT_549 = "\" + tableName_";
  protected final String TEXT_550 = " + \"";
  protected final String TEXT_551 = ".\");" + NL + "\t";
  protected final String TEXT_552 = NL + "    stmtBulk_";
  protected final String TEXT_553 = ".execute(bulkSQL_";
  protected final String TEXT_554 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_555 = ".close();    " + NL + "\t";
  protected final String TEXT_556 = NL + "\t\tlog.info(\"";
  protected final String TEXT_557 = " - Insert records in table ";
  protected final String TEXT_558 = "\" + tableName_";
  protected final String TEXT_559 = " + \"";
  protected final String TEXT_560 = " has finished.\");" + NL + "\t";
