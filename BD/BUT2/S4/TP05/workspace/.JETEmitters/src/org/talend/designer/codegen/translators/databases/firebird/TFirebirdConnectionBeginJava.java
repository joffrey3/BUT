...
public class TFirebirdConnectionBeginJava
{
  ...
  protected final String TEXT_125 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_126 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_127 = " == null) {";
  protected final String TEXT_128 = NL + "\t\t";
  protected final String TEXT_129 = NL + "\t\t";
  protected final String TEXT_130 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_131 = "\", conn_";
  protected final String TEXT_132 = ");";
  protected final String TEXT_133 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_134 = " = ";
  protected final String TEXT_135 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_136 = ".get(dsAlias_";
  protected final String TEXT_137 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_138 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_139 = " = dataSources_";
  protected final String TEXT_140 = ".get(dsAlias_";
  protected final String TEXT_141 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_142 = "\", conn_";
  protected final String TEXT_143 = ");" + NL + "\t}";
  protected final String TEXT_144 = NL + "\tif (null != conn_";
