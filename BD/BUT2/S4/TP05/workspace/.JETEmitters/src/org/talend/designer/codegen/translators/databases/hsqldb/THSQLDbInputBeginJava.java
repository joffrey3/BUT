...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_182 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_183 = " + \":\" + ";
  protected final String TEXT_184 = " + \"/\" + ";
  protected final String TEXT_185 = ";";
  protected final String TEXT_186 = NL + "\t\t            url_";
  protected final String TEXT_187 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_188 = " + \":\" + ";
  protected final String TEXT_189 = " + \"/\" + ";
  protected final String TEXT_190 = ";";
  protected final String TEXT_191 = NL + "\t\t            url_";
  protected final String TEXT_192 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_193 = " + \":\" + ";
  protected final String TEXT_194 = " + \"/\" + ";
  protected final String TEXT_195 = ";";
  protected final String TEXT_196 = NL + "\t\t            url_";
  protected final String TEXT_197 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_198 = " + \":\" + ";
  protected final String TEXT_199 = " + \"/\" + ";
  protected final String TEXT_200 = ";";
  protected final String TEXT_201 = NL + "\t\t        url_";
  protected final String TEXT_202 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_203 = " + \"/\" + ";
  protected final String TEXT_204 = ";";
  protected final String TEXT_205 = NL + "\t\t\t\turl_";
  protected final String TEXT_206 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_207 = " ;";
  protected final String TEXT_208 = NL + "\t\t\t\turl_";
  protected final String TEXT_209 = " += \";\" + ";
  protected final String TEXT_210 = ";";
  protected final String TEXT_211 = NL + "    " + NL + "\t";
  protected final String TEXT_212 = NL + "\t\t    int nb_line_";
  protected final String TEXT_213 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_214 = " = null;";
  protected final String TEXT_215 = NL + "\t\t        conn_";
  protected final String TEXT_216 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_248 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_249 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_378 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_379 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_380 = ".getClob(i_";
  protected final String TEXT_381 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_382 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_383 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_384 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_385 = ".add(tNTextImpl_";
  protected final String TEXT_386 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_387 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_388 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_389 = ".getColumnTypeName(i_";
  protected final String TEXT_390 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_391 = ".add(rs_";
  protected final String TEXT_392 = ".getString(i_";
  protected final String TEXT_393 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_394 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = ", rs_";
  protected final String TEXT_397 = ", fixedColumnCount_";
  protected final String TEXT_398 = ",list_";
  protected final String TEXT_399 = ",";
  protected final String TEXT_400 = ");";
  protected final String TEXT_401 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_402 = ".";
  protected final String TEXT_403 = ", rs_";
  protected final String TEXT_404 = ", fixedColumnCount_";
  protected final String TEXT_405 = ",";
  protected final String TEXT_406 = ");";
  protected final String TEXT_407 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = ", rs_";
  protected final String TEXT_410 = ", fixedColumnCount_";
  protected final String TEXT_411 = ",";
  protected final String TEXT_412 = ");";
  protected final String TEXT_413 = NL + "                                  Object geom = rs_";
  protected final String TEXT_414 = ".getObject(";
  protected final String TEXT_415 = "column_index_";
  protected final String TEXT_416 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_417 = ".";
  protected final String TEXT_418 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_425 = " - Retrieving the record \" + nb_line_";
