...
public class TELTPostgresqlOutputMainJava
{
  ...
  protected final String TEXT_136 = ".prepareStatement(updateQuery_";
  protected final String TEXT_137 = ");" + NL;
  protected final String TEXT_138 = NL + "\t" + NL + "\tString deleteQuery_";
  protected final String TEXT_139 = " = \"DELETE  FROM \"+ tableName_";
  ...
  protected final String TEXT_146 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_147 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_148 = NL + "int nb_line_";
  protected final String TEXT_149 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_150 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_151 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_152 = " = 0;" + NL + "\t";
  protected final String TEXT_153 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery_";
  ...
  protected final String TEXT_162 = " " + NL + "nb_line_updated_";
  protected final String TEXT_163 = " = pstmt_";
  protected final String TEXT_164 = ".executeUpdate();";
  protected final String TEXT_165 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_166 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_167 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_168 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_169 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_170 = " = pstmt_";
  protected final String TEXT_171 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_172 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_173 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_174 = NL + NL + "pstmt_";
  protected final String TEXT_175 = ".close();" + NL;
  protected final String TEXT_176 = NL + "    if(conn_";
  protected final String TEXT_177 = " != null && !conn_";
  protected final String TEXT_178 = ".isClosed()) {" + NL + "\t\t";
