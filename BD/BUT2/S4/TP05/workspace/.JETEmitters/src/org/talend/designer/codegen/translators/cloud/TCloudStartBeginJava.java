...
public class TCloudStartBeginJava
{
  ...
  protected final String TEXT_18 = NL + "\t\torg.jclouds.aws.ec2.features.AWSKeyPairApi keyPairClient_";
  protected final String TEXT_19 = " = context_";
  protected final String TEXT_20 = ".unwrapApi(org.jclouds.aws.ec2.AWSEC2Api.class).getKeyPairApi().get();" + NL + "\t\torg.jclouds.ec2.domain.KeyPair result_";
  ...
  protected final String TEXT_62 = " = null;" + NL + "\t" + NL + "\ttry {" + NL + "\t\tnodes_";
  protected final String TEXT_63 = " = context_";
  protected final String TEXT_64 = ".getComputeService().createNodesInGroup(";
  protected final String TEXT_65 = ".toLowerCase(), ";
  protected final String TEXT_66 = ", template_";
  protected final String TEXT_67 = ");" + NL + "\t} catch(com.google.common.util.concurrent.UncheckedExecutionException e_";
  protected final String TEXT_68 = ") {" + NL + "\t\tboolean ignoreException_";
  protected final String TEXT_69 = " = false;" + NL + "\t\tif(e_";
  protected final String TEXT_70 = ".getCause()!=null && (e_";
  protected final String TEXT_71 = ".getCause() instanceof java.lang.NullPointerException)) {" + NL + "\t\t\tif(\"name\".equals(e_";
  protected final String TEXT_72 = ".getCause().getMessage())) {" + NL + "\t\t\t\tignoreException_";
  protected final String TEXT_73 = " = true;" + NL + "\t\t\t\tSystem.err.println(\"Some exception happen when get the running instance information object, you can avoid it by setting the key pair\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tif(!ignoreException_";
  protected final String TEXT_74 = ") {" + NL + "\t\t\tthrow e_";
  protected final String TEXT_75 = ";" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_76 = "_NODE_GROUP\", ";
  protected final String TEXT_77 = ".toLowerCase());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_78 = "_NODES\", nodes_";
