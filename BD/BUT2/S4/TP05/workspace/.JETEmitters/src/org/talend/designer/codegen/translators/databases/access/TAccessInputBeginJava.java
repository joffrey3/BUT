...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_181 = " + \";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true\";";
  ...
  protected final String TEXT_269 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_270 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
