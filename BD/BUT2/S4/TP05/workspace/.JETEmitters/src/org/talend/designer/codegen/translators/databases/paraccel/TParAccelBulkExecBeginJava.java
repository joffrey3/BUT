...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_342 = ".getTables(null, dbschema_";
  protected final String TEXT_343 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_344 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_345 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_346 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_370 = " - Creating table ";
  ...
  protected final String TEXT_378 = " - Create table ";
  ...
  protected final String TEXT_383 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_384 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_385 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_389 = " - Droping table ";
  ...
  protected final String TEXT_397 = " - Drop table ";
  ...
  protected final String TEXT_420 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_424 = " - Clearing table ";
  ...
  protected final String TEXT_432 = "- Clear table ";
  ...
  protected final String TEXT_447 = " - Trancating table ";
  ...
  protected final String TEXT_455 = " - Truncate table ";
  protected final String TEXT_456 = "\" + tableName_";
  protected final String TEXT_457 = " + \"";
  protected final String TEXT_458 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_460 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_461 = " += rsTruncCount_";
  protected final String TEXT_462 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_463 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_464 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_465 = ".close();" + NL + "\t\t";
  protected final String TEXT_466 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_467 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_468 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_469 = NL + "\t";
  protected final String TEXT_470 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_471 = " = conn_";
  protected final String TEXT_472 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_473 = NL + "\t";
  protected final String TEXT_474 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_475 = " - Paralle bulk SQL:\"+xpxSQL_";
  protected final String TEXT_476 = "+\".\");" + NL + "\t\tlog.debug(\"";
  protected final String TEXT_477 = " - Executing parallel bulk SQL.\");" + NL + "\t";
  protected final String TEXT_478 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_479 = " = conn_";
  protected final String TEXT_480 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_481 = ".execute(xpxSQL_";
  protected final String TEXT_482 = ");";
  protected final String TEXT_483 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_484 = " - Execute parallel bulk SQL has finished.\");" + NL + "\t";
  protected final String TEXT_485 = NL + "    stmtXPX_";
  protected final String TEXT_486 = ".close();    ";
  protected final String TEXT_487 = NL + "\t";
  protected final String TEXT_488 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_489 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_490 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_491 = " - Bulk inserting data into ";
  protected final String TEXT_492 = "\" + tableName_";
  protected final String TEXT_493 = " + \"";
  protected final String TEXT_494 = ".\" );" + NL + "\t";
  protected final String TEXT_495 = NL + "    stmtBulk_";
  protected final String TEXT_496 = ".execute(bulkSQL_";
  protected final String TEXT_497 = ");" + NL + "\t";
  protected final String TEXT_498 = NL + "\t\tlog.info(\"";
  protected final String TEXT_499 = " - Bulk insert data into ";
  protected final String TEXT_500 = "\" + tableName_";
  protected final String TEXT_501 = " + \"";
  protected final String TEXT_502 = " has finished.\");" + NL + "\t";
