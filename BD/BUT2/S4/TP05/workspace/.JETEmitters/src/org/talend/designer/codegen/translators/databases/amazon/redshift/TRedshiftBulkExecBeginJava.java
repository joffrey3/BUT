...
public class TRedshiftBulkExecBeginJava {
  ...
  protected final String TEXT_80 = ";" + NL + "\tString tableName2_";
  protected final String TEXT_81 = " = tableName_";
  protected final String TEXT_82 = ";" + NL + "\tboolean isTempTable_";
  protected final String TEXT_83 = " = tableName_";
  protected final String TEXT_84 = "!=null && tableName_";
  protected final String TEXT_85 = ".trim().startsWith(\"#\");" + NL + "\tif(isTempTable_";
  protected final String TEXT_86 = ") {" + NL + "\t\ttableName2_";
  protected final String TEXT_87 = " = \"\\\"\" + tableName2_";
  protected final String TEXT_88 = " + \"\\\"\";" + NL + "\t} else if(dbschema_";
  protected final String TEXT_89 = " == null || dbschema_";
  protected final String TEXT_90 = ".trim().length() == 0) {" + NL + "\t\t//do nothing" + NL + "\t} else {" + NL + "\t\ttableName_";
  protected final String TEXT_91 = " = dbschema_";
  protected final String TEXT_92 = " + \"\\\".\\\"\" + tableName_";
  protected final String TEXT_93 = ";" + NL + "\t\ttableName2_";
  protected final String TEXT_94 = " = dbschema_";
  protected final String TEXT_95 = " + \".\" + tableName2_";
  protected final String TEXT_96 = ";" + NL + "\t}" + NL + "" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_102 = " = \"com.amazon.redshift.jdbc41.Driver\";" + NL + "\t\tClass.forName(driverClass_";
  protected final String TEXT_103 = ").newInstance();" + NL + "\t\t";
  protected final String TEXT_104 = NL + "\t\t\tString url_";
  protected final String TEXT_105 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = " + \"/\" + ";
  protected final String TEXT_108 = ";" + NL + "\t\t";
  protected final String TEXT_109 = NL + "\t\t\tString url_";
  protected final String TEXT_110 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_111 = " + \":\" + ";
  protected final String TEXT_112 = " + \"/\" + ";
  protected final String TEXT_113 = " + \"?\" + ";
  protected final String TEXT_114 = ";" + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\t";
  protected final String TEXT_116 = " " + NL + "\t\tfinal String decryptedPass_";
  protected final String TEXT_117 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_118 = ");" + NL + "\t\t";
  protected final String TEXT_119 = NL + "\t\tfinal String decryptedPass_";
  protected final String TEXT_120 = " = ";
  protected final String TEXT_121 = "; " + NL + "\t\t";
  protected final String TEXT_122 = NL + "\t\tString dbUser_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_125 = " = decryptedPass_";
  ...
  protected final String TEXT_275 = NL + "            \tString tableForSearch_";
  protected final String TEXT_276 = " = ";
  protected final String TEXT_277 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_278 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_279 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_280 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_281 = " =  tableForSearch_";
  protected final String TEXT_282 = ".substring(1,tableForSearch_";
  protected final String TEXT_283 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_284 = " =  tableForSearch_";
  protected final String TEXT_285 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_289 = ".getTables(null, conn_";
  protected final String TEXT_290 = ".getSchema(), tableForSearch_";
  protected final String TEXT_291 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_292 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_293 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_294 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_300 = ".getTables(null, dbschema_";
  protected final String TEXT_301 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_302 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_303 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_304 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_323 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_324 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_325 = " = conn_";
  protected final String TEXT_326 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_328 = " - Creating table ";
  ...
  protected final String TEXT_336 = " - Create table ";
  protected final String TEXT_337 = "\" + tableName_";
  protected final String TEXT_338 = " + \"";
  protected final String TEXT_339 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_340 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_341 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_343 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_347 = " - Droping table ";
  ...
  protected final String TEXT_355 = " - Drop table ";
  ...
  protected final String TEXT_364 = " - Creating table ";
  ...
  protected final String TEXT_372 = " - Create table ";
  ...
  protected final String TEXT_378 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_382 = " - Clearing table ";
  ...
  protected final String TEXT_403 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_405 = " - Trancating table ";
  protected final String TEXT_406 = "\" + tableName_";
  protected final String TEXT_407 = " + \"";
  protected final String TEXT_408 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_409 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_410 = ".executeUpdate(\"";
  protected final String TEXT_411 = "\");" + NL + "   \t    \t";
  protected final String TEXT_412 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_413 = " - Truncate table ";
  protected final String TEXT_414 = "\" + tableName_";
  protected final String TEXT_415 = " + \"";
  protected final String TEXT_416 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_418 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_419 = " += rsTruncCount_";
  protected final String TEXT_420 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_421 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_422 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_423 = ".close();" + NL + "\t\t";
  protected final String TEXT_424 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_425 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_426 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_427 = NL + "\tStringBuilder command_";
  protected final String TEXT_428 = " = new StringBuilder();";
  protected final String TEXT_429 = NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_430 = " = ";
  protected final String TEXT_431 = NL + "\t\t',';";
  protected final String TEXT_432 = NL + "\t\tString.valueOf(";
  protected final String TEXT_433 = ").charAt(0);";
  protected final String TEXT_434 = NL + "\t\tchar textEnclosure_";
  protected final String TEXT_435 = " = ";
  protected final String TEXT_436 = NL + "\t\t'\\0';" + NL + "\t";
  protected final String TEXT_437 = NL + "\t\t'\"';";
  protected final String TEXT_438 = NL + "\t\tString.valueOf(";
  protected final String TEXT_439 = ").charAt(0);";
  protected final String TEXT_440 = NL + "\tcommand_";
  protected final String TEXT_441 = ".append(\"COPY \").append(tableName2_";
  protected final String TEXT_442 = ")" + NL + "\t";
  protected final String TEXT_443 = NL + "\t\t.append(\" (\")";
  protected final String TEXT_444 = NL + "\t\t\t.append(\"";
  protected final String TEXT_445 = "\")";
  protected final String TEXT_446 = NL + "\t\t\t.append(\",\")";
  protected final String TEXT_447 = NL + "\t\t.append(\")\")";
  protected final String TEXT_448 = NL + "\t.append(\" FROM '\");";
  protected final String TEXT_449 = NL + "\t";
  protected final String TEXT_450 = " " + NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_451 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_452 = ");" + NL + "\t";
  protected final String TEXT_453 = NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_454 = " = ";
  protected final String TEXT_455 = "; " + NL + "\t";
  protected final String TEXT_456 = NL + "\t";
  protected final String TEXT_457 = NL + "\t\tStringBuilder avro_builder_";
  protected final String TEXT_458 = " = new StringBuilder();" + NL + "\t\tif(\"auto\".equals(";
  protected final String TEXT_459 = ")) {" + NL + "\t\t\tavro_builder_";
  protected final String TEXT_460 = ".append(\"FORMAT AS AVRO '\").append(\"auto\").append(\"' \");" + NL + "\t\t} else {" + NL + "\t\t\tavro_builder_";
  protected final String TEXT_461 = ".append(\"FORMAT AVRO '\").append(";
  protected final String TEXT_462 = ").append(\"' \");" + NL + "\t\t}";
  protected final String TEXT_463 = NL + "\t\tcommand_";
  protected final String TEXT_464 = ".append(\"s3://\").append(";
  protected final String TEXT_465 = ").append(\"/\").append(";
  protected final String TEXT_466 = ")";
  protected final String TEXT_467 = NL + "\t\tString hdfspath_";
  protected final String TEXT_468 = " = ";
  protected final String TEXT_469 = ";" + NL + "\t\tif(hdfspath_";
  protected final String TEXT_470 = "!=null && hdfspath_";
  protected final String TEXT_471 = ".startsWith(\"/\")) {" + NL + "\t\t\thdfspath_";
  protected final String TEXT_472 = " = hdfspath_";
  protected final String TEXT_473 = ".substring(1);" + NL + "\t\t}" + NL + "\t\tcommand_";
  protected final String TEXT_474 = ".append(\"emr://\").append(";
  protected final String TEXT_475 = ").append(\"/\").append(hdfspath_";
  protected final String TEXT_476 = ")";
  protected final String TEXT_477 = NL + "\t\tcommand_";
  protected final String TEXT_478 = ".append(\"dynamodb://\").append(";
  protected final String TEXT_479 = ")";
  protected final String TEXT_480 = NL + "\t\tcommand_";
  protected final String TEXT_481 = ".append(\"s3://\").append(";
  protected final String TEXT_482 = ").append(\"/\").append(";
  protected final String TEXT_483 = ")";
  protected final String TEXT_484 = NL + "\t.append(\"' \")" + NL + "\t" + NL + "\t.append(\"credentials 'aws_access_key_id=\").append(";
  protected final String TEXT_485 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_486 = ")";
  protected final String TEXT_487 = NL + "\t\t.append(\";master_symmetric_key=\").append(";
  protected final String TEXT_488 = ")";
  protected final String TEXT_489 = NL + "\t.append(\"' \")";
  protected final String TEXT_490 = NL + "\t.append(\"READRATIO \").append(";
  protected final String TEXT_491 = ").append(\" \");";
  protected final String TEXT_492 = NL + "\t.append(\"SSH \")";
  protected final String TEXT_493 = NL + "\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_494 = ").append(\"' \")";
  protected final String TEXT_495 = NL + "\t.append(\"JSON '\").append(";
  protected final String TEXT_496 = ").append(\"' \")";
  protected final String TEXT_497 = NL + "\t.append(avro_builder_";
  protected final String TEXT_498 = ")";
  protected final String TEXT_499 = NL + "\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_500 = ").append(\"' \")";
  protected final String TEXT_501 = NL + "\t;";
  protected final String TEXT_502 = NL + "\tif(textEnclosure_";
  protected final String TEXT_503 = "!='\\0') {" + NL + "\t\tcommand_";
  protected final String TEXT_504 = ".append(\"CSV QUOTE '\").append(textEnclosure_";
  protected final String TEXT_505 = ").append(\"' \");" + NL + "\t}";
  protected final String TEXT_506 = NL + "\t\tcommand_";
  protected final String TEXT_507 = ".append(\"ENCODING \").append(";
  ...
  protected final String TEXT_516 = NL + "\t\t\tcommand_";
  ...
  protected final String TEXT_521 = ".append(\"MAXERROR \").append(";
  protected final String TEXT_522 = ").append(\" \");";
  protected final String TEXT_523 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_524 = ".append(\"ACCEPTINVCHARS \");";
  protected final String TEXT_525 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_526 = ".append(\"ACCEPTINVCHARS '\").append(";
  protected final String TEXT_527 = ").append(\"' \");";
  protected final String TEXT_528 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_529 = ".append(\"";
  protected final String TEXT_530 = " ON \");";
  protected final String TEXT_531 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_532 = ".append(\"";
  protected final String TEXT_533 = " OFF \");";
  protected final String TEXT_534 = NL + "\t\tcommand_";
  protected final String TEXT_535 = ".append(\"ENCRYPTED \");";
  protected final String TEXT_536 = NL + "\t\tcommand_";
  protected final String TEXT_537 = ".append(\"";
  protected final String TEXT_538 = " \");";
  protected final String TEXT_539 = NL + "\t\tcommand_";
  protected final String TEXT_540 = ".append(\"DATEFORMAT '\").append(";
  protected final String TEXT_541 = ").append(\"' \");";
  protected final String TEXT_542 = NL + "\t\tcommand_";
  protected final String TEXT_543 = ".append(\"DATEFORMAT 'auto' \");";
  protected final String TEXT_544 = NL + "\t\tcommand_";
  protected final String TEXT_545 = ".append(\"TIMEFORMAT '\").append(";
  protected final String TEXT_546 = ").append(\"' \");";
  protected final String TEXT_547 = NL + "\t\tcommand_";
  protected final String TEXT_548 = ".append(\"TIMEFORMAT 'auto' \");";
  protected final String TEXT_549 = NL + "\t\tcommand_";
  protected final String TEXT_550 = ".append(\"TIMEFORMAT 'epochsecs' \");";
  protected final String TEXT_551 = NL + "\t\tcommand_";
  protected final String TEXT_552 = ".append(\"TIMEFORMAT 'epochmillisecs' \");";
  protected final String TEXT_553 = NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_554 = "=conn_";
  protected final String TEXT_555 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_556 = ".execute(command_";
  protected final String TEXT_557 = ".toString());";
  protected final String TEXT_558 = NL + "\t\tif(stmt_";
  protected final String TEXT_559 = ".getWarnings()!=null) {";
  protected final String TEXT_560 = NL + "\t\t\tlog.warn(\"";
  protected final String TEXT_561 = " - \" + stmt_";
  protected final String TEXT_562 = ".getWarnings().getMessage());";
  protected final String TEXT_563 = NL + "\t\t\tSystem.err.println(stmt_";
  protected final String TEXT_564 = ".getWarnings().getMessage());";
  protected final String TEXT_565 = NL + "\t\t}";
  protected final String TEXT_566 = NL + "\t";
  protected final String TEXT_567 = NL + "\t\tlog.info(\"";
  protected final String TEXT_568 = " - Finish loading data to table : \" + tableName2_";
