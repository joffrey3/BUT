...
public class TSybaseSCDBeginJava {
  ...
  protected final String TEXT_38 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  protected final String TEXT_39 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_40 = ", ";
  protected final String TEXT_41 = ", decryptedPassword_";
  protected final String TEXT_42 = ");    ";
  protected final String TEXT_43 = NL + "    if(dbschema_";
