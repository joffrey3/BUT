...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_181 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_182 = " = ";
  protected final String TEXT_183 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_184 = "!=null && key_";
  protected final String TEXT_185 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_186 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_187 = " - Deleting an object with key:\" + ";
  protected final String TEXT_188 = ");" + NL + "\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\tconn_";
  protected final String TEXT_190 = ".deleteObject(";
  protected final String TEXT_191 = ", key_";
  protected final String TEXT_192 = ");" + NL + "\t\t\t";
  protected final String TEXT_193 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_194 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_195 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_196 = "){" + NL + "\t\t";
  protected final String TEXT_197 = NL + "\t\t\tthrow(e_";
  ...
  protected final String TEXT_202 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_203 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_204 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_205 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_206 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
