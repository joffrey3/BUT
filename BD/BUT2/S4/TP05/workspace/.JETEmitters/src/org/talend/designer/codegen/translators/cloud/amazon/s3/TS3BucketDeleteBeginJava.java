...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_183 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_184 = ");" + NL + "\t\t";
  protected final String TEXT_185 = NL + "\t\tconn_";
  protected final String TEXT_186 = ".deleteBucket(";
  protected final String TEXT_187 = ");" + NL + "\t\t";
  protected final String TEXT_188 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_189 = " - Delete the bucket successfully.\");" + NL + "\t\t";
