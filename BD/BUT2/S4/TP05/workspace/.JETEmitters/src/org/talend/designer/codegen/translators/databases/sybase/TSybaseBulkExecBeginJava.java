...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_128 = " = \"com.sybase.jdbc4.jdbc.SybDriver\";" + NL + "\t\t";
  protected final String TEXT_129 = NL + "\t\t\t String driverClass_";
  protected final String TEXT_130 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";" + NL + "\t    ";
  ...
  protected final String TEXT_144 = " - Droping table ";
  protected final String TEXT_145 = "\" + tableName_";
  ...
  protected final String TEXT_152 = " - Drop table ";
  protected final String TEXT_153 = "\" + tableName_";
  protected final String TEXT_154 = " + \"";
  protected final String TEXT_155 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_157 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_161 = " - Creating table ";
  ...
  protected final String TEXT_169 = " - Create table ";
  ...
  protected final String TEXT_223 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_236 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_240 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_241 = ".equals(schema_";
  protected final String TEXT_242 = ") || (schema_";
  protected final String TEXT_243 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_244 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_253 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_254 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_255 = " == null || dbschema_";
  protected final String TEXT_256 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_259 = " = stmtSchema_";
  protected final String TEXT_260 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_261 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_262 = " = rsSchema_";
  protected final String TEXT_263 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_264 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_265 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_280 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_281 = ".equals";
  protected final String TEXT_282 = "IgnoreCase";
  protected final String TEXT_283 = "(schema_";
  ...
  protected final String TEXT_287 = NL + "            \tString tableForSearch_";
  protected final String TEXT_288 = " = ";
  protected final String TEXT_289 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_290 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_291 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_292 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_293 = " =  tableForSearch_";
  protected final String TEXT_294 = ".substring(1,tableForSearch_";
  protected final String TEXT_295 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_296 = " =  tableForSearch_";
  protected final String TEXT_297 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_298 = " = conn_";
  protected final String TEXT_299 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_300 = " = dbMetaData_";
  protected final String TEXT_301 = ".getTables(null, conn_";
  protected final String TEXT_302 = ".getSchema(), tableForSearch_";
  protected final String TEXT_303 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_304 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_305 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_306 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  ...
  protected final String TEXT_312 = ".getTables(null, dbschema_";
  protected final String TEXT_313 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_314 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_315 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_316 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_440 = NL + NL + "StringBuilder command_";
  protected final String TEXT_441 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_442 = ".append(";
  protected final String TEXT_443 = " + \" \");";
  protected final String TEXT_444 = NL + "    String tmpTableName_";
  protected final String TEXT_445 = " = tableName_";
  protected final String TEXT_446 = ";" + NL + "    tableName_";
  protected final String TEXT_447 = " = \"tmp_";
  protected final String TEXT_448 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_449 = " != null && dbschema_";
  protected final String TEXT_450 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  protected final String TEXT_451 = "=dbschema_";
  protected final String TEXT_452 = " + \".\" + tableName_";
  protected final String TEXT_453 = ";" + NL + "    }";
  protected final String TEXT_454 = NL + "if(dbschema_";
  protected final String TEXT_455 = " != null && dbschema_";
  protected final String TEXT_456 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_457 = ".append(db_";
  protected final String TEXT_458 = " + \".\" + tableName_";
  protected final String TEXT_459 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_460 = ".append(db_";
  protected final String TEXT_461 = " + \"..\" + tableName_";
  protected final String TEXT_462 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_463 = ".append(\" in \" + ";
  protected final String TEXT_464 = ");" + NL + "String headRow_";
  protected final String TEXT_465 = " = ";
  protected final String TEXT_466 = ";" + NL + "if(headRow_";
  protected final String TEXT_467 = " != null && headRow_";
  protected final String TEXT_468 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_469 = ".append(\" -F \" + headRow_";
  protected final String TEXT_470 = ");" + NL + "}" + NL;
  protected final String TEXT_471 = NL + "\tcommand_";
  protected final String TEXT_472 = ".append(\" -b \" + ";
  protected final String TEXT_473 = ");";
  protected final String TEXT_474 = NL + NL + "command_";
  protected final String TEXT_475 = ".append(\" -t \" + ";
  protected final String TEXT_476 = ");" + NL + "command_";
  protected final String TEXT_477 = ".append(\" -r \" + ";
  protected final String TEXT_478 = ");" + NL + "command_";
  protected final String TEXT_479 = ".append(\" -c -U \" + dbUser_";
  protected final String TEXT_480 = " + \" -P \" + dbPwd_";
  protected final String TEXT_481 = ");";
  protected final String TEXT_482 = NL + "command_";
  protected final String TEXT_483 = ".append(\" -I \" + ";
  protected final String TEXT_484 = ");";
  protected final String TEXT_485 = NL + "    command_";
  protected final String TEXT_486 = ".append(\" -S \" + ";
  protected final String TEXT_487 = ");";
  protected final String TEXT_488 = NL + "\tcommand_";
  protected final String TEXT_489 = ".append(\" -S \" + host_";
  protected final String TEXT_490 = ");";
  protected final String TEXT_491 = NL + "String encoding_";
  protected final String TEXT_492 = " = ";
  protected final String TEXT_493 = ";" + NL + "if(encoding_";
  protected final String TEXT_494 = " != null && encoding_";
  protected final String TEXT_495 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_496 = ".append(\" -J \" + encoding_";
  protected final String TEXT_497 = ");" + NL + "}" + NL;
  protected final String TEXT_498 = NL + "\tlog.info(\"";
  protected final String TEXT_499 = " - Executing command:'\" + command_";
  protected final String TEXT_500 = " + \"'.\");";
  protected final String TEXT_501 = NL + "    Runtime runtime_";
  protected final String TEXT_502 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_503 = " = runtime_";
  protected final String TEXT_504 = ".exec(command_";
  protected final String TEXT_505 = ".toString());";
  protected final String TEXT_506 = NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_510 = " - Creating temp table ";
  protected final String TEXT_511 = "\" + tableName_";
  protected final String TEXT_512 = " + \"";
  protected final String TEXT_513 = ".\" );" + NL + "\t\t";
  protected final String TEXT_514 = NL + "        stmtCreateTmp_";
  protected final String TEXT_515 = ".execute(\"";
  protected final String TEXT_516 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_517 = ".close();            ";
  protected final String TEXT_518 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_519 = " - Create temp table ";
  protected final String TEXT_520 = "\" + tableName_";
  protected final String TEXT_521 = " + \"";
  protected final String TEXT_522 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_523 = NL + "        Runtime runtime_";
  protected final String TEXT_524 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_525 = " = runtime_";
  protected final String TEXT_526 = ".exec(command_";
  protected final String TEXT_527 = ".toString());       ";
  protected final String TEXT_528 = NL + NL + "Thread normal_";
  protected final String TEXT_529 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_530 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_531 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_532 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_533 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_534 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_535 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_536 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_537 = ".start();" + NL + "" + NL + "Thread error_";
  ...
  protected final String TEXT_539 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_540 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  ...
  protected final String TEXT_545 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_546 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_547 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_548 = ".interrupt();" + NL + "error_";
  protected final String TEXT_549 = ".interrupt();";
  protected final String TEXT_550 = NL + "\tlog.info(\"";
  protected final String TEXT_551 = " - Excute command: '\" + command_";
  protected final String TEXT_552 = " + \"' has finished.\");";
