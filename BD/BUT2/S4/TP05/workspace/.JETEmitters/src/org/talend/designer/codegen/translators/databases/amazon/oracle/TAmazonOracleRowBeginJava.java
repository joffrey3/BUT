...
public class TAmazonOracleRowBeginJava
{
  ...
  protected final String TEXT_118 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_119 = " + \":\" + ";
  protected final String TEXT_120 = " + \":\" + ";
  protected final String TEXT_121 = ";" + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\tString url_";
  protected final String TEXT_123 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_124 = " + \")(port=\" + ";
  protected final String TEXT_125 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_126 = " + \")))\";" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tString url_";
  protected final String TEXT_128 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_129 = ";" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\tString atnParams_";
  protected final String TEXT_131 = " = ";
  protected final String TEXT_132 = ";" + NL + "\t\t\t\tatnParams_";
  protected final String TEXT_133 = " = atnParams_";
  protected final String TEXT_134 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_135 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_136 = ".put(\"user\",dbUser_";
  protected final String TEXT_137 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_138 = ".put(\"password\",dbPwd_";
  protected final String TEXT_139 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_140 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_141 = ".getBytes()));" + NL + "\t\t\t\tconn_";
  protected final String TEXT_142 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_143 = ", atnParamsPrope_";
  ...
  protected final String TEXT_151 = ".prepareStatement(";
