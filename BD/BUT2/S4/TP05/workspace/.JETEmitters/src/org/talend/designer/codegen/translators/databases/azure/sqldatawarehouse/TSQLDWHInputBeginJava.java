...
public class TSQLDWHInputBeginJava
{
  ...
  protected final String TEXT_211 = " += \";applicationName=Talend;\" + ";
  ...
  protected final String TEXT_290 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_291 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
