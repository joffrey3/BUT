...
public class TSQLDWHRowBeginJava
{
  ...
  protected final String TEXT_117 = NL + "\t\t\tString port_";
  protected final String TEXT_118 = " = ";
  protected final String TEXT_119 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_120 = " = ";
  protected final String TEXT_121 = " ;" + NL + "\t\t    ";
  protected final String TEXT_122 = NL + "\t\t\tString url_";
  protected final String TEXT_123 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_124 = " ;" + NL + "\t\t\t";
  protected final String TEXT_125 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_126 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_127 = " ;" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_129 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_130 = " += \":\" + ";
  protected final String TEXT_131 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  ...
  protected final String TEXT_139 = NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_140 = " += \";applicationName=Talend;\" + ";
  protected final String TEXT_141 = ";" + NL + "\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_143 = " = (String)globalMap.get(\"";
  protected final String TEXT_144 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "\t    \t\t";
  protected final String TEXT_148 = NL + "\t\t        String  tableName_";
  protected final String TEXT_149 = " = null;" + NL + "\t\t        if(dbschema_";
  ...
  protected final String TEXT_157 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_158 = " +\" ON\");" + NL + "\t\t\t";
  protected final String TEXT_159 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_160 = " = null;" + NL + "\tString query_";
  protected final String TEXT_161 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_162 = " = false;";
  ...
  protected final String TEXT_167 = NL + "\t\tjava.sql.Statement stmt_";
