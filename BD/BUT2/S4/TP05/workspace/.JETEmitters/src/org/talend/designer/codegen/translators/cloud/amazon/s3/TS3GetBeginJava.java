...
public class TS3GetBeginJava
{
  ...
  protected final String TEXT_183 = " - Getting an object with key:\" + ";
  protected final String TEXT_184 = ");" + NL + "\t\t";
  protected final String TEXT_185 = NL + "\t\tconn_";
  protected final String TEXT_186 = ".getObject(new com.amazonaws.services.s3.model.GetObjectRequest(";
  protected final String TEXT_187 = ", ";
  protected final String TEXT_188 = "),new java.io.File(";
  protected final String TEXT_189 = "));" + NL + "\t\t";
  protected final String TEXT_190 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_191 = " - Get the object successfully.\");" + NL + "\t\t";
