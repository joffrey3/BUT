...
public class TEXABulkExecBeginJava {
  ...
  protected final String TEXT_290 = ".getTables(null, dbschema_";
  ...
  protected final String TEXT_294 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_419 = "_NB_LINE_DELETED\", deletedCount_";
  protected final String TEXT_420 = ");" + NL + "org.talend.database.exasol.imp.EXABulkUtil ";
  protected final String TEXT_421 = " = new org.talend.database.exasol.imp.EXABulkUtil();";
  protected final String TEXT_422 = NL;
  protected final String TEXT_423 = ".setOnlyBuildSQLCode(";
  protected final String TEXT_424 = ");";
  protected final String TEXT_425 = NL;
  protected final String TEXT_426 = ".setConnection(conn_";
  protected final String TEXT_427 = ");";
  protected final String TEXT_428 = NL;
  protected final String TEXT_429 = ".setTable(tableName_";
  protected final String TEXT_430 = ");";
  protected final String TEXT_431 = NL + "// Source is a file" + NL + "// setup the format of date values if no dedicated pattern is provided for a column ";
  protected final String TEXT_432 = NL;
  protected final String TEXT_433 = ".setDefaultDateFormat(";
  protected final String TEXT_434 = ");";
  protected final String TEXT_435 = NL + "// setup the format of timestamp values if no dedicated pattern is provided for a column";
  protected final String TEXT_436 = NL;
  protected final String TEXT_437 = ".setDefaultTimestampFormat(";
  protected final String TEXT_438 = ");";
  protected final String TEXT_439 = NL + "// setup numeric separators, default if nothing set is the English format";
  protected final String TEXT_440 = NL;
  protected final String TEXT_441 = ".setDefaultNumericCharacters(";
  protected final String TEXT_442 = ", ";
  protected final String TEXT_443 = ");";
  protected final String TEXT_444 = NL;
  protected final String TEXT_445 = ".setFileOptColumnEnclosure(";
  protected final String TEXT_446 = ");";
  protected final String TEXT_447 = NL;
  protected final String TEXT_448 = ".setFileOptColumnSeparator(";
  protected final String TEXT_449 = ");";
  protected final String TEXT_450 = NL;
  protected final String TEXT_451 = ".setFileOptEncoding(";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL;
  protected final String TEXT_454 = ".setFileOptRowSeparator(";
  protected final String TEXT_455 = ");";
  protected final String TEXT_456 = NL;
  protected final String TEXT_457 = ".setFileOptTrim(\"";
  protected final String TEXT_458 = "\");";
  protected final String TEXT_459 = NL;
  protected final String TEXT_460 = ".setFileOptSkip(";
  protected final String TEXT_461 = ");";
  protected final String TEXT_462 = NL;
  protected final String TEXT_463 = ".setFileOptNullIdentifier(";
  protected final String TEXT_464 = ");";
  protected final String TEXT_465 = NL + "// add column configurations";
  protected final String TEXT_466 = NL;
  protected final String TEXT_467 = ".addCSVDateColumn(\"";
  protected final String TEXT_468 = "\", null, ";
  protected final String TEXT_469 = ");";
  protected final String TEXT_470 = NL;
  protected final String TEXT_471 = ".addCSVNumberColumn(\"";
  protected final String TEXT_472 = "\", null, ";
  protected final String TEXT_473 = ", ";
  protected final String TEXT_474 = ", ";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL;
  protected final String TEXT_477 = ".addCSVColumn(\"";
  protected final String TEXT_478 = "\", null);";
  protected final String TEXT_479 = NL;
  protected final String TEXT_480 = ".setRemoteExistingFileConnectionName(";
  protected final String TEXT_481 = ");";
  protected final String TEXT_482 = NL;
  protected final String TEXT_483 = ".setRemoteExistingDBConnectionName(";
  protected final String TEXT_484 = ");";
  protected final String TEXT_485 = NL;
  protected final String TEXT_486 = ".setRemoteUser(";
  protected final String TEXT_487 = ");";
  protected final String TEXT_488 = NL;
  protected final String TEXT_489 = ".setRemotePassword(";
  protected final String TEXT_490 = ");";
  protected final String TEXT_491 = NL;
  protected final String TEXT_492 = ".setLocalFilePath(";
  protected final String TEXT_493 = ");";
  protected final String TEXT_494 = NL;
  protected final String TEXT_495 = ".setTransferSecure(";
  protected final String TEXT_496 = ");";
  protected final String TEXT_497 = NL;
  protected final String TEXT_498 = ".setRemoteFileUrl(";
  protected final String TEXT_499 = ");";
  protected final String TEXT_500 = NL;
  protected final String TEXT_501 = ".setRemoteFileUrlParameters(";
  protected final String TEXT_502 = ");";
  protected final String TEXT_503 = NL;
  protected final String TEXT_504 = ".setRemoteFileName(";
  protected final String TEXT_505 = ");";
  protected final String TEXT_506 = NL;
  protected final String TEXT_507 = ".setDbmsSourceType(\"EXA\");";
  protected final String TEXT_508 = NL;
  protected final String TEXT_509 = ".setRemoteDbmsUrl(";
  protected final String TEXT_510 = ");";
  protected final String TEXT_511 = NL;
  protected final String TEXT_512 = ".setDbmsSourceType(\"JDBC\");";
  protected final String TEXT_513 = NL;
  protected final String TEXT_514 = ".setRemoteDbmsUrl(";
  protected final String TEXT_515 = ");";
  protected final String TEXT_516 = NL;
  protected final String TEXT_517 = ".setDbmsSourceType(\"ORA\");";
  protected final String TEXT_518 = NL;
  protected final String TEXT_519 = ".setRemoteDbmsUrl(";
  protected final String TEXT_520 = ");";
  protected final String TEXT_521 = NL;
  protected final String TEXT_522 = ".setRemoteSourceSelect(";
  protected final String TEXT_523 = ");";
  protected final String TEXT_524 = NL;
  protected final String TEXT_525 = ".setRemoteSourceTable(";
  protected final String TEXT_526 = ", ";
  protected final String TEXT_527 = ");";
  protected final String TEXT_528 = NL;
  protected final String TEXT_529 = ".addRemoteSourceTableColumn(\"";
  protected final String TEXT_530 = "\", ";
  protected final String TEXT_531 = ", null);";
  protected final String TEXT_532 = NL;
  protected final String TEXT_533 = ".setErrorRejectLimit(";
  protected final String TEXT_534 = ");";
  protected final String TEXT_535 = NL + "// setup error monitoring to a log table";
  protected final String TEXT_536 = NL;
  protected final String TEXT_537 = ".setErrorTableWithCurrentTimestamp(";
  protected final String TEXT_538 = ");";
  protected final String TEXT_539 = NL;
  protected final String TEXT_540 = ".setErrorTable(";
  protected final String TEXT_541 = ");";
  protected final String TEXT_542 = NL + "// setup error monitoring to a local log file";
  protected final String TEXT_543 = NL;
  protected final String TEXT_544 = ".setLocalErrorFileWithCurrentTimestamp(";
  protected final String TEXT_545 = ");";
  protected final String TEXT_546 = NL;
  protected final String TEXT_547 = ".setLocalErrorFile(";
  protected final String TEXT_548 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_549 = "_ERROR_LOG_FILE\", ";
  protected final String TEXT_550 = ".getLocalErrorFile());";
  protected final String TEXT_551 = NL + "// execute the import" + NL + "try {";
  protected final String TEXT_552 = NL + "\t globalMap.put(\"";
  protected final String TEXT_553 = "_FILENAME\", ";
  protected final String TEXT_554 = ".getLocalFilePath());";
  protected final String TEXT_555 = NL + "    ";
  protected final String TEXT_556 = ".executeImport();" + NL + "    insertedCount_";
  protected final String TEXT_557 = " = ";
  protected final String TEXT_558 = ".getCountAffectedRows();";
  protected final String TEXT_559 = NL + "    ";
  protected final String TEXT_560 = ".commitAndClose();";
  protected final String TEXT_561 = NL + "    globalMap.put(\"";
  protected final String TEXT_562 = "_NB_LINE_INSERTED\", insertedCount_";
  protected final String TEXT_563 = "); " + NL + "} catch (Exception e) {" + NL + "\t globalMap.put(\"";
  protected final String TEXT_564 = "_ERROR_MESSAGE\", \"Import failed: \" + e.getMessage());";
  protected final String TEXT_565 = NL + "    ";
  protected final String TEXT_566 = ".rollbackAndClose();";
  protected final String TEXT_567 = NL + "\t throw e;" + NL + "}";
