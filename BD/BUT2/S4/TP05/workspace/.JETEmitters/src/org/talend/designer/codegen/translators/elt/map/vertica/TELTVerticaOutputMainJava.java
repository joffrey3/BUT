...
public class TELTVerticaOutputMainJava
{
  ...
  protected final String TEXT_70 = NL + "\tString select_query_";
  protected final String TEXT_71 = " = null;" + NL + "\tString tableName_";
  ...
  protected final String TEXT_81 = NL + "\tString dbschema_";
  protected final String TEXT_82 = " = ";
  protected final String TEXT_83 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_84 = " != null && dbschema_";
  protected final String TEXT_85 = ".trim().length() > 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_86 = " = ";
  protected final String TEXT_87 = " + \".\" + ";
  protected final String TEXT_88 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_99 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_100 = " + \":\" + ";
  protected final String TEXT_101 = " + \"/\" + ";
  protected final String TEXT_102 = ";";
  protected final String TEXT_103 = NL + "\t\t\tString url_";
  protected final String TEXT_104 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_127 = NL + "\t\tStringBuilder info_";
  protected final String TEXT_128 = " = new StringBuilder();";
  protected final String TEXT_129 = NL + "\t\tinfo_";
  protected final String TEXT_130 = ".append(\"/*\");";
  protected final String TEXT_131 = NL + "\t\tinfo_";
  protected final String TEXT_132 = ".append(\"+ direct \");";
  protected final String TEXT_133 = NL + "\t\tinfo_";
  protected final String TEXT_134 = ".append(\"+ label(\").append(";
  protected final String TEXT_135 = ").append(\") \");";
  protected final String TEXT_136 = NL + "\t\tinfo_";
  protected final String TEXT_137 = ".append(\"*/\");";
  protected final String TEXT_138 = "\t" + NL + "\t\tString insertQuery_";
  protected final String TEXT_139 = " = \"INSERT \" + info_";
  protected final String TEXT_140 = " + \" INTO \"+tableName_";
  protected final String TEXT_141 = "+\" (";
  protected final String TEXT_142 = ") (\"+select_query_";
  protected final String TEXT_143 = "+\")\";" + NL + "\t\tpstmt_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".prepareStatement(insertQuery_";
  protected final String TEXT_146 = ");";
  protected final String TEXT_147 = NL + "\t\tString updateQuery_";
  protected final String TEXT_148 = " = \"UPDATE \" + info_";
  protected final String TEXT_149 = " + \" \"+tableName_";
  protected final String TEXT_150 = "+\" SET ";
  protected final String TEXT_151 = " \"";
  protected final String TEXT_152 = NL + "\t\t\t+\"  WHERE \" + ";
  protected final String TEXT_153 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".prepareStatement(updateQuery_";
  protected final String TEXT_156 = ");" + NL;
  protected final String TEXT_157 = NL + "\t\tString deleteQuery_";
  protected final String TEXT_158 = " = \"DELETE \" + info_";
  protected final String TEXT_159 = " + \" FROM \"+ tableName_";
  protected final String TEXT_160 = "+\" WHERE EXISTS (\"+ select_query_";
  protected final String TEXT_161 = ".replaceAll(selectQueryColumnsName_";
  ...
  protected final String TEXT_166 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_167 = ");";
  protected final String TEXT_168 = NL + "\t\tint nb_line_";
  protected final String TEXT_169 = " = 0;" + NL + "\t\tint nb_line_updated_";
  protected final String TEXT_170 = " = 0;" + NL + "\t\tint nb_line_inserted_";
  protected final String TEXT_171 = " = 0;" + NL + "\t\tint nb_line_deleted_";
  protected final String TEXT_172 = " = 0;";
  protected final String TEXT_173 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery_";
  protected final String TEXT_174 = " + \"\\n\");" + NL + "\t\t";
  protected final String TEXT_175 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_176 = " += nb_line_inserted_";
  ...
  protected final String TEXT_184 = " += nb_line_updated_";
  protected final String TEXT_185 = " = pstmt_";
  protected final String TEXT_186 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_187 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_188 = " + \" rows updated. \\n\");";
  protected final String TEXT_189 = NL + "\t\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_190 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_191 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_192 = " += nb_line_deleted_";
  protected final String TEXT_193 = " = pstmt_";
  protected final String TEXT_194 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_195 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_196 = " + \" rows deleted. \\n\");";
  protected final String TEXT_197 = NL + NL + "\tpstmt_";
  protected final String TEXT_198 = ".close();" + NL;
  protected final String TEXT_199 = NL + "    if(conn_";
  protected final String TEXT_200 = " != null && !conn_";
  protected final String TEXT_201 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_202 = NL + "    }";
  protected final String TEXT_203 = NL + NL + "\tglobalMap.put(\"";
  protected final String TEXT_204 = "_NB_LINE\",nb_line_";
  protected final String TEXT_205 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_206 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_213 = " - Has ";
  protected final String TEXT_214 = " records count: \" + nb_line_";
