...
public class TELTNetezzaOutputMainJava
{
  ...
  protected final String TEXT_81 = NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_87 = " = \"org.netezza.Driver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_116 = NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_117 = " =null;";
  protected final String TEXT_118 = "\t" + NL + "\t\tString insertQuery_";
  protected final String TEXT_119 = " = \"INSERT INTO \"+";
  protected final String TEXT_120 = "+\"(";
  protected final String TEXT_121 = ") (\"+select_query_";
  protected final String TEXT_122 = "+\")\";" + NL + "\t\tpstmt_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".prepareStatement(insertQuery_";
  protected final String TEXT_125 = ");";
  protected final String TEXT_126 = NL + "\t\tString updateQuery_";
  protected final String TEXT_127 = " = \"UPDATE \"+";
  protected final String TEXT_128 = ";" + NL + "\t\tupdateQuery_";
  protected final String TEXT_129 = " +=\" SET ";
  protected final String TEXT_130 = " \" +select_query_";
  protected final String TEXT_131 = ".substring(select_query_";
  protected final String TEXT_132 = ".indexOf(\"FROM\"));";
  protected final String TEXT_133 = NL + "\t\tif(select_query_";
  protected final String TEXT_134 = ".indexOf(\"WHERE\")==-1){" + NL + "\t\tupdateQuery_";
  protected final String TEXT_135 = " +=\"  WHERE \";" + NL + "\t\t}else{" + NL + "\t\tupdateQuery_";
  protected final String TEXT_136 = " +=\"  AND \";" + NL + "\t\t} " + NL + "\t\tupdateQuery_";
  protected final String TEXT_137 = "+= ";
  protected final String TEXT_138 = ";";
  protected final String TEXT_139 = NL + "\t\tpstmt_";
  protected final String TEXT_140 = " = conn_";
  protected final String TEXT_141 = ".prepareStatement(updateQuery_";
  protected final String TEXT_142 = ");" + NL;
  protected final String TEXT_143 = NL + "\t\tString deleteQuery_";
  protected final String TEXT_144 = " = \"DELETE  FROM \"+";
  protected final String TEXT_145 = ";" + NL + "\t\tdeleteQuery_";
  ...
  protected final String TEXT_151 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_152 = ");";
  protected final String TEXT_153 = NL + "\tint nb_line_";
  protected final String TEXT_154 = " = 0;" + NL + "\tint nb_line_updated_";
  protected final String TEXT_155 = " = 0;" + NL + "\tint nb_line_inserted_";
  protected final String TEXT_156 = " = 0;" + NL + "\tint nb_line_deleted_";
  protected final String TEXT_157 = " = 0;";
  protected final String TEXT_158 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery_";
  ...
  protected final String TEXT_177 = " += nb_line_deleted_";
  protected final String TEXT_178 = " = pstmt_";
  protected final String TEXT_179 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_180 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_181 = " + \" rows deleted. \\n\");";
  protected final String TEXT_182 = NL + NL + "\tpstmt_";
  protected final String TEXT_183 = ".close();";
  protected final String TEXT_184 = NL + "    if(conn_";
  protected final String TEXT_185 = " != null && !conn_";
  protected final String TEXT_186 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_187 = NL + "    }";
  protected final String TEXT_188 = NL + NL + "globalMap.put(\"";
  protected final String TEXT_189 = "_NB_LINE\",nb_line_";
  protected final String TEXT_190 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_191 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_192 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_193 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  ...
  protected final String TEXT_198 = " - Has ";
  protected final String TEXT_199 = " records count: \" + nb_line_";
