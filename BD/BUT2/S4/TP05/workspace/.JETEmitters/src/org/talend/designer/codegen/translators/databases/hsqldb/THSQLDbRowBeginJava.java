...
public class THSQLDbRowBeginJava
{
  ...
  protected final String TEXT_121 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_122 = " + \":\" + ";
  protected final String TEXT_123 = " + \"/\" + ";
  protected final String TEXT_124 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_126 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_127 = " + \":\" + ";
  protected final String TEXT_128 = " + \"/\" + ";
  protected final String TEXT_129 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_131 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_132 = " + \":\" + ";
  protected final String TEXT_133 = " + \"/\" + ";
  protected final String TEXT_134 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_136 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_137 = " + \":\" + ";
  protected final String TEXT_138 = " + \"/\" + ";
  protected final String TEXT_139 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\turl_";
  protected final String TEXT_141 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_142 = " + \"/\" + ";
  protected final String TEXT_143 = " ;" + NL + "\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\turl_";
  protected final String TEXT_145 = " = \"jdbc:hsqldb:mem:\" + ";
