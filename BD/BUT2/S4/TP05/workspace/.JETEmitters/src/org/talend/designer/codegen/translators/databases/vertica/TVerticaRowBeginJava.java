...
public class TVerticaRowBeginJava
{
  ...
  protected final String TEXT_118 = " = \"jdbc:vertica://\"+";
  protected final String TEXT_119 = "+\":\"+";
  protected final String TEXT_120 = "+\"/\"+";
  protected final String TEXT_121 = ";" + NL + "\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\tString url_";
  protected final String TEXT_123 = " = \"jdbc:vertica://\"+";
  protected final String TEXT_124 = "+\":\"+";
  protected final String TEXT_125 = "+\"/\"+";
  protected final String TEXT_126 = " + \"?\" + ";
  protected final String TEXT_127 = ";" + NL + "\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_129 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_131 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_132 = NL + "\t\t\t\tint nb_line_deleted_";
