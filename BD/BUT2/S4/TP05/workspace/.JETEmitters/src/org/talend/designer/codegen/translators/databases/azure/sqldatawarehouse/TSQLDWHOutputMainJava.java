...
public class TSQLDWHOutputMainJava {
  ...
  protected final String TEXT_1262 = "{" + NL + "            \t\tpublic int limitBytePart1(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_1263 = ") throws Exception {" + NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1264 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1265 = ": pstmt_";
  protected final String TEXT_1266 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1267 = " == -2 || countEach_";
  protected final String TEXT_1268 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcounter += countEach_";
  protected final String TEXT_1269 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1270 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1271 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1272 = NL + "                \tint countSum_";
  protected final String TEXT_1273 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1274 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcounter += (countEach_";
  protected final String TEXT_1275 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1276 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_1277 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1278 = NL + "               \t\t\t }" + NL + "    \t\t\t\treturn counter;" + NL + "            \t}" + NL + "            \t" + NL + "            \tpublic int limitBytePart2(int counter,java.sql.PreparedStatement pstmt_";
  protected final String TEXT_1279 = ") throws Exception {" + NL + "                try {" + NL + "                \t\t";
  protected final String TEXT_1280 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1281 = ": pstmt_";
  protected final String TEXT_1282 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1283 = " == -2 || countEach_";
  protected final String TEXT_1284 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcounter += countEach_";
  protected final String TEXT_1285 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1286 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1287 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1288 = NL + "                \t" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1289 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcounter += (countEach_";
  protected final String TEXT_1290 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1291 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "            \t    \t";
  protected final String TEXT_1292 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1293 = NL + "                \t\t}\t" + NL + "                \treturn counter;\t" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_1294 = NL + "    \t\tif ((batchSize_";
  protected final String TEXT_1295 = " > 0) && (batchSize_";
  protected final String TEXT_1296 = " <= batchSizeCounter_";
  protected final String TEXT_1297 = ")) {" + NL + "    \t\t" + NL + "    \t\t            ";
  protected final String TEXT_1298 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1299 = " = new LimitBytesHelper_";
  protected final String TEXT_1300 = "().limitBytePart1(insertedCount_";
  protected final String TEXT_1301 = ",pstmt_";
  protected final String TEXT_1302 = ");" + NL + "            \t    \t";
  protected final String TEXT_1303 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1304 = " = new LimitBytesHelper_";
  protected final String TEXT_1305 = "().limitBytePart1(updatedCount_";
  protected final String TEXT_1306 = ",pstmt_";
  protected final String TEXT_1307 = ");" + NL + "            \t    \t";
  protected final String TEXT_1308 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1309 = " = new LimitBytesHelper_";
  protected final String TEXT_1310 = "().limitBytePart1(deletedCount_";
  protected final String TEXT_1311 = ",pstmt_";
  protected final String TEXT_1312 = ");" + NL + "            \t    \t";
  protected final String TEXT_1313 = NL + "    \t\t\t" + NL + "\t\t\t    batchSizeCounter_";
  protected final String TEXT_1314 = " = 0;" + NL + "\t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1315 = NL + NL + "    \t////////////commit every////////////" + NL + "    \t\t\t";
  protected final String TEXT_1316 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1317 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1318 = " <= commitCounter_";
  protected final String TEXT_1319 = ") {";
  protected final String TEXT_1320 = NL + "                if ((batchSize_";
  protected final String TEXT_1321 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1322 = " > 0)) {" + NL + "    \t\t            ";
  protected final String TEXT_1323 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1324 = " = new LimitBytesHelper_";
  protected final String TEXT_1325 = "().limitBytePart1(insertedCount_";
  protected final String TEXT_1326 = ",pstmt_";
  protected final String TEXT_1327 = ");" + NL + "            \t    \t";
  protected final String TEXT_1328 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1329 = " = new LimitBytesHelper_";
  protected final String TEXT_1330 = "().limitBytePart1(updatedCount_";
  protected final String TEXT_1331 = ",pstmt_";
  protected final String TEXT_1332 = ");" + NL + "            \t    \t";
  protected final String TEXT_1333 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1334 = " = new LimitBytesHelper_";
  protected final String TEXT_1335 = "().limitBytePart1(deletedCount_";
  protected final String TEXT_1336 = ",pstmt_";
  protected final String TEXT_1337 = ");" + NL + "            \t    \t";
  protected final String TEXT_1338 = NL + "            \tbatchSizeCounter_";
  protected final String TEXT_1339 = " = 0;" + NL + "            \t}";
  protected final String TEXT_1340 = NL + "                \t";
  protected final String TEXT_1341 = NL + "                \tconn_";
  protected final String TEXT_1342 = ".commit();" + NL + "            \t\t";
  protected final String TEXT_1343 = NL + "                \tcommitCounter_";
  protected final String TEXT_1344 = "=0;" + NL + "                }";
  protected final String TEXT_1345 = NL + "\t\tif (isShareIdentity_";
  protected final String TEXT_1346 = " ) {" + NL + "        \t stmt_";
  protected final String TEXT_1347 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_1348 = " +\"] OFF\");" + NL + "        }";
