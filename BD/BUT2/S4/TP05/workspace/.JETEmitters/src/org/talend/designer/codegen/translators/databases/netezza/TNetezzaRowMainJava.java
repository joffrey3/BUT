...
public class TNetezzaRowMainJava
{
  ...
  protected final String TEXT_105 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_110 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_111 = "_NB_LINE_UPDATED\", nb_line_update_";
  protected final String TEXT_112 = ");";
  protected final String TEXT_113 = NL + "\t\tnb_line_deleted_";
  protected final String TEXT_114 = " += pstmt_";
  protected final String TEXT_115 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_116 = "_NB_LINE_DELETED\", nb_line_deleted_";
  protected final String TEXT_117 = ");";
  protected final String TEXT_118 = NL + "\t\tnb_line_inserted_";
  protected final String TEXT_119 = " += stmt_";
  protected final String TEXT_120 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_121 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_122 = ");";
  protected final String TEXT_123 = NL + "\t\tnb_line_update_";
  protected final String TEXT_124 = " += stmt_";
  protected final String TEXT_125 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_126 = "_NB_LINE_UPDATED\", nb_line_update_";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "\t\tnb_line_deleted_";
  protected final String TEXT_129 = " += stmt_";
  protected final String TEXT_130 = ".getUpdateCount();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_131 = "_NB_LINE_DELETED\", nb_line_deleted_";
  protected final String TEXT_132 = ");";
  protected final String TEXT_133 = NL + "\t} catch (java.lang.Exception e) {" + NL + "\t\twhetherReject_";
  protected final String TEXT_134 = " = true;" + NL + "\t\t";
  ...
  protected final String TEXT_145 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  protected final String TEXT_146 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_147 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_148 = NL + "\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_149 = NL + "\t}" + NL + "\t";
  protected final String TEXT_150 = NL + "\tif(!whetherReject_";
  ...
  protected final String TEXT_157 = " = rs_";
  ...
  protected final String TEXT_165 = NL + "\t\tcommitCounter_";
  protected final String TEXT_166 = "++;" + NL + "\t\tif(commitEvery_";
  protected final String TEXT_167 = " <= commitCounter_";
  protected final String TEXT_168 = ") {" + NL + "\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\tcommitCounter_";
  protected final String TEXT_170 = "=0;" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_171 = NL + "\tnb_";
  protected final String TEXT_172 = " += pstmt_";
  protected final String TEXT_173 = ".getUpdateCount();";
  protected final String TEXT_174 = NL + "\tnb_";
  protected final String TEXT_175 = " += stmt_";
  protected final String TEXT_176 = ".getUpdateCount();";
