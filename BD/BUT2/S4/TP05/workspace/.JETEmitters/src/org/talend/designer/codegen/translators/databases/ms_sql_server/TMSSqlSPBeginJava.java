...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_125 = ".execute(\"SET NOCOUNT ON\");" + NL + "String spSchema_";
  protected final String TEXT_126 = " = \"\";" + NL + "if(dbschema_";
  protected final String TEXT_127 = " != null && !dbschema_";
  protected final String TEXT_128 = ".trim().isEmpty()) {" + NL + "    spSchema_";
  protected final String TEXT_129 = " = \"[\"+dbschema_";
  protected final String TEXT_130 = "+\"].\";" + NL + "}" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".prepareCall(\"{";
  protected final String TEXT_133 = "call \" + spSchema_";
  protected final String TEXT_134 = " + ";
  protected final String TEXT_135 = " + \"(";
  protected final String TEXT_136 = ")}\"";
  protected final String TEXT_137 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_138 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_139 = ";" + NL + "String tmpString_";
