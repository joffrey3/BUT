...
public class TJMSInputEndJava
{
  ...
  protected final String TEXT_45 = NL + "\tnbline_";
  protected final String TEXT_46 = "++;" + NL + "\tmessage_";
  protected final String TEXT_47 = ".acknowledge();" + NL + "\tif(";
  protected final String TEXT_48 = " > 0 && nbline_";
  protected final String TEXT_49 = " >= ";
  protected final String TEXT_50 = "){" + NL + "\t\tbreak;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "consumer_";
  protected final String TEXT_51 = ".close();" + NL + "resourceMap.remove(\"consumer_";
  protected final String TEXT_52 = "\");" + NL + "session_";
  protected final String TEXT_53 = ".close();" + NL + "resourceMap.remove(\"session_";
  protected final String TEXT_54 = "\");" + NL + "connection_";
  protected final String TEXT_55 = ".close();" + NL + "resourceMap.remove(\"connection_";
  protected final String TEXT_56 = "\");";
  protected final String TEXT_57 = NL + "globalMap.put(\"";
  protected final String TEXT_58 = "_NB_LINE\", nbline_";
