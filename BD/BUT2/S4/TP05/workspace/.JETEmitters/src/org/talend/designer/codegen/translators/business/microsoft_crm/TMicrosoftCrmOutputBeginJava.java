...
public class TMicrosoftCrmOutputBeginJava
{
  ...
  protected final String TEXT_62 = " = org.talend.ms.crm.odata.ClientConfigurationFactory" + NL + "            .buildOAuthClientConfiguration(";
  protected final String TEXT_63 = ", ";
  protected final String TEXT_64 = ", decryptedPassword_";
  protected final String TEXT_65 = ", ";
  protected final String TEXT_66 = ");";
  protected final String TEXT_67 = NL + NL + "\tclientConfig_";
  protected final String TEXT_68 = ".setTimeout(";
  protected final String TEXT_69 = ");" + NL + "\tclientConfig_";
  protected final String TEXT_70 = ".setMaxRetry(reConnMaxNum_";
  protected final String TEXT_71 = ",";
  protected final String TEXT_72 = ");" + NL + "\tclientConfig_";
  protected final String TEXT_73 = ".setReuseHttpClient(";
  protected final String TEXT_74 = ");" + NL + "\torg.talend.ms.crm.odata.DynamicsCRMClient client_";
  protected final String TEXT_75 = " = new org.talend.ms.crm.odata.DynamicsCRMClient(clientConfig_";
  protected final String TEXT_76 = ",";
  protected final String TEXT_77 = ",entitySetName_";
  protected final String TEXT_78 = ");";
  protected final String TEXT_79 = NL + "\tint nb_line_";
  protected final String TEXT_80 = " = 0;" + NL + "\t";
  protected final String TEXT_81 = NL + "\tSystem.setProperty(\"org.apache.commons.logging.Log\", \"org.apache.commons.logging.impl.SimpleLog\");" + NL + "    System.setProperty(\"org.apache.commons.logging.simplelog.showdatetime\", \"true\");" + NL + "    System.setProperty(\"org.apache.commons.logging.simplelog.log.httpclient.wire\", \"debug\");" + NL + "    System.setProperty(\"org.apache.commons.logging.simplelog.log.org.apache.commons.httpclient\", \"debug\");" + NL + "\t";
  protected final String TEXT_82 = NL + "\tSystem.setProperty(\"org.apache.commons.logging.Log\", \"org.apache.commons.logging.impl.NoOpLog\");" + NL + "\t";
  ...
  protected final String TEXT_91 = NL + "\t\t\torg.apache.commons.httpclient.auth.AuthPolicy.registerAuthScheme(org.apache.commons.httpclient.auth.AuthPolicy.NTLM, org.talend.mscrm.login.ntlm.JCIFS_NTLMScheme.class);" + NL + "" + NL + "\t\t\tcom.microsoft.crm4.webserviceTest.CrmServiceStub service_";
  protected final String TEXT_92 = " = new com.microsoft.crm4.webserviceTest.CrmServiceStub(";
  protected final String TEXT_93 = ");" + NL + "\t\t\torg.apache.axis2.client.Options options_";
  protected final String TEXT_94 = " = service_";
  protected final String TEXT_95 = "._getServiceClient().getOptions();" + NL + "\t\t\torg.apache.axis2.transport.http.HttpTransportProperties.Authenticator auth_";
  protected final String TEXT_96 = " = new org.apache.axis2.transport.http.HttpTransportProperties.Authenticator();" + NL + "" + NL + "\t\t\tList<String> authSchemes_";
  protected final String TEXT_97 = " = new java.util.ArrayList<String>();" + NL + "\t\t\tauthSchemes_";
  protected final String TEXT_98 = ".add(org.apache.axis2.transport.http.HttpTransportProperties.Authenticator.NTLM);" + NL + "\t\t\tauth_";
  protected final String TEXT_99 = " .setAuthSchemes(authSchemes_";
  protected final String TEXT_100 = ");" + NL + "" + NL + "            auth_";
  protected final String TEXT_101 = " .setUsername(";
  protected final String TEXT_102 = ");" + NL + "            auth_";
  protected final String TEXT_103 = " .setPassword(decryptedPassword_";
  protected final String TEXT_104 = ");" + NL + "            auth_";
  protected final String TEXT_105 = " .setHost(";
  protected final String TEXT_106 = ");" + NL + "            auth_";
  protected final String TEXT_107 = " .setPort(";
  protected final String TEXT_108 = ");" + NL + "            auth_";
  protected final String TEXT_109 = " .setDomain(";
  protected final String TEXT_110 = ");" + NL + "            auth_";
  protected final String TEXT_111 = " .setPreemptiveAuthentication(false);" + NL + "" + NL + "            options_";
  protected final String TEXT_112 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.AUTHENTICATE, auth_";
  protected final String TEXT_113 = ");" + NL + "            options_";
  protected final String TEXT_114 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.REUSE_HTTP_CLIENT, \"";
  protected final String TEXT_115 = "\");" + NL + "" + NL + "            options_";
  protected final String TEXT_116 = " .setUserName(";
  protected final String TEXT_117 = ");" + NL + "            options_";
  protected final String TEXT_118 = " .setPassword(decryptedPassword_";
  protected final String TEXT_119 = ");" + NL + "            options_";
  protected final String TEXT_120 = " .setTimeOutInMilliSeconds(Long.valueOf(";
  protected final String TEXT_121 = "));" + NL + "" + NL + "            options_";
  protected final String TEXT_122 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.SO_TIMEOUT,new Integer(";
  protected final String TEXT_123 = "));" + NL + "            options_";
  protected final String TEXT_124 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.CONNECTION_TIMEOUT, new Integer(";
  protected final String TEXT_125 = "));" + NL + "" + NL + "            com.microsoft.schemas.crm._2007.webservices.CrmAuthenticationTokenDocument catd_";
  protected final String TEXT_126 = " = com.microsoft.schemas.crm._2007.webservices.CrmAuthenticationTokenDocument.Factory.newInstance();" + NL + "            com.microsoft.schemas.crm._2007.coretypes.CrmAuthenticationToken token_";
  protected final String TEXT_127 = " = com.microsoft.schemas.crm._2007.coretypes.CrmAuthenticationToken.Factory.newInstance();" + NL + "            token_";
  protected final String TEXT_128 = ".setAuthenticationType(0);" + NL + "            token_";
  protected final String TEXT_129 = ".setOrganizationName(";
  protected final String TEXT_130 = ");" + NL + "            catd_";
  protected final String TEXT_131 = ".setCrmAuthenticationToken(token_";
  protected final String TEXT_132 = ");";
  protected final String TEXT_133 = NL + "        \tcom.microsoft.crm4.webserviceTest.CrmServiceStub service_";
  protected final String TEXT_134 = " = new com.microsoft.crm4.webserviceTest.CrmServiceStub(\"https://\" + ";
  protected final String TEXT_135 = " + \"/MSCrmServices/2007/CrmService.asmx\");" + NL + "\t\t\torg.apache.axis2.client.Options options_";
  protected final String TEXT_136 = " = service_";
  protected final String TEXT_137 = "._getServiceClient().getOptions();" + NL + "        \torg.talend.mscrm.login.passport.MsDynamicsWrapper msDynamicsWrapper_";
  protected final String TEXT_138 = " = new org.talend.mscrm.login.passport.MsDynamicsWrapper(";
  protected final String TEXT_139 = ",";
  protected final String TEXT_140 = ",";
  protected final String TEXT_141 = ",decryptedPassword_";
  protected final String TEXT_142 = ");" + NL + "\t\t\tmsDynamicsWrapper_";
  protected final String TEXT_143 = ".connect();" + NL + "\t\t\tString crmTicket_";
  protected final String TEXT_144 = " = msDynamicsWrapper_";
  protected final String TEXT_145 = ".getCrmTicket();" + NL + "" + NL + "        \toptions_";
  protected final String TEXT_146 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.REUSE_HTTP_CLIENT, \"";
  protected final String TEXT_147 = "\");" + NL + "        \toptions_";
  protected final String TEXT_148 = " .setTimeOutInMilliSeconds(Long.valueOf(";
  protected final String TEXT_149 = "));" + NL + "" + NL + "            options_";
  protected final String TEXT_150 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.SO_TIMEOUT,new Integer(";
  protected final String TEXT_151 = "));" + NL + "            options_";
  protected final String TEXT_152 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.CONNECTION_TIMEOUT, new Integer(";
  protected final String TEXT_153 = "));" + NL + "" + NL + "        \tcom.microsoft.schemas.crm._2007.webservices.CrmAuthenticationTokenDocument catd_";
  protected final String TEXT_154 = " = com.microsoft.schemas.crm._2007.webservices.CrmAuthenticationTokenDocument.Factory.newInstance();" + NL + "            com.microsoft.schemas.crm._2007.coretypes.CrmAuthenticationToken token_";
  protected final String TEXT_155 = " = com.microsoft.schemas.crm._2007.coretypes.CrmAuthenticationToken.Factory.newInstance();" + NL + "            token_";
  protected final String TEXT_156 = ".setAuthenticationType(1);" + NL + "            token_";
  protected final String TEXT_157 = ".setOrganizationName(";
  protected final String TEXT_158 = ");" + NL + "            token_";
  protected final String TEXT_159 = ".setCrmTicket(crmTicket_";
  protected final String TEXT_160 = ");" + NL + "            catd_";
  protected final String TEXT_161 = ".setCrmAuthenticationToken(token_";
  protected final String TEXT_162 = ");" + NL + "    \t";
  protected final String TEXT_163 = NL + "    \torg.talend.ms.crm.MSCRMClient client_";
  protected final String TEXT_164 = " = new org.talend.ms.crm.MSCRMClient(";
  protected final String TEXT_165 = ", decryptedPassword_";
  protected final String TEXT_166 = ", ";
  protected final String TEXT_167 = ");" + NL + "\t\tclient_";
  protected final String TEXT_168 = ".setTimeout(";
  protected final String TEXT_169 = ");" + NL + "\t\tclient_";
  protected final String TEXT_170 = ".setReuseHttpClient(";
  protected final String TEXT_171 = ");" + NL + "\t\tclient_";
  protected final String TEXT_172 = ".setMaxConnectionRetries(reConnMaxNum_";
  protected final String TEXT_173 = ");" + NL + "\t\tclient_";
  protected final String TEXT_174 = ".setAttemptsInterval(";
  protected final String TEXT_175 = ");" + NL + "\t\tcom.microsoft.schemas.xrm._2011.contracts.OrganizationServiceStub serviceStub_";
  protected final String TEXT_176 = " = client_";
  protected final String TEXT_177 = ".getOnlineConnection(";
