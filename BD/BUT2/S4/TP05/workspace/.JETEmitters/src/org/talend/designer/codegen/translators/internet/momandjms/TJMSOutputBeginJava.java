...
public class TJMSOutputBeginJava
{
  ...
  protected final String TEXT_45 = NL + "\tjava.util.Hashtable props_";
  ...
  protected final String TEXT_73 = ".start();" + NL + "    resourceMap.put(\"connection_";
  protected final String TEXT_74 = "\",connection_";
  protected final String TEXT_75 = ");" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_76 = " = connection_";
  protected final String TEXT_77 = ".createSession(false, javax.jms.Session.AUTO_ACKNOWLEDGE);" + NL + "    resourceMap.put(\"session_";
  protected final String TEXT_78 = "\",session_";
  protected final String TEXT_79 = ");" + NL + "\t";
  protected final String TEXT_80 = NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_81 = " = (javax.jms.Destination)context_";
  protected final String TEXT_82 = ".lookup(";
  protected final String TEXT_83 = ");" + NL + "\t";
  protected final String TEXT_84 = NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_85 = " = session_";
  protected final String TEXT_86 = ".create";
  protected final String TEXT_87 = "(";
  protected final String TEXT_88 = ");" + NL + "\t";
  protected final String TEXT_89 = NL + NL + "\tjavax.jms.MessageProducer producer_";
  protected final String TEXT_90 = " = session_";
  protected final String TEXT_91 = ".createProducer(dest_";
  protected final String TEXT_92 = ");" + NL + "    resourceMap.put(\"producer_";
  protected final String TEXT_93 = "\",producer_";
  protected final String TEXT_94 = ");" + NL + "" + NL + "\tproducer_";
  protected final String TEXT_95 = ".setDeliveryMode(javax.jms.DeliveryMode.";
  protected final String TEXT_96 = ");" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_97 = " = 0;" + NL + "" + NL + "" + NL + "" + NL + "\t\t";
