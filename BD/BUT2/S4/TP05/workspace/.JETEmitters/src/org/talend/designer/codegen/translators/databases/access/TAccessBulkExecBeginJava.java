...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_315 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_349 = " - Droping table ";
  ...
  protected final String TEXT_357 = " - Drop table ";
  ...
  protected final String TEXT_366 = " - Creating table ";
  ...
  protected final String TEXT_374 = " - Create table ";
  ...
  protected final String TEXT_380 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_403 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_407 = " - Trancating table ";
  protected final String TEXT_408 = "\" + tableName_";
  protected final String TEXT_409 = " + \"";
  protected final String TEXT_410 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_412 = ".executeUpdate(\"";
  protected final String TEXT_413 = "\");" + NL + "   \t    \t";
  protected final String TEXT_414 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_415 = " - Truncate table ";
  protected final String TEXT_416 = "\" + tableName_";
  protected final String TEXT_417 = " + \"";
  protected final String TEXT_418 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_419 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_420 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_421 = " += rsTruncCount_";
  protected final String TEXT_422 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_423 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_424 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_425 = ".close();" + NL + "\t\t";
  protected final String TEXT_426 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_427 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_428 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_429 = " " + NL;
  protected final String TEXT_430 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_431 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_432 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_433 = " + \";HDR=";
  protected final String TEXT_434 = "].[\" + fileName_";
  protected final String TEXT_435 = " + \"]\";" + NL + "\t\tjava.sql.Statement stmt_";
  ...
  protected final String TEXT_439 = " - Bulk SQL:\"+bulkInsert_";
  protected final String TEXT_440 = "+\".\");" + NL + "    \t\tlog.info(\"";
  protected final String TEXT_441 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_442 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_443 = NL + "\t\tstmt_";
  protected final String TEXT_444 = ".execute(bulkInsert_";
  protected final String TEXT_445 = ");" + NL + "" + NL + "\t\tstmt_";
  protected final String TEXT_446 = ".close();" + NL + "\t\t";
  protected final String TEXT_447 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_448 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_449 = " + \" has finished.\");" + NL + "    \t";
