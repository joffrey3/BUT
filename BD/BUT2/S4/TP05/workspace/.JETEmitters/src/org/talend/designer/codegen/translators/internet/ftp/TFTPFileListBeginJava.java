...
public class TFTPFileListBeginJava
{
  ...
  protected final String TEXT_199 = NL + "  \tint nb_file_";
  protected final String TEXT_200 = " = 0;" + NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_201 = " =null;" + NL + "" + NL + "  \t";
  protected final String TEXT_202 = NL + "\t    ftp_";
  protected final String TEXT_203 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_204 = "\");" + NL + "\t\t";
  protected final String TEXT_205 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_206 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_207 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_208 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_209 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_210 = NL + "\t  \t";
  protected final String TEXT_211 = NL + "\t  \t\tString rootDir_";
  protected final String TEXT_212 = " = ftp_";
  protected final String TEXT_213 = ".pwd();" + NL + "\t  \t";
  protected final String TEXT_214 = NL + "\t";
  protected final String TEXT_215 = "    " + NL + "\t    ftp_";
  protected final String TEXT_216 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_217 = ".setRemoteHost(";
  protected final String TEXT_218 = ");" + NL + "\t    ftp_";
  protected final String TEXT_219 = ".setRemotePort(";
  ...
  protected final String TEXT_226 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t    ";
  protected final String TEXT_227 = NL + "\t      ftp_";
  protected final String TEXT_228 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  protected final String TEXT_229 = NL + "\t\t";
  protected final String TEXT_230 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_231 = " - Attempt to connect to '\" + ";
  protected final String TEXT_232 = " + \"' with username '\" +";
  protected final String TEXT_233 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_234 = NL + "\t    ftp_";
  protected final String TEXT_235 = ".setControlEncoding(";
  protected final String TEXT_236 = ");" + NL + "\t    ftp_";
  protected final String TEXT_237 = ".connect();  " + NL + "\t    " + NL + "\t    ";
  ...
  protected final String TEXT_245 = NL + "\t\t" + NL + "\t    ftp_";
  protected final String TEXT_246 = ".login(";
  protected final String TEXT_247 = ", decryptedPassword_";
  protected final String TEXT_248 = "); " + NL + "\t\t";
  protected final String TEXT_249 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_250 = " - Connect to '\" + ";
  protected final String TEXT_251 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_252 = "  " + NL + "\t";
  protected final String TEXT_253 = "      " + NL + "\tString remotedir_";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ";" + NL + "\tftp_";
  protected final String TEXT_256 = ".chdir(remotedir_";
  protected final String TEXT_257 = ");" + NL + "\tString[] fileList_";
  protected final String TEXT_258 = ";" + NL + "" + NL + "\tif (";
  protected final String TEXT_259 = ") {" + NL + "\t\tfileList_";
  protected final String TEXT_260 = " = ftp_";
  protected final String TEXT_261 = ".dir(null, true);" + NL + "\t} else {" + NL + "\t\tfileList_";
  protected final String TEXT_262 = " = ftp_";
  protected final String TEXT_263 = ".dir(null, false);" + NL + "\t}";
  protected final String TEXT_264 = NL + "  \t\t\tftp_";
  protected final String TEXT_265 = ".chdir(rootDir_";
  protected final String TEXT_266 = ");";
  protected final String TEXT_267 = NL + "\tList<String> fileListTemp_";
  protected final String TEXT_268 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "\tfor (String filemask_";
  protected final String TEXT_269 = " : maskList_";
  protected final String TEXT_270 = ") {" + NL + "\t\tjava.util.regex.Pattern fileNamePattern_";
  protected final String TEXT_271 = " = java.util.regex.Pattern.compile(filemask_";
  protected final String TEXT_272 = ".replaceAll(\"\\\\.\", \"\\\\\\\\.\").replaceAll(\"\\\\*\", \".*\"));" + NL + "\t" + NL + "\t    for (String filemaskTemp_";
  protected final String TEXT_273 = " : fileList_";
  protected final String TEXT_274 = ") {" + NL + "\t\t\tif (fileNamePattern_";
  protected final String TEXT_275 = ".matcher(filemaskTemp_";
  protected final String TEXT_276 = ").matches()) {" + NL + "\t        \tfileListTemp_";
  protected final String TEXT_277 = ".add(filemaskTemp_";
  protected final String TEXT_278 = ");" + NL + "\t      \t}" + NL + "\t\t}" + NL + "\t}    " + NL + "\tint i_";
  protected final String TEXT_279 = " = -1;" + NL + "" + NL + "\t";
  protected final String TEXT_280 = NL + "\t\tlog.info(\"";
  protected final String TEXT_281 = " - Listing files from server.\");" + NL + "\t";
  protected final String TEXT_282 = " " + NL + "\twhile (++i_";
  protected final String TEXT_283 = " < fileListTemp_";
  protected final String TEXT_284 = ".size()) {" + NL + "\t    String currentFileName_";
  protected final String TEXT_285 = " = fileListTemp_";
  protected final String TEXT_286 = ".get(i_";
  protected final String TEXT_287 = "); " + NL + "\t    String currentFilePath_";
  protected final String TEXT_288 = " = remotedir_";
  protected final String TEXT_289 = ";" + NL + "\t\tif(!remotedir_";
  protected final String TEXT_290 = ".endsWith(\"/\")&&!remotedir_";
  protected final String TEXT_291 = ".endsWith(\"\\\\\")){" + NL + "\t\t\tcurrentFilePath_";
  protected final String TEXT_292 = " += \"/\";" + NL + "\t\t}" + NL + "\t\tcurrentFilePath_";
  protected final String TEXT_293 = " += fileListTemp_";
  protected final String TEXT_294 = ".get(i_";
  protected final String TEXT_295 = ");" + NL + "\t\t";
  protected final String TEXT_296 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_297 = " - List file : '\" + currentFilePath_";
  protected final String TEXT_298 = " + \"' .\");" + NL + "\t\t";
  protected final String TEXT_299 = " " + NL + "\t    globalMap.put(\"";
  protected final String TEXT_300 = "_CURRENT_FILE\", currentFileName_";
  protected final String TEXT_301 = ");" + NL + "\t    globalMap.put(\"";
  protected final String TEXT_302 = "_CURRENT_FILEPATH\", currentFilePath_";
  protected final String TEXT_303 = ");" + NL + "\t    nb_file_";
