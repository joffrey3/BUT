...
public class TRESTClientMainJava
{
  ...
  protected final String TEXT_302 = NL + "\t\t\twebClient_";
  protected final String TEXT_303 = ".invoke(\"";
  protected final String TEXT_304 = "\", requestBody_";
  protected final String TEXT_305 = ");" + NL + "\t\t";
  protected final String TEXT_306 = NL + NL + NL + "\t\tint webClientResponseStatus_";
  protected final String TEXT_307 = " = webClient_";
  protected final String TEXT_308 = ".getResponse().getStatus();" + NL + "\t\tif (webClientResponseStatus_";
  protected final String TEXT_309 = " >= 300) {" + NL + "\t\t\tthrow new javax.ws.rs.WebApplicationException(webClient_";
  protected final String TEXT_310 = ".getResponse());" + NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_311 = NL + "\t\t\tif (";
  protected final String TEXT_312 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_313 = " = new ";
  protected final String TEXT_314 = "Struct();" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_315 = ".statusCode = webClientResponseStatus_";
  protected final String TEXT_316 = ";" + NL + "\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t\t";
  protected final String TEXT_318 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tObject responseObj_";
  protected final String TEXT_319 = " = responseDoc_";
  protected final String TEXT_320 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\tObject responseObj_";
  protected final String TEXT_322 = " = null;" + NL + "\t\t\t\tif(responseDoc_";
  protected final String TEXT_323 = ".hasEntity()){" + NL + "\t\t\t\t\tresponseObj_";
  protected final String TEXT_324 = " = responseDoc_";
  protected final String TEXT_325 = ".readEntity(responseClass_";
  protected final String TEXT_326 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\tif(responseObj_";
  protected final String TEXT_328 = " != null){" + NL + "\t\t\t\t\tif (responseClass_";
  protected final String TEXT_329 = " == String.class) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_330 = ".string = (String) responseObj_";
  protected final String TEXT_331 = ";" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\troutines.system.Document responseTalendDoc_";
  protected final String TEXT_332 = " = null;" + NL + "\t\t\t\t\t\tif (null != responseObj_";
  protected final String TEXT_333 = ") {" + NL + "\t\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_334 = " = new routines.system.Document();" + NL + "\t\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_335 = ".setDocument((org.dom4j.Document) responseObj_";
  protected final String TEXT_336 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_337 = ".body = responseTalendDoc_";
  protected final String TEXT_338 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_339 = NL + NL + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_340 = "_HEADERS\", webClient_";
  protected final String TEXT_341 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_343 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_344 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_345 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t// handle \"oneway\" for PUT, POST and PATCH with empty response payload" + NL + "\t\t\tif (webClientResponseStatus_";
  protected final String TEXT_348 = " == 202 && responseObj_";
  protected final String TEXT_349 = " == null){" + NL + "\t\t\t\t";
  protected final String TEXT_350 = ".string = \"\";" + NL + "\t\t\t\treturn;" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_351 = NL + "\t\t";
  protected final String TEXT_352 = NL + NL + "\t} catch (javax.ws.rs.WebApplicationException ex_";
  protected final String TEXT_353 = ") {" + NL + "\t\t";
  protected final String TEXT_354 = NL + "\t\t\tif (";
  protected final String TEXT_355 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_356 = " = new ";
  protected final String TEXT_357 = "Struct();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_358 = ".errorCode = ex_";
  protected final String TEXT_359 = ".getResponse().getStatus();" + NL + "" + NL + "\t\t\tString errorMessage_";
  protected final String TEXT_360 = " = null;" + NL + "\t\t\ttry {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_361 = " = ex_";
  protected final String TEXT_362 = ".getResponse().readEntity(String.class);" + NL + "\t\t\t} catch (Exception exe_";
  protected final String TEXT_363 = ") {" + NL + "\t\t\t\t// ignore" + NL + "\t\t\t}" + NL + "\t\t\tif (null == errorMessage_";
  protected final String TEXT_364 = " || 0 == errorMessage_";
  protected final String TEXT_365 = ".trim().length()) {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_366 = " = ex_";
  protected final String TEXT_367 = ".getMessage();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_368 = ".errorMessage = errorMessage_";
  protected final String TEXT_369 = ";" + NL + "" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_370 = "_HEADERS\", ex_";
  protected final String TEXT_371 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_373 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_374 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_375 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_376 = NL + "\t\t";
  protected final String TEXT_377 = NL + "\t\t\tthrow ex_";
  protected final String TEXT_378 = ";" + NL + "\t\t";
  protected final String TEXT_379 = NL + "\t}" + NL + "" + NL + "} catch(Exception e_";
  protected final String TEXT_380 = ") {" + NL + "\t";
  protected final String TEXT_381 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_382 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_383 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_384 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_385 = NL + "}" + NL;
  protected final String TEXT_386 = NL + "java.util.Collection<String> responseParts_";
  protected final String TEXT_387 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_388 = NL + "org.apache.cxf.jaxrs.ext.multipart.MultipartBody multipartBody_";
  protected final String TEXT_389 = " =responseDoc_";
  protected final String TEXT_390 = ".readEntity(org.apache.cxf.jaxrs.ext.multipart.MultipartBody.class);" + NL + "try {" + NL + "\tfor (org.apache.cxf.jaxrs.ext.multipart.Attachment att_";
  protected final String TEXT_391 = " : multipartBody_";
  protected final String TEXT_392 = ".getAllAttachments()) {" + NL + "       java.io.InputStream is_";
  protected final String TEXT_393 = " = att_";
  protected final String TEXT_394 = ".getDataHandler().getInputStream();" + NL + "       java.util.Scanner s_";
  protected final String TEXT_395 = " = new java.util.Scanner(is_";
  protected final String TEXT_396 = ").useDelimiter(\"\\\\A\");" + NL + "       responseParts_";
  protected final String TEXT_397 = ".add(s_";
  protected final String TEXT_398 = ".hasNext() ? s_";
  protected final String TEXT_399 = ".next() : \"\");" + NL + "       is_";
  protected final String TEXT_400 = ".close();" + NL + "   }" + NL + "} catch (java.io.IOException e_";
  protected final String TEXT_401 = ") {" + NL + "\t";
  protected final String TEXT_402 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_403 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_404 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_405 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_406 = NL + "}";
  protected final String TEXT_407 = NL + "for (String responsePart_";
  protected final String TEXT_408 = " : responseDoc_";
  protected final String TEXT_409 = ") {" + NL + "    responseParts_";
  protected final String TEXT_410 = ".add(responsePart_";
  protected final String TEXT_411 = ");" + NL + "}";
  protected final String TEXT_412 = NL + "for (String responsePart_";
  protected final String TEXT_413 = " : responseParts_";
  protected final String TEXT_414 = ") {" + NL + "    row1 = new row1Struct();" + NL + "    row1.string = responsePart_";
