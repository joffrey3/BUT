...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_724 = NL + "                    \texInsertColValue";
  protected final String TEXT_725 = NL + "                    \t";
  protected final String TEXT_726 = NL + "                        .c";
  protected final String TEXT_727 = "(";
  protected final String TEXT_728 = ".";
  protected final String TEXT_729 = ")";
  protected final String TEXT_730 = NL + "\t\t\t\t\t\texInsertColValue";
  protected final String TEXT_731 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_732 = NL + "\t\t\t\t\t\t.c";
  protected final String TEXT_733 = "(";
  protected final String TEXT_734 = ".";
  protected final String TEXT_735 = ".clone())";
  protected final String TEXT_736 = NL + "\t\t\t\t;";
  protected final String TEXT_737 = NL + NL + "\t\t\t\texInsertColValueList";
  protected final String TEXT_738 = ".add(exInsertColValue";
  protected final String TEXT_739 = ");" + NL + "\t\t\t\trowCount";
  protected final String TEXT_740 = "++;" + NL + "" + NL + "                nb_line_";
  protected final String TEXT_741 = "++;" + NL + "" + NL + "\t\t\t\tif(rowCount";
  protected final String TEXT_742 = " == ";
  protected final String TEXT_743 = "){" + NL + "\t                insertedCount_";
  protected final String TEXT_744 = " = insertedCount_";
  protected final String TEXT_745 = " + pstmt_";
  protected final String TEXT_746 = ".executeUpdate();" + NL + "\t                exInsertColValueList";
  protected final String TEXT_747 = ".clear();" + NL + "\t                rowCount";
  protected final String TEXT_748 = " = 0;" + NL + "\t\t\t\t\tcounter";
  protected final String TEXT_749 = "=1;" + NL + "\t\t\t\t}";
  protected final String TEXT_750 = NL + "                    ";
  protected final String TEXT_751 = NL + "                    int count_";
  protected final String TEXT_752 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_753 = ".";
  protected final String TEXT_754 = ", pstmt_";
  ...
  protected final String TEXT_763 = NL + "                       pstmt_";
  protected final String TEXT_764 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_765 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_766 = "++;";
  protected final String TEXT_767 = NL + "                           try {" + NL + "                               updatedCount_";
  protected final String TEXT_768 = " = updatedCount_";
  protected final String TEXT_769 = " + pstmt_";
  protected final String TEXT_770 = ".executeUpdate();" + NL + "                               nb_line_";
  protected final String TEXT_771 = "++;";
  protected final String TEXT_772 = NL + "                           } catch(java.lang.Exception e) {" + NL + "                               whetherReject_";
  protected final String TEXT_773 = " = true;";
  protected final String TEXT_774 = NL + "                                   throw(e);";
  ...
  protected final String TEXT_797 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_798 = " = pstmt_";
  protected final String TEXT_799 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_800 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_801 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_802 = " = rs_";
  protected final String TEXT_803 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_804 = " > 0) {";
  ...
  protected final String TEXT_809 = ", pstmtUpdate_";
  ...
  protected final String TEXT_818 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_819 = " = updatedCount_";
  protected final String TEXT_820 = " + pstmtUpdate_";
  protected final String TEXT_821 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_822 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_823 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_824 = " = true;";
  protected final String TEXT_825 = NL + "                        throw(e);";
  protected final String TEXT_826 = NL + "                    \tnb_line_";
  protected final String TEXT_827 = "++;" + NL + "                    \t";
  protected final String TEXT_828 = NL + "                            ";
  protected final String TEXT_829 = " = new ";
  protected final String TEXT_830 = "Struct();";
  protected final String TEXT_831 = NL + "                                ";
  protected final String TEXT_832 = ".";
  protected final String TEXT_833 = " = ";
  protected final String TEXT_834 = ".";
  protected final String TEXT_835 = ";";
  protected final String TEXT_836 = NL + "                            rejectedCount_";
  protected final String TEXT_837 = " = rejectedCount_";
  protected final String TEXT_838 = " + 1;";
  protected final String TEXT_839 = NL + "                            ";
  protected final String TEXT_840 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_845 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_846 = NL + "                        ";
  protected final String TEXT_847 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_848 = ".";
  protected final String TEXT_849 = ", pstmtInsert_";
  protected final String TEXT_850 = ", ";
  protected final String TEXT_851 = ", \"";
  protected final String TEXT_852 = "\");";
  protected final String TEXT_853 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_854 = " = insertedCount_";
  protected final String TEXT_855 = " + pstmtInsert_";
  protected final String TEXT_856 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_857 = "++;";
  protected final String TEXT_858 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_859 = " = true;";
  protected final String TEXT_860 = NL + "                        throw(e);";
  protected final String TEXT_861 = NL + "                    \tnb_line_";
  protected final String TEXT_862 = "++;" + NL + "                    \t";
  protected final String TEXT_863 = NL + "                            ";
  protected final String TEXT_864 = " = new ";
  protected final String TEXT_865 = "Struct();";
  ...
  protected final String TEXT_884 = NL + "                    int count_";
  ...
  protected final String TEXT_897 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_898 = "=pstmtUpdate_";
  protected final String TEXT_899 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_900 = " = updatedCount_";
  protected final String TEXT_901 = "+updateFlag_";
  protected final String TEXT_902 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_903 = " == 0) {";
  protected final String TEXT_904 = NL + "                        ";
  protected final String TEXT_905 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_906 = ".";
  protected final String TEXT_907 = ", pstmtInsert_";
  ...
  protected final String TEXT_914 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_915 = "++;";
  protected final String TEXT_916 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_917 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_918 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_939 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_940 = NL + "                }";
  protected final String TEXT_941 = NL + "\t\t\t\t\t";
  protected final String TEXT_942 = NL + "                    \t";
  protected final String TEXT_943 = NL + "\t                        query_";
  protected final String TEXT_944 = " = ";
  protected final String TEXT_945 = ";" + NL + "\t                        ";
  protected final String TEXT_946 = NL + "                    ";
  protected final String TEXT_947 = NL + "                       pstmt_";
  protected final String TEXT_948 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_949 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_950 = "++;";
  protected final String TEXT_951 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_952 = " = deletedCount_";
  protected final String TEXT_953 = " + pstmt_";
  protected final String TEXT_954 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_955 = "++;";
  protected final String TEXT_956 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_957 = " = true;";
  protected final String TEXT_958 = NL + "                               throw(e);";
  protected final String TEXT_959 = NL + "                            nb_line_";
  ...
  protected final String TEXT_979 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_990 = NL + "                if ((batchSize_";
  protected final String TEXT_991 = " > 0) && (batchSize_";
  protected final String TEXT_992 = " <= batchSizeCounter_";
  protected final String TEXT_993 = ")) {" + NL + "            \t\t";
  protected final String TEXT_994 = NL + NL + "int[] status_";
  protected final String TEXT_995 = " = null;" + NL + "int countSum_";
  protected final String TEXT_996 = " = 0;" + NL + "try {" + NL + "    batchSizeCounter_";
  protected final String TEXT_997 = " = 0;";
  protected final String TEXT_998 = NL + "    status_";
  protected final String TEXT_999 = " = pstmt_";
  protected final String TEXT_1000 = ".executeBatch();";
  protected final String TEXT_1001 = NL + "    for(int countEach_";
  protected final String TEXT_1002 = ": status_";
  protected final String TEXT_1003 = ") {" + NL + "        countSum_";
  protected final String TEXT_1004 = " += (countEach_";
  protected final String TEXT_1005 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1006 = ");" + NL + "    }" + NL + "}catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1007 = NL + "        throw(e);";
  protected final String TEXT_1008 = NL + "    for(int countEach_";
  protected final String TEXT_1009 = ": e.getUpdateCounts()) {" + NL + "        countSum_";
  ...
  protected final String TEXT_1013 = NL + "    System.err.println(e.getMessage());";
  protected final String TEXT_1014 = NL + "}" + NL + "try {" + NL + "    tmp_batchUpdateCount_";
  protected final String TEXT_1015 = " = pstmt_";
  protected final String TEXT_1016 = ".getUpdateCount();" + NL + "}catch (java.sql.SQLException e){";
  protected final String TEXT_1017 = NL + "    System.err.println(e.getMessage());" + NL + "}" + NL + "tmp_batchUpdateCount_";
  protected final String TEXT_1018 = " = tmp_batchUpdateCount_";
  protected final String TEXT_1019 = " > countSum_";
  protected final String TEXT_1020 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_1021 = " : countSum_";
  protected final String TEXT_1022 = ";";
  protected final String TEXT_1023 = NL + "    insertedCount_";
  protected final String TEXT_1024 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1025 = ";";
  protected final String TEXT_1026 = NL + "    updatedCount_";
  protected final String TEXT_1027 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1028 = ";";
  protected final String TEXT_1029 = NL + "    deletedCount_";
  protected final String TEXT_1030 = " += tmp_batchUpdateCount_";
  protected final String TEXT_1031 = ";";
  protected final String TEXT_1032 = NL + "                               }";
  protected final String TEXT_1033 = NL + "                commitCounter_";
  protected final String TEXT_1034 = "++;" + NL + "" + NL + "                if(commitEvery_";
  ...
  protected final String TEXT_1040 = NL + NL + "int[] status_";
  protected final String TEXT_1041 = " = null;" + NL + "int countSum_";
  protected final String TEXT_1042 = " = 0;" + NL + "try {" + NL + "    batchSizeCounter_";
  protected final String TEXT_1043 = " = 0;";
  protected final String TEXT_1044 = NL + "    status_";
  protected final String TEXT_1045 = " = pstmt_";
  protected final String TEXT_1046 = ".executeBatch();";
  protected final String TEXT_1047 = NL + "    for(int countEach_";
  protected final String TEXT_1048 = ": status_";
  protected final String TEXT_1049 = ") {" + NL + "        countSum_";
  protected final String TEXT_1050 = " += (countEach_";
  protected final String TEXT_1051 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1052 = ");" + NL + "    }" + NL + "}catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1053 = NL + "        throw(e);";
  protected final String TEXT_1054 = NL + "    for(int countEach_";
  protected final String TEXT_1055 = ": e.getUpdateCounts()) {" + NL + "        countSum_";
  ...
  protected final String TEXT_1059 = NL + "    System.err.println(e.getMessage());";
  protected final String TEXT_1060 = NL + "}" + NL + "try {" + NL + "    tmp_batchUpdateCount_";
  protected final String TEXT_1061 = " = pstmt_";
  protected final String TEXT_1062 = ".getUpdateCount();" + NL + "}catch (java.sql.SQLException e){";
  protected final String TEXT_1063 = NL + "    System.err.println(e.getMessage());" + NL + "}" + NL + "tmp_batchUpdateCount_";
  ...
  protected final String TEXT_1079 = NL + "                    conn_";
  protected final String TEXT_1080 = ".commit();";
  protected final String TEXT_1081 = NL + "                   \tcommitCounter_";
  protected final String TEXT_1082 = "=0;" + NL + "                }";
