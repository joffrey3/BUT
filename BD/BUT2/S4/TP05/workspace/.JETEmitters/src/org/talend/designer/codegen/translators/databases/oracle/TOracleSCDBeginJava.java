...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_143 = ">();" + NL + "        " + NL + "        class ResultSet2Cache_";
  protected final String TEXT_144 = " {" + NL + "        \tvoid fill(java.sql.ResultSet resultSet_";
  protected final String TEXT_145 = ", java.util.Map<SCDSK_";
  protected final String TEXT_146 = ", SCDStruct_";
  protected final String TEXT_147 = "> cache_";
  protected final String TEXT_148 = ") throws java.lang.Exception {" + NL + "        " + NL + "        java.sql.Timestamp timestamp_";
  protected final String TEXT_149 = " = null;" + NL + "    \tString tmpValue_";
  protected final String TEXT_150 = " = null;" + NL + "    " + NL + "        while(resultSet_";
  protected final String TEXT_151 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_152 = " sk_";
  protected final String TEXT_153 = " = new SCDSK_";
  protected final String TEXT_154 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_155 = " row_";
  protected final String TEXT_156 = " = new SCDStruct_";
  protected final String TEXT_157 = "();";
  protected final String TEXT_158 = NL + "                    tmpValue_";
  protected final String TEXT_159 = " = resultSet_";
  protected final String TEXT_160 = ".getString(";
  protected final String TEXT_161 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_162 = " != null && tmpValue_";
  protected final String TEXT_163 = ".length() > 0) {";
  protected final String TEXT_164 = NL + "                        ";
  protected final String TEXT_165 = ".";
  protected final String TEXT_166 = " = tmpValue_";
  protected final String TEXT_167 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_168 = NL + "                            if(tmpValue_";
  protected final String TEXT_169 = " == null) {";
  protected final String TEXT_170 = NL + "                                ";
  protected final String TEXT_171 = ".";
  protected final String TEXT_172 = " = null;" + NL + "                            } else {";
  protected final String TEXT_173 = NL + "                                ";
  protected final String TEXT_174 = ".";
  protected final String TEXT_175 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_176 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_177 = ")) {";
  protected final String TEXT_178 = NL + "                                ";
  protected final String TEXT_179 = ".";
  protected final String TEXT_180 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  ...
  protected final String TEXT_184 = NL + "\t                    if(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_185 = ").getTIMESTAMPTZ(";
  protected final String TEXT_186 = ") != null){" + NL + "\t                    \t";
  protected final String TEXT_187 = ".";
  protected final String TEXT_188 = " = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_189 = ").getTIMESTAMPTZ(";
  protected final String TEXT_190 = ").toBytes());" + NL + "\t                    }else{" + NL + "\t                    \t";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = " = null;" + NL + "\t                    }" + NL + "\t                ";
  protected final String TEXT_193 = NL + "\t                    timestamp_";
  protected final String TEXT_194 = " = resultSet_";
  protected final String TEXT_195 = ".getTimestamp(";
  protected final String TEXT_196 = ");" + NL + "\t                    if(timestamp_";
  protected final String TEXT_197 = " != null) {" + NL + "\t                        ";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = " = new java.util.Date(timestamp_";
  protected final String TEXT_200 = ".getTime());" + NL + "\t                    } else {" + NL + "\t                        ";
  protected final String TEXT_201 = ".";
  protected final String TEXT_202 = " = null;" + NL + "\t                    }";
  protected final String TEXT_203 = NL + "                    if(resultSet_";
  protected final String TEXT_204 = ".getObject(";
  protected final String TEXT_205 = ") != null) {";
  protected final String TEXT_206 = NL + "                        ";
  protected final String TEXT_207 = ".";
  protected final String TEXT_208 = " = resultSet_";
  protected final String TEXT_209 = ".get";
  protected final String TEXT_210 = "(";
  protected final String TEXT_211 = ");" + NL + "                    }";
  protected final String TEXT_212 = NL + "            cache_";
  protected final String TEXT_213 = ".put(sk_";
  protected final String TEXT_214 = ", row_";
  protected final String TEXT_215 = ");" + NL + "        }//end while" + NL + "        }//end method" + NL + "        }//end class" + NL + "        " + NL + "        new ResultSet2Cache_";
  protected final String TEXT_216 = "().fill(resultSet_";
  protected final String TEXT_217 = ", cache_";
  protected final String TEXT_218 = ");" + NL + "        " + NL + "        resultSet_";
  protected final String TEXT_219 = ".close();" + NL + "        statement_";
  protected final String TEXT_220 = ".close();";
  protected final String TEXT_221 = NL + "            System.out.println(\"[";
  protected final String TEXT_222 = "] comparison cache loaded\");";
  protected final String TEXT_223 = NL + "        ";
  protected final String TEXT_224 = " nextSurrogateKey_";
  protected final String TEXT_225 = " = 1;";
  protected final String TEXT_226 = NL + "            if(cache_";
  protected final String TEXT_227 = ".size() > 0) {";
  protected final String TEXT_228 = NL + "        String tmpQuery_";
  protected final String TEXT_229 = " = \"SELECT MAX(";
  protected final String TEXT_230 = ") FROM \" + tableName_";
  protected final String TEXT_231 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_232 = " = connection_";
  protected final String TEXT_233 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_234 = " = tmpStmt_";
  protected final String TEXT_235 = ".executeQuery(tmpQuery_";
  protected final String TEXT_236 = ");";
  protected final String TEXT_237 = NL + "        if(tmpRS_";
  protected final String TEXT_238 = ".next() && tmpRS_";
  protected final String TEXT_239 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_240 = " = tmpRS_";
  protected final String TEXT_241 = ".get";
  protected final String TEXT_242 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_243 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_244 = ".close();";
  protected final String TEXT_245 = NL + "            }";
  protected final String TEXT_246 = NL + "    String insertionSQL_";
  protected final String TEXT_247 = " = \"";
  protected final String TEXT_248 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_249 = " = connection_";
  protected final String TEXT_250 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_251 = ");";
  protected final String TEXT_252 = NL + "            insertionStatement_";
  protected final String TEXT_253 = ".setTimestamp(";
  protected final String TEXT_254 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_255 = "\")));";
  protected final String TEXT_256 = NL + "            insertionStatement_";
  protected final String TEXT_257 = ".setNull(";
  protected final String TEXT_258 = ", java.sql.Types.DATE);";
  protected final String TEXT_259 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_260 = " = ";
  protected final String TEXT_261 = ";" + NL + "            String datePattern_";
  protected final String TEXT_262 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_263 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_264 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_265 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_266 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_267 = ".setTimestamp(";
  protected final String TEXT_268 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_269 = ").parse(";
  protected final String TEXT_270 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_271 = ").getTime()));";
  protected final String TEXT_272 = NL + "        String updateSQLForType1_";
  protected final String TEXT_273 = " = \"";
  protected final String TEXT_274 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_275 = " = connection_";
  protected final String TEXT_276 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_277 = ");";
  protected final String TEXT_278 = NL + "        String updateSQLForType2_";
  protected final String TEXT_279 = " = \"";
  protected final String TEXT_280 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_281 = " = connection_";
  protected final String TEXT_282 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_283 = ");";
  protected final String TEXT_284 = NL + "            updateForType2_";
  protected final String TEXT_285 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_286 = "\")));";
  protected final String TEXT_287 = NL + "        String updateSQLForType3_";
  protected final String TEXT_288 = " = \"";
  protected final String TEXT_289 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_290 = " = connection_";
  protected final String TEXT_291 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_292 = ");";
  protected final String TEXT_293 = NL;
  protected final String TEXT_294 = NL + "        SCDSK_";
  protected final String TEXT_295 = " lookUpKey_";
  protected final String TEXT_296 = " = null;";
  protected final String TEXT_297 = NL + "    SCDStruct_";
  protected final String TEXT_298 = " lookUpValue_";
  protected final String TEXT_299 = " = null;" + NL + "    ";
  protected final String TEXT_300 = NL + "    " + NL + "    class Helper65535_";
  protected final String TEXT_301 = " {" + NL + "    \t" + NL + "    \tvoid propagate(";
