...
public class TDB2InputBeginJava
{
  ...
  protected final String TEXT_185 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_192 = " = routines.system.JDBCUtil.getDoubleObject(rs_";
  protected final String TEXT_193 = ", ";
  protected final String TEXT_194 = "column_index_";
  protected final String TEXT_195 = ");";
  protected final String TEXT_196 = NL + "\t\t\t\t";
  protected final String TEXT_197 = ".";
  protected final String TEXT_198 = " = routines.system.JDBCUtil.getDouble(rs_";
  protected final String TEXT_199 = ", ";
  protected final String TEXT_200 = "column_index_";
  protected final String TEXT_201 = ");";
  protected final String TEXT_202 = NL + "\t\t\t\t";
  protected final String TEXT_203 = ".";
  protected final String TEXT_204 = " = routines.system.JDBCUtil.getBooleanObject(rs_";
  protected final String TEXT_205 = ", ";
  protected final String TEXT_206 = "column_index_";
  protected final String TEXT_207 = ");";
  protected final String TEXT_208 = NL + "\t\t\t\t";
  protected final String TEXT_209 = ".";
  protected final String TEXT_210 = " = routines.system.JDBCUtil.getBoolean(rs_";
  ...
  protected final String TEXT_222 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_223 = " =  conn_";
  protected final String TEXT_224 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_225 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_226 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_227 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_228 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_229 = NL + "                 conn_";
  protected final String TEXT_230 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_231 = NL + "               ";
  protected final String TEXT_232 = " + \"=\" + ";
  protected final String TEXT_233 = " + \";\" +";
  protected final String TEXT_234 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_235 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_236 = ");";
  protected final String TEXT_237 = NL + "\t\t    ";
  protected final String TEXT_238 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_239 = " = ";
  protected final String TEXT_240 = ";" + NL + "\t\t\t";
  protected final String TEXT_241 = NL + "                log.debug(\"";
  protected final String TEXT_242 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_249 = "_QUERY\",dbquery_";
  protected final String TEXT_250 = ");";
  protected final String TEXT_251 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_252 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_253 = " = stmt_";
  protected final String TEXT_254 = ".executeQuery(dbquery_";
  protected final String TEXT_255 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_256 = " = rs_";
  protected final String TEXT_257 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_258 = " = rsmd_";
  protected final String TEXT_259 = ".getColumnCount();" + NL;
  protected final String TEXT_260 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_261 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_262 = ".setDbmsId(\"";
  protected final String TEXT_263 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_264 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_265 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_266 = ".add(\"";
  protected final String TEXT_267 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_268 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_269 = " = ";
  protected final String TEXT_270 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_271 = "; i <= rsmd_";
  protected final String TEXT_272 = ".getColumnCount()-";
  protected final String TEXT_273 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_274 = ".contains(rsmd_";
  protected final String TEXT_275 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_276 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_277 = ".setName(rsmd_";
  protected final String TEXT_278 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_279 = ".setDbName(rsmd_";
  protected final String TEXT_280 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_282 = "\", rsmd_";
  protected final String TEXT_283 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_284 = ".getPrecision(i), rsmd_";
  protected final String TEXT_285 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_286 = ".setDbType(rsmd_";
  protected final String TEXT_287 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_288 = ".setDbTypeId(rsmd_";
  protected final String TEXT_289 = ".getColumnType(i));";
  protected final String TEXT_290 = NL + "                \tdcm_";
  protected final String TEXT_291 = ".setFormat(";
  protected final String TEXT_292 = ");";
  protected final String TEXT_293 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_294 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_295 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_296 = ".setLength(rsmd_";
  protected final String TEXT_297 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_298 = ".setLength(rsmd_";
  protected final String TEXT_299 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_300 = NL + "\t\t\tdcm_";
  protected final String TEXT_301 = ".setLength(rsmd_";
  protected final String TEXT_302 = ".getPrecision(i));";
  protected final String TEXT_303 = NL + "                \tdcm_";
  protected final String TEXT_304 = ".setPrecision(rsmd_";
  protected final String TEXT_305 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_306 = ".setNullable(rsmd_";
  protected final String TEXT_307 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_308 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_309 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_310 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_311 = ".metadatas.add(dcm_";
  protected final String TEXT_312 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_313 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_314 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_315 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_316 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_317 = NL + "\t\t    ";
  protected final String TEXT_318 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_319 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_320 = NL + "\t\t    while (rs_";
  protected final String TEXT_321 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_322 = "++;" + NL + "\t\t        ";
  protected final String TEXT_323 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_324 = " = ";
  protected final String TEXT_325 = " + dcg_";
  protected final String TEXT_326 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_328 = " = ";
  protected final String TEXT_329 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_331 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_332 = " < ";
  protected final String TEXT_333 = "column_index_";
  protected final String TEXT_334 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_335 = ".";
  protected final String TEXT_336 = " = ";
  protected final String TEXT_337 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_338 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_339 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_340 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t                            ";
  protected final String TEXT_342 = ".";
  protected final String TEXT_343 = " = (List)rs_";
  ...
  protected final String TEXT_350 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_351 = ".getObject(";
  protected final String TEXT_352 = "column_index_";
  protected final String TEXT_353 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_354 = NL + "                                    ";
  protected final String TEXT_355 = ".";
  protected final String TEXT_356 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_365 = ".setEPSG(";
  protected final String TEXT_366 = ");" + NL + "                                        }";
  protected final String TEXT_367 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_368 = NL + "                                  ";
  protected final String TEXT_369 = ".";
  protected final String TEXT_370 = "=dcg_";
  protected final String TEXT_371 = ";";
  protected final String TEXT_372 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_373 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_374 = " = ";
  protected final String TEXT_375 = "; i_";
  protected final String TEXT_376 = "  <= rsmd_";
  protected final String TEXT_377 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_390 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_391 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_392 = ".getColumnTypeName(i_";
  protected final String TEXT_393 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_394 = ".add(rs_";
  protected final String TEXT_395 = ".getString(i_";
  protected final String TEXT_396 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_397 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
