...
public class TELTJDBCOutputMainJava {
  ...
  protected final String TEXT_74 = NL + "                if(log.is";
  protected final String TEXT_75 = "Enabled())";
  ...
  protected final String TEXT_82 = NL + "    \tclass BytesLimit65535_";
  protected final String TEXT_83 = "{" + NL + "    \t\tpublic void limitLog4jByte() throws Exception{" + NL + "    \t\t\t";
  protected final String TEXT_84 = NL + "            StringBuilder ";
  protected final String TEXT_85 = " = new StringBuilder();";
  protected final String TEXT_86 = NL + "            ";
  protected final String TEXT_87 = ".append(\"Parameters:\");";
  protected final String TEXT_88 = NL + "                    ";
  protected final String TEXT_89 = ".append(\"";
  protected final String TEXT_90 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_91 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_98 = NL + "    \t\t}" + NL + "    \t}" + NL + "    \t" + NL + "        new BytesLimit65535_";
  protected final String TEXT_99 = "().limitLog4jByte();";
  protected final String TEXT_100 = NL + "            StringBuilder ";
  protected final String TEXT_101 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_110 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_119 = NL + "\tString select_query_";
  protected final String TEXT_120 = " = null;\t" + NL + "\tString tableName_";
  protected final String TEXT_121 = " = null;" + NL + "\tString selectQueryColumnsName_";
  protected final String TEXT_122 = " = null;" + NL + "\t";
  protected final String TEXT_123 = NL + "\t\tselect_query_";
  protected final String TEXT_124 = " = (String) globalMap.get(\"";
  protected final String TEXT_125 = "\"+\"QUERY\"+\"";
  protected final String TEXT_126 = "\");" + NL + "\t\tselectQueryColumnsName_";
  protected final String TEXT_127 = " = (String) globalMap.get(\"";
  protected final String TEXT_128 = "\"+\"QUERY_COLUMNS_NAME\"+\"";
  ...
  protected final String TEXT_137 = ";" + NL + "\t}else {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_144 = "\");" + NL + "        dbUser_";
  protected final String TEXT_145 = " = (String)globalMap.get(\"";
  protected final String TEXT_146 = "\");";
  protected final String TEXT_147 = NL + "        String driverClass_";
  protected final String TEXT_148 = " = ";
  protected final String TEXT_149 = ";" + NL + "        java.lang.Class.forName(driverClass_";
  protected final String TEXT_150 = ");" + NL + "        String url_";
  protected final String TEXT_151 = " = ";
  protected final String TEXT_152 = "; " + NL + "        dbUser_";
  protected final String TEXT_153 = " = ";
  protected final String TEXT_154 = ";\t        " + NL + "    \t";
  protected final String TEXT_155 = NL + "    \t" + NL + "    \t";
  protected final String TEXT_156 = "String decryptedPassword_";
  protected final String TEXT_157 = " = null;";
  protected final String TEXT_158 = " " + NL + "\tdecryptedPassword_";
  protected final String TEXT_159 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_160 = ");";
  protected final String TEXT_161 = NL + "\tdecryptedPassword_";
  protected final String TEXT_162 = " = ";
  protected final String TEXT_163 = "; ";
  protected final String TEXT_164 = NL + "       \tString dbPwd_";
  ...
  protected final String TEXT_168 = "\t" + NL + "        \tString insertQuery_";
  protected final String TEXT_169 = " = \"INSERT INTO \"+tableName_";
  protected final String TEXT_170 = "+\"(";
  protected final String TEXT_171 = ")  (\"+select_query_";
  protected final String TEXT_172 = "+\")\";";
  protected final String TEXT_173 = NL + "        \tString updateQuery_";
  protected final String TEXT_174 = " = \"UPDATE \"+tableName_";
  protected final String TEXT_175 = "+\" SET ";
  protected final String TEXT_176 = " \"";
  protected final String TEXT_177 = NL + "        \t\t+\"  WHERE \" + ";
  protected final String TEXT_178 = NL + "        \t;";
  protected final String TEXT_179 = NL + "        \tString deleteQuery_";
  protected final String TEXT_180 = " = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_181 = "+\" WHERE EXISTS (\"+select_query_";
  protected final String TEXT_182 = "+\") \" " + NL + "        \t";
  protected final String TEXT_183 = NL + "        \t+\"  AND \" + ";
  protected final String TEXT_184 = NL + "        \t";
  protected final String TEXT_185 = NL + "        \t;" + NL + "    \t";
  protected final String TEXT_186 = NL + "    \t" + NL + "        int nb_line_";
  protected final String TEXT_187 = " = 0;" + NL + "        int nb_line_updated_";
  protected final String TEXT_188 = " = 0;" + NL + "        int nb_line_inserted_";
  protected final String TEXT_189 = " = 0;" + NL + "        int nb_line_deleted_";
  ...
  protected final String TEXT_216 = NL + "                java.sql.Statement isExistStmt_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".createStatement();" + NL + "                boolean whetherExist_";
  protected final String TEXT_219 = " = false;" + NL + "                try {" + NL + "                    isExistStmt_";
  ...
  protected final String TEXT_223 = " = false;" + NL + "                }" + NL + "                isExistStmt_";
  protected final String TEXT_224 = ".close();";
  protected final String TEXT_225 = NL + "            \tString tableNameForSearch_";
  protected final String TEXT_226 = " = ";
  protected final String TEXT_227 = ";" + NL + "            \tString dbschemaForSearch_";
  protected final String TEXT_228 = " = null;" + NL + "            \tif(dbschema_";
  protected final String TEXT_229 = " == null || dbschema_";
  protected final String TEXT_230 = ".trim().isEmpty()) {" + NL + "            \t\tdbschemaForSearch_";
  protected final String TEXT_231 = " = dbUser_";
  protected final String TEXT_232 = ".toUpperCase();" + NL + "            \t} else {" + NL + "            \t\tdbschemaForSearch_";
  ...
  protected final String TEXT_356 = NL + "                String schemaForSearch_";
  protected final String TEXT_357 = " = null;" + NL + "\t\t\t\tString tableForSearch_";
  protected final String TEXT_358 = " = ";
  protected final String TEXT_359 = ";" + NL + "\t\t\t\t" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_363 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_364 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_375 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_386 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_422 = NL + "                conn_";
  protected final String TEXT_423 = ".commit();";
  protected final String TEXT_424 = NL + "            stmtTrunc_";
  protected final String TEXT_425 = ".executeUpdate(\"";
  protected final String TEXT_426 = "\");";
  protected final String TEXT_427 = NL + "                if(!conn_";
  protected final String TEXT_428 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_429 = ".commit();" + NL + "                }";
  protected final String TEXT_430 = NL + "            stmtTrunc_";
  protected final String TEXT_431 = ".close();";
  protected final String TEXT_432 = NL + "    \t\t";
  protected final String TEXT_433 = NL + "        System.out.println(\"Inserting with : \\n\" + insertQuery_";
  protected final String TEXT_434 = " + \"\\n\");";
  protected final String TEXT_435 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_436 = " = conn_";
  protected final String TEXT_437 = ".prepareStatement(insertQuery_";
  protected final String TEXT_438 = ");" + NL + "        nb_line_inserted_";
  protected final String TEXT_439 = " = pstmt_";
  protected final String TEXT_440 = ".executeUpdate();";
  protected final String TEXT_441 = NL + "        System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_442 = " + \" rows inserted. \\n\");" + NL + "        pstmt_";
  protected final String TEXT_443 = ".close();" + NL + "\t\t";
  protected final String TEXT_444 = NL + "        System.out.println(\"Updating with : \\n\" + updateQuery_";
  protected final String TEXT_445 = " +\"\\n\");";
  protected final String TEXT_446 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_447 = " = conn_";
  protected final String TEXT_448 = ".prepareStatement(updateQuery_";
  protected final String TEXT_449 = ");" + NL + "        nb_line_updated_";
  protected final String TEXT_450 = " = pstmt_";
  protected final String TEXT_451 = ".executeUpdate();";
  protected final String TEXT_452 = NL + "    \tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_453 = " + \" rows updated. \\n\");" + NL + "    \tpstmt_";
  protected final String TEXT_454 = ".close();" + NL + "    \t";
  protected final String TEXT_455 = NL + "    \tSystem.out.println(\"Deleting with : \\n\" + deleteQuery_";
  protected final String TEXT_456 = " +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_457 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".prepareStatement(deleteQuery_";
  protected final String TEXT_460 = ");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_461 = " = pstmt_";
  protected final String TEXT_462 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_463 = NL + "    \tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_464 = " + \" rows deleted. \\n\");" + NL + "    \tpstmt_";
  protected final String TEXT_465 = ".close();" + NL + "\t\t";
  protected final String TEXT_466 = NL;
  protected final String TEXT_467 = NL + "        if(conn_";
  protected final String TEXT_468 = " != null && !conn_";
  protected final String TEXT_469 = ".isClosed()) {" + NL + "    \t\t";
  protected final String TEXT_470 = NL + "        }";
  protected final String TEXT_471 = NL + "    nb_line_";
  protected final String TEXT_472 = " = nb_line_updated_";
  protected final String TEXT_473 = " + nb_line_inserted_";
  protected final String TEXT_474 = " + nb_line_deleted_";
  protected final String TEXT_475 = ";" + NL + "    globalMap.put(\"";
  protected final String TEXT_476 = "_NB_LINE\",nb_line_";
  protected final String TEXT_477 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_478 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_479 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_480 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_481 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_482 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_483 = ");";
  protected final String TEXT_484 = NL + "    \tlog.info(\"";
  protected final String TEXT_485 = " - Has ";
  protected final String TEXT_486 = " records count: \" + nb_line_";
