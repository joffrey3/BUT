...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_180 = " = \"jdbc:sqlite:\" + \"/\" + ";
  ...
  protected final String TEXT_188 = " = java.sql.DriverManager.getConnection(url_";
  ...
  protected final String TEXT_227 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_228 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_294 = NL + "\t\t    \tlog.debug(\"";
  ...
  protected final String TEXT_366 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_367 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_368 = ".getColumnTypeName(i_";
  protected final String TEXT_369 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_370 = ".add(rs_";
  protected final String TEXT_371 = ".getString(i_";
  protected final String TEXT_372 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_373 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
