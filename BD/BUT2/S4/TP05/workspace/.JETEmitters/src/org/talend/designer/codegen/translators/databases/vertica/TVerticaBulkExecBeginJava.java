...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_292 = ".getTables(null, dbschema_";
  protected final String TEXT_293 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_294 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_295 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_296 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_308 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_316 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_333 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_335 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_339 = " - Droping table ";
  ...
  protected final String TEXT_347 = " - Drop table ";
  protected final String TEXT_348 = "\" + tableName_";
  protected final String TEXT_349 = " + \"";
  protected final String TEXT_350 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_352 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_356 = " - Creating table ";
  ...
  protected final String TEXT_364 = " - Create table ";
  ...
  protected final String TEXT_370 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_374 = " - Clearing table ";
  ...
  protected final String TEXT_382 = "- Clear table ";
  ...
  protected final String TEXT_387 = ".close();" + NL + "\t\t";
  ...
  protected final String TEXT_397 = " - Trancating table ";
  ...
  protected final String TEXT_404 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_405 = " - Truncate table ";
  protected final String TEXT_406 = "\" + tableName_";
  protected final String TEXT_407 = " + \"";
  protected final String TEXT_408 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_416 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_417 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_418 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_419 = NL + "try{";
  protected final String TEXT_420 = NL + "        int keyCount_";
  protected final String TEXT_421 = " = ";
  protected final String TEXT_422 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_423 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tableName_";
  protected final String TEXT_424 = " = \"tmp_";
  protected final String TEXT_425 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_426 = " != null && dbschema_";
  protected final String TEXT_427 = ".trim().length() != 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_428 = " = dbschema_";
  protected final String TEXT_429 = " + \".\" + tableName_";
  protected final String TEXT_430 = ";" + NL + "\t\t}" + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_431 = " = conn_";
  protected final String TEXT_432 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_433 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_434 = " - Creating temp table ";
  protected final String TEXT_435 = "\" + tableName_";
  protected final String TEXT_436 = " + \"";
  protected final String TEXT_437 = ".\" );" + NL + "\t\t";
  protected final String TEXT_438 = NL + "        stmtCreateTmp_";
  protected final String TEXT_439 = ".execute(\"";
  protected final String TEXT_440 = ")\");";
  protected final String TEXT_441 = NL + "        \tlog.info(\"";
  protected final String TEXT_442 = " - Create temp table ";
  protected final String TEXT_443 = "\" + tableName_";
  protected final String TEXT_444 = " + \"";
  protected final String TEXT_445 = " has succeeded.\");";
  protected final String TEXT_446 = NL + "        stmtCreateTmp_";
  protected final String TEXT_447 = ".close();";
  protected final String TEXT_448 = NL + "\t\tCharacter OUT_DELIM_";
  protected final String TEXT_449 = " = ";
  protected final String TEXT_450 = ".charAt(0);" + NL + "\t\t";
  protected final String TEXT_451 = NL + "\t\tString escapechar_";
  protected final String TEXT_452 = " = ";
  protected final String TEXT_453 = ";" + NL + "\t\tif(!escapechar_";
  protected final String TEXT_454 = ".isEmpty()){" + NL + "\t\t\tescapechar_";
  protected final String TEXT_455 = " = \"\" + escapechar_";
  protected final String TEXT_456 = ".charAt(0);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_457 = NL + "\t\tString sql_";
  protected final String TEXT_458 = " = \"COPY \" + tableName_";
  protected final String TEXT_459 = " " + NL + "\t\t";
  protected final String TEXT_460 = NL + "\t\t\t+ \"";
  protected final String TEXT_461 = "\"" + NL + "\t\t";
  protected final String TEXT_462 = "\t\t" + NL + "\t\t+ \" FROM STDIN DELIMITER '\" +OUT_DELIM_";
  protected final String TEXT_463 = " + \"'\" " + NL + "\t\t";
  protected final String TEXT_464 = NL + "\t\t+ \"ESCAPE AS '\" + escapechar_";
  protected final String TEXT_465 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_466 = NL + "\t\t+\" NO ESCAPE\"" + NL + "\t\t";
  protected final String TEXT_467 = NL + "\t    ";
  protected final String TEXT_468 = " + \" NULL '\"  + ";
  protected final String TEXT_469 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_470 = NL + "\t\t";
  protected final String TEXT_471 = " + \" DIRECT\"";
  protected final String TEXT_472 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_473 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_474 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_475 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_476 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_477 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_478 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_479 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_480 = " - Bulk SQL:\"+sql_";
  protected final String TEXT_481 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_482 = " - Bulk inserting data into ";
  protected final String TEXT_483 = "\" + tableName_";
  protected final String TEXT_484 = " + \"";
  protected final String TEXT_485 = ".\" );";
  protected final String TEXT_486 = NL + "    \tfis_";
  protected final String TEXT_487 = " = new java.io.FileInputStream(new java.io.File(";
  protected final String TEXT_488 = "));";
  protected final String TEXT_489 = NL + "\t\t\t java.sql.Statement stmt_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_492 = " = stmt_";
  protected final String TEXT_493 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_494 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_495 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_496 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_497 = " = rs_";
  protected final String TEXT_498 = ".getInt(1);" + NL + "\t\t}" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_499 = ").startCopyIn(sql_";
  protected final String TEXT_500 = ", fis_";
  protected final String TEXT_501 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_502 = ").addStreamToCopyIn(fis_";
  protected final String TEXT_503 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_504 = ").finishCopyIn();" + NL + "\t    ";
  ...
  protected final String TEXT_509 = " has finished.\");";
  protected final String TEXT_510 = NL + "\t\trs_";
  protected final String TEXT_511 = " = stmt_";
  protected final String TEXT_512 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_513 = ");" + NL + "\t    int nbLineAfterLoad_";
  protected final String TEXT_514 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_515 = ".next()) {" + NL + "\t    \tnbLineAfterLoad_";
  protected final String TEXT_516 = " = rs_";
  protected final String TEXT_517 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\tstmt_";
  protected final String TEXT_518 = ".close();" + NL + "\t\tif(";
  protected final String TEXT_519 = " && nbLineBeforeLoad_";
  protected final String TEXT_520 = " >= nbLineAfterLoad_";
  protected final String TEXT_521 = "){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted in component ";
  protected final String TEXT_522 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_523 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_524 = " - Number of records inserted to table ";
  protected final String TEXT_525 = "\" + tableName_";
  protected final String TEXT_526 = " + \"";
  protected final String TEXT_527 = " by ";
  protected final String TEXT_528 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_529 = " - nbLineBeforeLoad_";
  protected final String TEXT_530 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_531 = NL + "\t\t\tSystem.out.println(\"Number of records inserted to table ";
  protected final String TEXT_532 = "\" + tableName_";
  protected final String TEXT_533 = " + \"";
  protected final String TEXT_534 = " by ";
  protected final String TEXT_535 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_536 = " - nbLineBeforeLoad_";
  protected final String TEXT_537 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_538 = "_ACCEPTED_ROW_NUMBER\",nbLineAfterLoad_";
  protected final String TEXT_539 = " - nbLineBeforeLoad_";
  protected final String TEXT_540 = ");\t" + NL + "\t\t";
  protected final String TEXT_541 = NL + "\t\t com.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_542 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_543 = ",sql_";
  protected final String TEXT_544 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_545 = ".start();" + NL + "\t\tvcs_";
  protected final String TEXT_546 = ".addStream(fis_";
  protected final String TEXT_547 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_548 = ".execute();" + NL + "\t\tvcs_";
  protected final String TEXT_549 = ".finish();" + NL + "\t\t";
  protected final String TEXT_550 = NL + "            log.info(\"";
  protected final String TEXT_551 = " - Bulk insert data into ";
  protected final String TEXT_552 = "\" + tableName_";
  protected final String TEXT_553 = " + \"";
  protected final String TEXT_554 = " has finished.\");";
  protected final String TEXT_555 = NL + "\t\tlong copyNumber_";
  protected final String TEXT_556 = " = vcs_";
  protected final String TEXT_557 = ".getRowCount();" + NL + "\t\t" + NL + "\t\t//get rejected and accepted row number" + NL + "\t\tjava.sql.Statement stmt_accept_reject_";
  protected final String TEXT_558 = " = conn_";
  protected final String TEXT_559 = ".createStatement();" + NL + "\t\t" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_560 = " = stmt_accept_reject_";
  protected final String TEXT_561 = ".executeQuery(\"select get_num_accepted_rows()\");" + NL + "\t    int accetpedRowNumber_";
  protected final String TEXT_562 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_563 = ".next()) {" + NL + "\t    \taccetpedRowNumber_";
  protected final String TEXT_564 = " = rs_";
  protected final String TEXT_565 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t    rs_";
  protected final String TEXT_566 = " = stmt_accept_reject_";
  protected final String TEXT_567 = ".executeQuery(\"select get_num_rejected_rows()\");" + NL + "\t    int rejectedRowNumber_";
  protected final String TEXT_568 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_569 = ".next()) {" + NL + "\t    \trejectedRowNumber_";
  protected final String TEXT_570 = " = rs_";
  protected final String TEXT_571 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tstmt_accept_reject_";
  protected final String TEXT_572 = ".close();" + NL + "\t\t" + NL + "\t\tif(";
  protected final String TEXT_573 = " && copyNumber_";
  protected final String TEXT_574 = " <= 0){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted into component ";
  protected final String TEXT_575 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_576 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_577 = " - Number of records inserted into table ";
  protected final String TEXT_578 = "\" + tableName_";
  protected final String TEXT_579 = " + \"";
  protected final String TEXT_580 = " by ";
  protected final String TEXT_581 = ": \" + (copyNumber_";
  protected final String TEXT_582 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_583 = NL + "\t\t\tSystem.out.println(\"Number of records inserted into table ";
  protected final String TEXT_584 = "\" + tableName_";
  protected final String TEXT_585 = " + \"";
  protected final String TEXT_586 = " by ";
  protected final String TEXT_587 = ": \" + (copyNumber_";
  protected final String TEXT_588 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_589 = "_ACCEPTED_ROW_NUMBER\",accetpedRowNumber_";
  protected final String TEXT_590 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_591 = "_REJECTED_ROW_NUMBER\",rejectedRowNumber_";
  protected final String TEXT_592 = ");" + NL + "\t   ";
  protected final String TEXT_593 = NL + "        String tmpTableName_";
  protected final String TEXT_594 = " = \"tmp_";
  protected final String TEXT_595 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_596 = " == null || dbschema_";
  protected final String TEXT_597 = ".trim().length() == 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_598 = " = ";
  protected final String TEXT_599 = ";" + NL + "\t\t} else {" + NL + "\t    \ttableName_";
  protected final String TEXT_600 = " = dbschema_";
  protected final String TEXT_601 = " + \".\" + ";
  protected final String TEXT_602 = ";" + NL + "\t    \ttmpTableName_";
  protected final String TEXT_603 = "=dbschema_";
  protected final String TEXT_604 = " + \".\" + tmpTableName_";
  protected final String TEXT_605 = ";" + NL + "\t\t}" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_606 = " = conn_";
  protected final String TEXT_607 = ".createStatement();" + NL + "\t";
  protected final String TEXT_608 = NL + "\t\tlog.info(\"";
  protected final String TEXT_609 = " - Updating ";
  protected final String TEXT_610 = "\" + tableName_";
  protected final String TEXT_611 = " + \"";
  protected final String TEXT_612 = " from ";
  protected final String TEXT_613 = "\"+tmpTableName_";
  protected final String TEXT_614 = "+\"";
  protected final String TEXT_615 = ".\");" + NL + "\t";
  protected final String TEXT_616 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_617 = ".executeUpdate(\"";
  protected final String TEXT_618 = "\");" + NL + "\t";
  protected final String TEXT_619 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_620 = ".close();" + NL + "        tableName_";
  protected final String TEXT_621 = " = tmpTableName_";
  protected final String TEXT_622 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_623 = " = conn_";
  protected final String TEXT_624 = ".createStatement();" + NL + "\t";
  protected final String TEXT_625 = NL + "\t\tlog.info(\"";
  protected final String TEXT_626 = " - Droping temp table ";
  protected final String TEXT_627 = "\" + tableName_";
  protected final String TEXT_628 = " + \"";
  protected final String TEXT_629 = ".\");" + NL + "\t";
  protected final String TEXT_630 = NL + "        stmtTmpDrop_";
  protected final String TEXT_631 = ".execute(\"";
  protected final String TEXT_632 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_633 = ".close();        " + NL + "\t";
  protected final String TEXT_634 = NL + "\t\tlog.info(\"";
  protected final String TEXT_635 = " - Drop temp table ";
  protected final String TEXT_636 = "\" + tableName_";
  protected final String TEXT_637 = "+ \"";
  protected final String TEXT_638 = " has succeeded.\");" + NL + "\t";
  protected final String TEXT_639 = NL + "}finally{" + NL + "\tif(fis_";
  protected final String TEXT_640 = "!=null)" + NL + "\t\tfis_";
  protected final String TEXT_641 = ".close();";
  protected final String TEXT_642 = NL + "}" + NL + NL + NL + NL + NL + NL + NL;
