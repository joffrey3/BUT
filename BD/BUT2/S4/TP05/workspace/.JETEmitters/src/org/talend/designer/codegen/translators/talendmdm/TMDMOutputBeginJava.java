...
public class TMDMOutputBeginJava
{
  ...
  protected final String TEXT_184 = " == null){" + NL + "                if((Boolean)globalMap.get(\"useClientTranId_";
  protected final String TEXT_185 = "\")){" + NL + "                    List<String> cookies_";
  protected final String TEXT_186 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getCookies(turl_";
  protected final String TEXT_187 = ",username_";
  protected final String TEXT_188 = ",password_";
  protected final String TEXT_189 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_190 = " = new com.talend.mdm.transaction.client.MDMTransaction();" + NL + "                    mdmTransaction_";
  protected final String TEXT_191 = ".setUrl(turl_";
  protected final String TEXT_192 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_193 = ".setId(\"";
  protected final String TEXT_194 = "_\" + java.util.UUID.randomUUID());" + NL + "                    mdmTransaction_";
  protected final String TEXT_195 = ".setUsername(username_";
  protected final String TEXT_196 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_197 = ".setPassword(password_";
  protected final String TEXT_198 = ");" + NL + "                    mdmTransaction_";
  protected final String TEXT_199 = ".setCookies(cookies_";
  protected final String TEXT_200 = ");" + NL + "                }else{";
  protected final String TEXT_201 = NL + "                    mdmTransaction_";
  protected final String TEXT_202 = " = com.talend.mdm.transaction.client.MDMTransactionClient.newTransaction(turl_";
  protected final String TEXT_203 = ",username_";
  protected final String TEXT_204 = ",password_";
  protected final String TEXT_205 = ");" + NL + "                }" + NL + "                java.util.List<org.apache.cxf.headers.Header> soapHeaders_";
  protected final String TEXT_206 = " = new java.util.ArrayList<org.apache.cxf.headers.Header>();" + NL + "                javax.xml.namespace.QName qName_";
  protected final String TEXT_207 = " = new javax.xml.namespace.QName(\"http://www.talend.com/mdm\", \"transaction-id\");" + NL + "                org.apache.cxf.databinding.DataBinding dataBinding_";
  protected final String TEXT_208 = " = new org.apache.cxf.jaxb.JAXBDataBinding(String.class);" + NL + "                soapHeaders_";
  protected final String TEXT_209 = ".add(new org.apache.cxf.headers.Header(qName_";
  protected final String TEXT_210 = ", mdmTransaction_";
  protected final String TEXT_211 = ".getId(), dataBinding_";
  protected final String TEXT_212 = "));" + NL + "                context_";
  protected final String TEXT_213 = ".put(org.apache.cxf.headers.Header.HEADER_LIST, soapHeaders_";
  protected final String TEXT_214 = ");" + NL + "" + NL + "                java.util.Map<String, java.util.List<String>> httpHeaders_";
  protected final String TEXT_215 = " = new java.util.HashMap<String, java.util.List<String>>();" + NL + "                httpHeaders_";
  protected final String TEXT_216 = ".put(\"Cookie\", mdmTransaction_";
  protected final String TEXT_217 = ".getCookies());" + NL + "                context_";
  protected final String TEXT_218 = ".put(org.apache.cxf.message.Message.PROTOCOL_HEADERS, httpHeaders_";
  protected final String TEXT_219 = ");" + NL + "" + NL + "                globalMap.put(transKey_";
  protected final String TEXT_220 = ", mdmTransaction_";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "            }" + NL + "        }" + NL + "        service_";
  protected final String TEXT_223 = ".ping(new org.talend.mdm.webservice.WSPing());";
  protected final String TEXT_224 = NL + "        globalMap.put(connKey_";
  protected final String TEXT_225 = ", service_";
  protected final String TEXT_226 = ");" + NL + "    }";
  protected final String TEXT_227 = NL + NL + "org.talend.mdm.webservice.WSDataClusterPK dataCluster_";
  protected final String TEXT_228 = " = new org.talend.mdm.webservice.WSDataClusterPK(";
  protected final String TEXT_229 = " + \"";
  protected final String TEXT_230 = "\");" + NL + "org.talend.mdm.webservice.WSDataModelPK dataModel_";
  protected final String TEXT_231 = " = new org.talend.mdm.webservice.WSDataModelPK(";
  protected final String TEXT_232 = ");" + NL + "" + NL + "String input_";
  protected final String TEXT_233 = ";" + NL + "" + NL + "java.util.List<org.talend.mdm.webservice.WSItemPK> wspks_";
  protected final String TEXT_234 = ";" + NL + "org.talend.mdm.webservice.WSItemPK wspk_";
