...
public class TSybaseSCDELTBeginJava {
  ...
  protected final String TEXT_5 = NL + "\t\tjava.lang.Class.forName(\"com.sybase.jdbc4.jdbc.SybDriver\");" + NL + "\t        ";
  protected final String TEXT_6 = NL + "\t    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t        ";
  protected final String TEXT_7 = NL + "\t\t\tString url_";
  protected final String TEXT_8 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_9 = " + \":\" + ";
  protected final String TEXT_10 = " + \"/\" + ";
  protected final String TEXT_11 = ";";
  protected final String TEXT_12 = NL + "\t\t\tString url_";
  protected final String TEXT_13 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_14 = " + \":\" + ";
  protected final String TEXT_15 = " + \"/\" + ";
  protected final String TEXT_16 = " + \"?\" + ";
  protected final String TEXT_17 = ";";
  protected final String TEXT_18 = NL + "        String dbUser_";
  ...
  protected final String TEXT_28 = NL + NL + "        String dbPwd_";
  ...
  protected final String TEXT_35 = NL + "    String tableName_";
  protected final String TEXT_36 = " = ";
  protected final String TEXT_37 = ";" + NL + "    String sourceTable_";
  ...
  protected final String TEXT_68 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_69 = ".close();";
  protected final String TEXT_70 = NL + "                if(!whetherExist_";
  protected final String TEXT_71 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_72 = " = conn_";
  protected final String TEXT_73 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_83 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_95 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_98 = ".executeUpdate(\"";
  protected final String TEXT_99 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_100 = ".close();";
  protected final String TEXT_101 = NL + "        System.out.println(\"[";
  protected final String TEXT_102 = "] table action ";
  protected final String TEXT_103 = " done\\n\");";
  protected final String TEXT_104 = NL + "        String updateForType1_";
  protected final String TEXT_105 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_106 = " + \" SET ";
  protected final String TEXT_107 = " FROM \" + sourceTable_";
  protected final String TEXT_108 = " + \" t WHERE ";
  protected final String TEXT_109 = " AND (";
  protected final String TEXT_110 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_111 = " = conn_";
  protected final String TEXT_112 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_113 = ".executeUpdate(updateForType1_";
  protected final String TEXT_114 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_115 = ".close();";
  protected final String TEXT_116 = NL + "            System.out.println(\"[";
  protected final String TEXT_117 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_118 = " + \"\\ndone\");";
  protected final String TEXT_119 = NL + "        String updateForType2_";
  protected final String TEXT_120 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_121 = " + \" SET ";
  protected final String TEXT_122 = " = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_123 = "\"))) + \"'";
  protected final String TEXT_124 = ", ";
  protected final String TEXT_125 = " = 0";
  protected final String TEXT_126 = " FROM \" + sourceTable_";
  protected final String TEXT_127 = " + \" t WHERE ";
  protected final String TEXT_128 = " AND (";
  protected final String TEXT_129 = ") AND \" + tableName_";
  protected final String TEXT_130 = " + \".";
  protected final String TEXT_131 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_134 = ".executeUpdate(updateForType2_";
  protected final String TEXT_135 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_136 = ".close();";
  protected final String TEXT_137 = NL + "            System.out.println(\"[";
  protected final String TEXT_138 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_139 = " + \"\\ndone\");";
  protected final String TEXT_140 = NL + "        String insertForType2_";
  protected final String TEXT_141 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_142 = " + \"(";
  protected final String TEXT_143 = ", ";
  protected final String TEXT_144 = ") SELECT ";
  protected final String TEXT_145 = "\" + ";
  protected final String TEXT_146 = " + \".NEXTVAL, ";
  protected final String TEXT_147 = "t.";
  protected final String TEXT_148 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_149 = "\"))) + \"', NULL";
  protected final String TEXT_150 = ", 1";
  protected final String TEXT_151 = ", d.";
  protected final String TEXT_152 = " + 1";
  protected final String TEXT_153 = " FROM \" + " + NL + "        sourceTable_";
  protected final String TEXT_154 = " + \" t, \" + tableName_";
  protected final String TEXT_155 = " + \" d WHERE ";
  protected final String TEXT_156 = " AND (";
  protected final String TEXT_157 = ") AND d.";
  protected final String TEXT_158 = " = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_159 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_162 = ".executeUpdate(insertForType2_";
  protected final String TEXT_163 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_164 = ".close();";
  protected final String TEXT_165 = NL + "            System.out.println(\"[";
  protected final String TEXT_166 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_167 = " + \"\\ndone\");";
  protected final String TEXT_168 = NL + "    String insert_";
  protected final String TEXT_169 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_170 = " + \"(";
  protected final String TEXT_171 = ", ";
  protected final String TEXT_172 = ") SELECT ";
  protected final String TEXT_173 = "\" + ";
  protected final String TEXT_174 = " + \".NEXTVAL, ";
  protected final String TEXT_175 = "t.";
  protected final String TEXT_176 = "\"";
  protected final String TEXT_177 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_178 = "\"))) + \"', NULL\"";
  protected final String TEXT_179 = NL + "    + \"";
  protected final String TEXT_180 = ", 1";
  protected final String TEXT_181 = ", 1";
  protected final String TEXT_182 = " FROM \" + " + NL + "    sourceTable_";
  protected final String TEXT_183 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_184 = " + \" d ON ";
  protected final String TEXT_185 = " WHERE (";
  protected final String TEXT_186 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_189 = ".executeUpdate(insert_";
  protected final String TEXT_190 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_191 = ".close();";
  protected final String TEXT_192 = NL + "        System.out.println(\"[";
  protected final String TEXT_193 = "] new rows sql\\n\" + insert_";
