...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_184 = ".createStatement(java.sql.ResultSet.TYPE_FORWARD_ONLY," + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjava.sql.ResultSet.CONCUR_READ_ONLY);" + NL + "\t\t\t\tif(stmt_";
  protected final String TEXT_185 = " instanceof com.mysql.jdbc.Statement){" + NL + "\t\t\t\t    ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_186 = ").enableStreamingResults();" + NL + "\t\t\t\t}else if(stmt_";
  protected final String TEXT_187 = " instanceof com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper){" + NL + "\t\t\t\t    ((com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper)stmt_";
  protected final String TEXT_188 = ").enableStreamingResults();" + NL + "\t\t\t\t}";
  protected final String TEXT_189 = NL + "              stmt_";
  protected final String TEXT_190 = ".setFetchSize(";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_193 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\tif (null != dataSources_";
  protected final String TEXT_194 = ") {" + NL + "        \t\t\tString dsAlias_";
  protected final String TEXT_195 = " = ";
  protected final String TEXT_196 = ";" + NL + "            \t\tif (dataSources_";
  protected final String TEXT_197 = ".get(dsAlias_";
  protected final String TEXT_198 = ") == null) {" + NL + "               \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_199 = " + \" available!\");" + NL + "                  \t}" + NL + "            \t\tconn_";
  protected final String TEXT_200 = " = dataSources_";
  protected final String TEXT_201 = ".get(dsAlias_";
  protected final String TEXT_202 = ").getConnection();" + NL + "        \t\t} else {";
  ...
  protected final String TEXT_221 = NL + "            java.util.Date date_";
  protected final String TEXT_222 = " = null;" + NL + "            try{" + NL + "            \tdate_";
  protected final String TEXT_223 = " = rs_";
  protected final String TEXT_224 = ".getTimestamp(";
  protected final String TEXT_225 = "column_index_";
  protected final String TEXT_226 = ");" + NL + "            }catch(java.lang.Exception e){" + NL + "            \tdate_";
  protected final String TEXT_227 = " = rs_";
  protected final String TEXT_228 = ".getDate(";
  protected final String TEXT_229 = "column_index_";
  protected final String TEXT_230 = ");" + NL + "            }";
  protected final String TEXT_231 = NL + "            ";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = " = date_";
  protected final String TEXT_234 = ";";
  protected final String TEXT_235 = NL + "    " + NL + "\t";
  protected final String TEXT_236 = NL + "\t\t    int nb_line_";
  protected final String TEXT_237 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_243 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_244 = " =  conn_";
  protected final String TEXT_245 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_246 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_247 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_248 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_249 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_250 = NL + "                 conn_";
  protected final String TEXT_251 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_252 = NL + "               ";
  protected final String TEXT_253 = " + \"=\" + ";
  protected final String TEXT_254 = " + \";\" +";
  protected final String TEXT_255 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_256 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_257 = ");";
  protected final String TEXT_258 = NL + "\t\t    ";
  protected final String TEXT_259 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_260 = " = ";
  protected final String TEXT_261 = ";" + NL + "\t\t\t";
  protected final String TEXT_262 = NL + "                log.debug(\"";
  protected final String TEXT_263 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_272 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_273 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_274 = " = stmt_";
  protected final String TEXT_275 = ".executeQuery(dbquery_";
  protected final String TEXT_276 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_277 = " = rs_";
  protected final String TEXT_278 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_279 = " = rsmd_";
  protected final String TEXT_280 = ".getColumnCount();" + NL;
  protected final String TEXT_281 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_282 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_283 = ".setDbmsId(\"";
  protected final String TEXT_284 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_285 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_286 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_287 = ".add(\"";
  protected final String TEXT_288 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_289 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_290 = " = ";
  protected final String TEXT_291 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_292 = "; i <= rsmd_";
  protected final String TEXT_293 = ".getColumnCount()-";
  protected final String TEXT_294 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_295 = ".contains(rsmd_";
  protected final String TEXT_296 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_297 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_298 = ".setName(rsmd_";
  protected final String TEXT_299 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_300 = ".setDbName(rsmd_";
  protected final String TEXT_301 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_302 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_303 = "\", rsmd_";
  protected final String TEXT_304 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_305 = ".getPrecision(i), rsmd_";
  protected final String TEXT_306 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_307 = ".setDbType(rsmd_";
  protected final String TEXT_308 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_309 = ".setDbTypeId(rsmd_";
  protected final String TEXT_310 = ".getColumnType(i));";
  protected final String TEXT_311 = NL + "                \tdcm_";
  protected final String TEXT_312 = ".setFormat(";
  protected final String TEXT_313 = ");";
  protected final String TEXT_314 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_315 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_316 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_317 = ".setLength(rsmd_";
  protected final String TEXT_318 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_319 = ".setLength(rsmd_";
  protected final String TEXT_320 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_321 = NL + "\t\t\tdcm_";
  protected final String TEXT_322 = ".setLength(rsmd_";
  protected final String TEXT_323 = ".getPrecision(i));";
  ...
  protected final String TEXT_336 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_337 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_338 = NL + "\t\t    ";
  protected final String TEXT_339 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_340 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_341 = NL + "\t\t    while (rs_";
  protected final String TEXT_342 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_343 = "++;" + NL + "\t\t        ";
  protected final String TEXT_344 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_345 = " = ";
  protected final String TEXT_346 = " + dcg_";
  protected final String TEXT_347 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_348 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  ...
  protected final String TEXT_371 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_372 = ".getObject(";
  protected final String TEXT_373 = "column_index_";
  protected final String TEXT_374 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_375 = NL + "                                    ";
  protected final String TEXT_376 = ".";
  protected final String TEXT_377 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_386 = ".setEPSG(";
  protected final String TEXT_387 = ");" + NL + "                                        }";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_389 = NL + "                                  ";
  protected final String TEXT_390 = ".";
  protected final String TEXT_391 = "=dcg_";
  ...
  protected final String TEXT_396 = "; i_";
  protected final String TEXT_397 = "  <= rsmd_";
  protected final String TEXT_398 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_411 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_412 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_413 = ".getColumnTypeName(i_";
  protected final String TEXT_414 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_415 = ".add(rs_";
  protected final String TEXT_416 = ".getString(i_";
  protected final String TEXT_417 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_418 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
    ...
    stringBuffer.append(TEXT_181);
		...
		public void createStatement(INode node) {
		   ...
		   if(("true").equals(useExistingConn)) {
			...
			if(null != driverName && driverName.toLowerCase().contains("mysql")){
