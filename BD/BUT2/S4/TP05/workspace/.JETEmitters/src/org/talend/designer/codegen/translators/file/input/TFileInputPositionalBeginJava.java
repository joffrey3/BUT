...
public class TFileInputPositionalBeginJava
{
  ...
  protected final String TEXT_650 = " instanceof java.io.InputStream){" + NL + "            \t\tthrow new java.lang.RuntimeException(\"When the input source is a stream,footer shouldn't be bigger than 0.\");" + NL + "            \t}else{" + NL + "            \t\tin_";
  protected final String TEXT_651 = " = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_652 = ")), ";
  protected final String TEXT_653 = "));" + NL + "            \t}" + NL + "\t\t\t\t";
  protected final String TEXT_654 = NL + "                               byteReader_";
  protected final String TEXT_655 = " = new org.talend.fileprocess.delimited.RowParserByByte(zis_";
  protected final String TEXT_656 = ", rowLength_";
  protected final String TEXT_657 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_658 = NL + "                              byteReader_";
  protected final String TEXT_659 = " = new org.talend.fileprocess.delimited.RowParserByByte(String.valueOf(filename_";
  protected final String TEXT_660 = "), rowLength_";
  protected final String TEXT_661 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_662 = NL + "\t\t\t\t\treader_";
  protected final String TEXT_663 = " = new org.talend.fileprocess.delimited.RowParser(in_";
  protected final String TEXT_664 = ", ";
  protected final String TEXT_665 = ", ";
  protected final String TEXT_666 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_667 = "\t";
  protected final String TEXT_668 = NL + "                      byteReader_";
  protected final String TEXT_669 = ".skipHeaders(";
  protected final String TEXT_670 = ");";
  protected final String TEXT_671 = NL + "                \treader_";
  protected final String TEXT_672 = ".skipHeaders(";
  protected final String TEXT_673 = ");" + NL + "            \t";
  protected final String TEXT_674 = NL + "\t" + NL + "            \tif ( nb_limit_";
  protected final String TEXT_675 = " >= 0 ){" + NL + "            \t\tnb_limit_";
  protected final String TEXT_676 = " = ( nb_limit_";
  protected final String TEXT_677 = " > available_";
  protected final String TEXT_678 = ") ? available_";
  protected final String TEXT_679 = " : nb_limit_";
  protected final String TEXT_680 = ";" + NL + "            \t}else{" + NL + "            \t\tnb_limit_";
  protected final String TEXT_681 = " = available_";
  protected final String TEXT_682 = ";" + NL + "            \t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t} catch(java.lang.Exception e) {//TD110 end" + NL + "        \t";
  protected final String TEXT_683 = NL + "        \t\tthrow e;" + NL + "        \t";
  protected final String TEXT_684 = NL + "        \t\t";
  protected final String TEXT_685 = NL + "        \t\t\tlog.error(\"";
  protected final String TEXT_686 = " - \" +e.getMessage());" + NL + "        \t\t";
  protected final String TEXT_687 = NL + "    \t\t\tSystem.err.println(e.getMessage());" + NL + "        \t";
  protected final String TEXT_688 = NL + "        }";
  protected final String TEXT_689 = NL + "                    while (nb_limit_";
  protected final String TEXT_690 = " != 0 && byteReader_";
  protected final String TEXT_691 = "!=null && byteReader_";
  protected final String TEXT_692 = ".readRecord()) {" + NL + "        \t            row_";
  protected final String TEXT_693 = " = new String(byteReader_";
  protected final String TEXT_694 = ".getBuffer(),";
  protected final String TEXT_695 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_696 = NL + "                    while (nb_limit_";
  protected final String TEXT_697 = " != 0 && reader_";
  protected final String TEXT_698 = "!=null && reader_";
  protected final String TEXT_699 = ".readRecord()) {" + NL + "        \t            row_";
  protected final String TEXT_700 = " = reader_";
  protected final String TEXT_701 = ".getRowRecord();" + NL + "            \t";
  protected final String TEXT_702 = NL + NL + "\t\t\t";
  protected final String TEXT_703 = NL + "\t\t\t\trowLen_";
  protected final String TEXT_704 = " = row_";
  protected final String TEXT_705 = ".getBytes(";
  protected final String TEXT_706 = ").length;" + NL + "\t\t\t";
  protected final String TEXT_707 = NL + "\t\t\t\trowLen_";
  protected final String TEXT_708 = " = row_";
  protected final String TEXT_709 = ".length();" + NL + "\t\t\t";
  protected final String TEXT_710 = NL + "\t\t\t";
  protected final String TEXT_711 = NL + "    \t\t\t\t\t\t";
  protected final String TEXT_712 = " = null;\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_713 = NL + "        \t\t\t" + NL + "            \t\t\tboolean whetherReject_";
  protected final String TEXT_714 = " = false;" + NL + "            \t\t\t";
  protected final String TEXT_715 = " = new ";
  protected final String TEXT_716 = "Struct();" + NL + "            \t\t\ttry {" + NL + "    \t\t\t" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_717 = NL + "                      \t\t\t\t\tpositionalUtil_";
  protected final String TEXT_718 = ".setValue_";
  protected final String TEXT_719 = "(";
  protected final String TEXT_720 = ",begins_";
  protected final String TEXT_721 = ",ends_";
  protected final String TEXT_722 = ",rowLen_";
  protected final String TEXT_723 = "," + NL + "                          \t\t\t\t";
  protected final String TEXT_724 = "byteArray_";
  protected final String TEXT_725 = ",arrays_";
  protected final String TEXT_726 = ",";
  protected final String TEXT_727 = "column_";
  protected final String TEXT_728 = ",row_";
  protected final String TEXT_729 = ");          " + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_730 = NL + "                            \tint substringBegin";
  protected final String TEXT_731 = "=0,substringEnd";
  protected final String TEXT_732 = "=0;" + NL + "                            \tint[]begin_end_";
  protected final String TEXT_733 = "=new int[2];" + NL + "                            \t" + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_734 = NL + "                        \t\t\t\tsubstringBegin";
  protected final String TEXT_735 = " = positionalUtil_";
  protected final String TEXT_736 = ".parseValue_";
  protected final String TEXT_737 = "(row_";
  protected final String TEXT_738 = ", substringBegin";
  protected final String TEXT_739 = ", substringEnd";
  protected final String TEXT_740 = ", rowLen_";
  protected final String TEXT_741 = ", columnValue";
  protected final String TEXT_742 = " ";
  protected final String TEXT_743 = ", arrays_";
  protected final String TEXT_744 = ", byteArray_";
  protected final String TEXT_745 = ", dynamic_";
  protected final String TEXT_746 = ");" + NL + "                        \t\t\t\tsubstringEnd";
  protected final String TEXT_747 = " = substringBegin";
  protected final String TEXT_748 = ";" + NL + "                    \t\t\t\t";
  protected final String TEXT_749 = NL + "      \t \t\t\t\t\t\t\t\tpositionalUtil_";
  protected final String TEXT_750 = ".setValue_";
  protected final String TEXT_751 = "(";
  protected final String TEXT_752 = ",columnValue";
  protected final String TEXT_753 = ");" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_754 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_755 = ".";
  protected final String TEXT_756 = "=dynamic_";
  protected final String TEXT_757 = ";" + NL + "    \t\t\t\t\t\t\t";
  protected final String TEXT_758 = NL + "    \t\t" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_759 = " ";
  protected final String TEXT_760 = " = null; ";
  protected final String TEXT_761 = "        \t\t\t" + NL + "            \t\t\t" + NL + "    \t\t\t\t\t} catch (java.lang.Exception e) {" + NL + "        \t\t\t\t\twhetherReject_";
  protected final String TEXT_762 = " = true;";
  protected final String TEXT_763 = NL + "                                throw(e);";
  ...
  protected final String TEXT_777 = NL + "                    \t\t\t\t\tlog.error(\"";
  protected final String TEXT_778 = " - \" +e.getMessage());" + NL + "                    \t\t\t\t";
  protected final String TEXT_779 = NL + "                                    System.err.println(e.getMessage());";
