...
public class TS3BucketCreateMainJava
{
  ...
  protected final String TEXT_183 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_184 = ");" + NL + "\t\t";
  protected final String TEXT_185 = NL + "\t\tconn_";
  protected final String TEXT_186 = ".createBucket(";
  protected final String TEXT_187 = ");" + NL + "\t\t";
  protected final String TEXT_188 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_189 = " - Create the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_191 = "){" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_193 = ");" + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_195 = " - \" + e_";
  protected final String TEXT_196 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_198 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_199 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_200 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_201 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
