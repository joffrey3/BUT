...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_84 = ";" + NL + "    }" + NL + "" + NL + "    schemaForSearch_";
  protected final String TEXT_85 = " = dbschema_";
  protected final String TEXT_86 = ";";
  protected final String TEXT_87 = NL;
  protected final String TEXT_88 = NL + "        int updateKeyCount_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_91 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_92 = NL + "        int deleteKeyCount_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_95 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_96 = NL + "int nb_line_";
  protected final String TEXT_97 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_98 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_99 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_100 = " = 0;" + NL + "int nb_line_rejected_";
  ...
  protected final String TEXT_104 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_105 = "=0;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_106 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_107 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_108 = " = calendar_";
  protected final String TEXT_109 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_110 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_111 = " = calendar_";
  protected final String TEXT_112 = ".getTime().getTime();" + NL + "long date_";
  protected final String TEXT_113 = ";" + NL + "" + NL + "boolean whetherReject_";
  ...
  protected final String TEXT_118 = "=0;" + NL + "   int tmp_batchUpdateCount_";
  protected final String TEXT_119 = " = 0;";
  protected final String TEXT_120 = NL + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_126 = NL + NL + "    java.lang.Class.forName(\"com.amazon.redshift.jdbc41.Driver\");";
  protected final String TEXT_127 = NL + "    ";
  protected final String TEXT_128 = NL + "\t\tString url_";
  protected final String TEXT_129 = " = \"jdbc:redshift://\"+";
  protected final String TEXT_130 = "+\":\"+";
  protected final String TEXT_131 = "+\"/\"+";
  protected final String TEXT_132 = ";" + NL + "\t";
  protected final String TEXT_133 = NL + "\t\tString url_";
  protected final String TEXT_134 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_135 = " + \":\" + ";
  protected final String TEXT_136 = " + \"/\" + ";
  protected final String TEXT_137 = " + \"?\" + ";
  protected final String TEXT_138 = ";" + NL + "\t";
  protected final String TEXT_139 = NL + "    " + NL + "    String dbUser_";
  protected final String TEXT_140 = " = ";
  protected final String TEXT_141 = ";";
  protected final String TEXT_142 = NL;
  protected final String TEXT_143 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_144 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_145 = ");";
  protected final String TEXT_146 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = "; ";
  protected final String TEXT_149 = NL + NL + "    String dbPwd_";
  protected final String TEXT_150 = " = decryptedPassword_";
  protected final String TEXT_151 = ";";
  protected final String TEXT_152 = NL + "    conn_";
  protected final String TEXT_153 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_154 = ",dbUser_";
  protected final String TEXT_155 = ",dbPwd_";
  protected final String TEXT_156 = ");" + NL + "\t";
  protected final String TEXT_157 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_158 = "\", conn_";
  protected final String TEXT_159 = ");" + NL + "    conn_";
  protected final String TEXT_160 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_161 = NL + "        int commitEvery_";
  protected final String TEXT_162 = " = ";
  protected final String TEXT_163 = ";" + NL + "        int commitCounter_";
  ...
  protected final String TEXT_172 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_179 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();";
  protected final String TEXT_182 = NL + "                              stmtCreate_";
  protected final String TEXT_183 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_203 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_236 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_239 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_240 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_241 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_242 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_243 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_248 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_249 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_250 = " = tableNameForSearch_";
  protected final String TEXT_251 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_252 = " = tableNameForSearch_";
  protected final String TEXT_253 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_254 = " = dbMetaData_";
  protected final String TEXT_255 = ".getTables(null, dbschemaForSearch_";
  ...
  protected final String TEXT_281 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_299 = ".toUpperCase()";
  protected final String TEXT_300 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_305 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_306 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_314 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_315 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_316 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_317 = " == null || dbschema_";
  protected final String TEXT_318 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_319 = " = conn_";
  protected final String TEXT_320 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_321 = " = stmtSchema_";
  protected final String TEXT_322 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_323 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_324 = " = rsSchema_";
  protected final String TEXT_325 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_326 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_327 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_361 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_365 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_366 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_367 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_368 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_375 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_376 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_377 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_378 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_379 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_380 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_516 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_517 = " + \"\\\" (";
  protected final String TEXT_518 = ") VALUES (";
  protected final String TEXT_519 = ")\");";
  protected final String TEXT_520 = NL + "\t\t\tint rowCount";
  protected final String TEXT_521 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_522 = " {";
  protected final String TEXT_523 = "\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_524 = " ";
  protected final String TEXT_525 = ";" + NL + "\t\t\t\t\t\t" + NL + "\t            \t\tpublic BufferLine_";
  protected final String TEXT_526 = " c";
  protected final String TEXT_527 = "(";
  protected final String TEXT_528 = " ";
  protected final String TEXT_529 = "){" + NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_530 = " = ";
  protected final String TEXT_531 = ";" + NL + "\t\t\t\t\t\t\treturn this;" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_532 = "\t\t" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_533 = "> exInsertColValueList";
  protected final String TEXT_534 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_535 = " exInsertColValue";
  protected final String TEXT_536 = " = null;" + NL + "" + NL + "" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_537 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_538 = "=0;i_";
  protected final String TEXT_539 = " < ";
  protected final String TEXT_540 = ";i_";
  protected final String TEXT_541 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_542 = ".append(\"(";
  protected final String TEXT_543 = ")\");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_544 = "!=";
  protected final String TEXT_545 = "-1) extendInsertValueStmt_";
  protected final String TEXT_546 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  protected final String TEXT_547 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_548 = " + \"\\\" (";
  protected final String TEXT_549 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_550 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_556 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_557 = " + \"\\\" SET ";
  protected final String TEXT_558 = " WHERE ";
  protected final String TEXT_559 = "\");" + NL + "\t    ";
  protected final String TEXT_560 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_561 = " = conn_";
  protected final String TEXT_562 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_563 = " + \"\\\" WHERE ";
  protected final String TEXT_564 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_565 = " = conn_";
  protected final String TEXT_566 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_571 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_577 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_578 = " + \"\\\" SET ";
  protected final String TEXT_579 = " WHERE ";
  protected final String TEXT_580 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_581 = " = conn_";
  protected final String TEXT_582 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_588 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_589 = " + \"\\\" WHERE ";
  protected final String TEXT_590 = "\");" + NL + "\t    ";
  protected final String TEXT_591 = NL + "\tclass BufferLine_";
  protected final String TEXT_592 = " {";
  protected final String TEXT_593 = NL + "\t\t\t";
  protected final String TEXT_594 = " ";
  protected final String TEXT_595 = ";" + NL + "\t\t\t" + NL + "    \t\tpublic BufferLine_";
  protected final String TEXT_596 = " c";
  protected final String TEXT_597 = "(";
  protected final String TEXT_598 = " ";
  protected final String TEXT_599 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_600 = " = ";
  protected final String TEXT_601 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}";
  protected final String TEXT_602 = NL + "\t\t\troutines.system.Dynamic ";
  protected final String TEXT_603 = ";" + NL + "\t\t\t" + NL + "\t\t\tpublic BufferLine_";
  protected final String TEXT_604 = " c";
  protected final String TEXT_605 = "(routines.system.Dynamic ";
  protected final String TEXT_606 = "){" + NL + "\t\t\t\tthis.";
  protected final String TEXT_607 = " = ";
  protected final String TEXT_608 = ";" + NL + "\t\t\t\treturn this;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_609 = NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_610 = "> exInsertColValueList";
  protected final String TEXT_611 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_612 = " exInsertColValue";
  protected final String TEXT_613 = " = null;" + NL + "    String insert_";
  protected final String TEXT_614 = " = \"\";" + NL + "    int rowCount";
  protected final String TEXT_615 = " = 0;";
  protected final String TEXT_616 = NL + "\tjava.sql.PreparedStatement pstmt_";
