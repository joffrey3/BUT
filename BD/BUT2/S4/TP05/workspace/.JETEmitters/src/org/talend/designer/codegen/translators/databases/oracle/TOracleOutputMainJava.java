...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_1135 = "){" + NL + "\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_1136 = " = e_";
  protected final String TEXT_1137 = ".getNextException(),sqle_";
  protected final String TEXT_1138 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_1139 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1140 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_1141 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1142 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1143 = ".getMessage(), ne_";
  protected final String TEXT_1144 = ".getSQLState(), ne_";
  protected final String TEXT_1145 = ".getErrorCode(), ne_";
  protected final String TEXT_1146 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1147 = " = sqle_";
  protected final String TEXT_1148 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1149 = " = e_";
  protected final String TEXT_1150 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t            \t";
  protected final String TEXT_1151 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1152 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1153 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_1154 = ");" + NL + "\t\t\t            }" + NL + "\t            \t";
  protected final String TEXT_1155 = NL + "\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_1156 = ");" + NL + "\t            \t";
  protected final String TEXT_1157 = NL + "\t        \t}" + NL + "                tmp_batchUpdateCount_";
  protected final String TEXT_1158 = " = pstmt_";
  protected final String TEXT_1159 = ".getUpdateCount();";
  protected final String TEXT_1160 = NL + "                    insertedCount_";
  protected final String TEXT_1161 = NL + "                    updatedCount_";
  protected final String TEXT_1162 = NL + "                    deletedCount_";
  protected final String TEXT_1163 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_1164 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1165 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_1166 = " = 0;" + NL + "            }";
  protected final String TEXT_1167 = NL + "                commitCounter_";
  protected final String TEXT_1168 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1169 = " <= commitCounter_";
  protected final String TEXT_1170 = ") {" + NL;
  protected final String TEXT_1171 = NL + "                        try {";
  protected final String TEXT_1172 = NL + "                            pstmt_";
  protected final String TEXT_1173 = ".executeBatch();";
  protected final String TEXT_1174 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1175 = "){" + NL + "\t\t\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_1176 = " = e_";
  protected final String TEXT_1177 = ".getNextException(),sqle_";
  protected final String TEXT_1178 = "=null;" + NL + "\t\t\t\t\t    \tString errormessage_";
  protected final String TEXT_1179 = ";" + NL + "\t\t\t\t\t\t\tif (ne_";
  protected final String TEXT_1180 = " != null) {" + NL + "\t\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_1181 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1182 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1183 = ".getMessage(), ne_";
  protected final String TEXT_1184 = ".getSQLState(), ne_";
  protected final String TEXT_1185 = ".getErrorCode(), ne_";
  protected final String TEXT_1186 = ");" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1187 = " = sqle_";
  protected final String TEXT_1188 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1189 = " = e_";
  protected final String TEXT_1190 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t            \t";
  protected final String TEXT_1191 = NL + "\t\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_1192 = " != null) {" + NL + "\t\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1193 = ");" + NL + "\t\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t\t            \tthrow(e_";
  protected final String TEXT_1194 = ");" + NL + "\t\t\t\t\t            }" + NL + "\t\t\t            \t";
  protected final String TEXT_1195 = NL + "\t\t\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_1196 = ");" + NL + "\t\t\t            \t";
  protected final String TEXT_1197 = NL + "\t\t\t        \t}" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_1198 = " = pstmt_";
  protected final String TEXT_1199 = ".getUpdateCount();";
  protected final String TEXT_1200 = NL + "                            insertedCount_";
  protected final String TEXT_1201 = NL + "                            updatedCount_";
  protected final String TEXT_1202 = NL + "                            deletedCount_";
  protected final String TEXT_1203 = NL + "                        += (tmp_batchUpdateCount_";
  protected final String TEXT_1204 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1205 = ":0);";
  protected final String TEXT_1206 = NL + "                    conn_";
  protected final String TEXT_1207 = ".commit();";
  protected final String TEXT_1208 = NL + "                    commitCounter_";
  protected final String TEXT_1209 = "=0;" + NL + "                }";
