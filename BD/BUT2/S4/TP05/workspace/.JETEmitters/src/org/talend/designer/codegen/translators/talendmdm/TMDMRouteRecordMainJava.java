...
public class TMDMRouteRecordMainJava
{
  ...
  protected final String TEXT_182 = "\");" + NL + "" + NL + "org.talend.mdm.webservice.WSRouteItemV2 wsRouteItem_";
  protected final String TEXT_183 = " = new org.talend.mdm.webservice.WSRouteItemV2();" + NL + "" + NL + "List<String> pkIds = new java.util.ArrayList<String>();";
  protected final String TEXT_184 = NL + "pkIds.add(";
  protected final String TEXT_185 = ");";
  protected final String TEXT_186 = NL + "org.talend.mdm.webservice.WSItemPK wsItemPK_";
  protected final String TEXT_187 = " = new org.talend.mdm.webservice.WSItemPK(";
  protected final String TEXT_188 = ",pkIds,dataCluster_";
  protected final String TEXT_189 = ");" + NL + "" + NL + "wsRouteItem_";
  protected final String TEXT_190 = ".setWsItemPK(wsItemPK_";
  protected final String TEXT_191 = ");" + NL + "" + NL + "//" + NL + "service_";
  protected final String TEXT_192 = ".routeItemV2(wsRouteItem_";
