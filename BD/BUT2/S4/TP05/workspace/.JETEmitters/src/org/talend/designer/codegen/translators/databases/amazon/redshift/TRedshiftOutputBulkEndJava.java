...
public class TRedshiftOutputBulkEndJava
{
  ...
  protected final String TEXT_156 = " = new com.amazonaws.ClientConfiguration();" + NL + "\t\tcc_";
  protected final String TEXT_157 = ".setUserAgent(routines.system.Constant.TALEND_USER_AGENT);" + NL + "\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\tint scketSendBufferSizeHints_";
  protected final String TEXT_159 = " = 0;" + NL + "\t\t\t\t\tint socketReceiveBufferSizeHints_";
  protected final String TEXT_160 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\tscketSendBufferSizeHints_";
  protected final String TEXT_162 = " = ";
  protected final String TEXT_163 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\t\t\tsocketReceiveBufferSizeHints_";
  protected final String TEXT_165 = " = ";
  protected final String TEXT_166 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_167 = NL + "\t\t\t\t\tcc_";
  protected final String TEXT_168 = ".setProtocol(com.amazonaws.Protocol.";
  protected final String TEXT_169 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_170 = NL + "\t\t\t\t\tcc_";
  protected final String TEXT_171 = ".set";
  protected final String TEXT_172 = "(";
  protected final String TEXT_173 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\tcc_";
  protected final String TEXT_175 = ".setSocketBufferSizeHints(scketSendBufferSizeHints_";
  protected final String TEXT_176 = ",socketReceiveBufferSizeHints_";
  protected final String TEXT_177 = ");" + NL + "\t\t\t";
  protected final String TEXT_178 = NL + "\t\t\tint sessionDurationSeconds_";
  protected final String TEXT_179 = " = ";
  protected final String TEXT_180 = " * 60;" + NL + "\t\t\tcom.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider.Builder stsBuilder_";
  protected final String TEXT_181 = " = " + NL + "\t\t\t\t\tnew com.amazonaws.auth.STSAssumeRoleSessionCredentialsProvider.Builder(";
  protected final String TEXT_182 = ", ";
  protected final String TEXT_183 = ").withLongLivedCredentialsProvider(credentialsProvider_";
  protected final String TEXT_184 = ")" + NL + "\t\t\t\t\t.withRoleSessionDurationSeconds(sessionDurationSeconds_";
  protected final String TEXT_185 = ");" + NL + "\t\t\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\t\tstsBuilder_";
  protected final String TEXT_187 = ".withServiceEndpoint(";
  protected final String TEXT_188 = ");" + NL + "\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\tstsBuilder_";
  protected final String TEXT_190 = ".withClientConfiguration(cc_";
  ...
  protected final String TEXT_210 = ".setEndpoint(";
  protected final String TEXT_211 = ");" + NL + "\t\t";
  protected final String TEXT_212 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_213 = " - Creating new connection successfully.\");" + NL + "\t\t";
  protected final String TEXT_214 = NL + "\t\ttry{" + NL + "\t\t\t";
  protected final String TEXT_215 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_216 = " - Uploading an object with key:\" + ";
  protected final String TEXT_217 = ");" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\tconn_";
  protected final String TEXT_219 = ".putObject(";
  protected final String TEXT_220 = ", ";
  protected final String TEXT_221 = ", file_";
  protected final String TEXT_222 = ");" + NL + "\t\t\t";
  protected final String TEXT_223 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_224 = " - Upload the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_225 = NL + "\t\t} finally {" + NL + "\t\t\tif(conn_";
  protected final String TEXT_226 = " !=null){" + NL + "\t\t\t\tconn_";
  protected final String TEXT_227 = ".shutdown();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t} else {";
  protected final String TEXT_228 = NL + "\t\t  log.debug(\"";
  protected final String TEXT_229 = " - \" + \"file \\\"\"+file_";
  protected final String TEXT_230 = ".getPath()+\"\\\" doesn't exist or content is empty.\");";
  protected final String TEXT_231 = NL + "\t}";
  protected final String TEXT_232 = NL + "\tif(file_";
  protected final String TEXT_233 = ".exists()) {" + NL + "\t\tfile_";
  protected final String TEXT_234 = ".delete();" + NL + "\t}";
  protected final String TEXT_235 = NL + "\tresourceMap.put(\"finish_";
