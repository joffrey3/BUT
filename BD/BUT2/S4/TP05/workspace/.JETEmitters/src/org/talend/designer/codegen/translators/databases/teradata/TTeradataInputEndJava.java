...
public class TTeradataInputEndJava
{
  ...
  protected final String TEXT_116 = NL + NL + "\t}" + NL + "}finally{" + NL + "\tstmt_";
  ...
  protected final String TEXT_123 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_124 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_125 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_126 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_127 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
  protected final String TEXT_128 = NL + "     }catch(Exception e){";
  protected final String TEXT_129 = NL + "         System.err.println(e.getMessage());" + NL + "     }";
