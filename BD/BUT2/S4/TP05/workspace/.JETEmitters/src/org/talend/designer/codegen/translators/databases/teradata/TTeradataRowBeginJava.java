...
public class TTeradataRowBeginJava
{
  ...
  protected final String TEXT_119 = NL + "                if(log.is";
  protected final String TEXT_120 = "Enabled())";
  ...
  protected final String TEXT_127 = NL + "    \tclass BytesLimit65535_";
  protected final String TEXT_128 = "{" + NL + "    \t\tpublic void limitLog4jByte() throws Exception{" + NL + "    \t\t\t";
  protected final String TEXT_129 = NL + "            StringBuilder ";
  protected final String TEXT_130 = " = new StringBuilder();";
  protected final String TEXT_131 = NL + "            ";
  protected final String TEXT_132 = ".append(\"Parameters:\");";
  protected final String TEXT_133 = NL + "                    ";
  protected final String TEXT_134 = ".append(\"";
  protected final String TEXT_135 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_136 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_143 = NL + "    \t\t}" + NL + "    \t}" + NL + "    \t" + NL + "        new BytesLimit65535_";
  protected final String TEXT_144 = "().limitLog4jByte();";
