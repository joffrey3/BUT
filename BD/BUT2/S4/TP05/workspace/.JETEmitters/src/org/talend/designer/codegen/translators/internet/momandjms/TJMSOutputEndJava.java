...
public class TJMSOutputEndJava
{
  ...
  protected final String TEXT_46 = ".close();" + NL + "resourceMap.remove(\"producer_";
  protected final String TEXT_47 = "\");" + NL + "session_";
  protected final String TEXT_48 = ".close();" + NL + "resourceMap.remove(\"session_";
  protected final String TEXT_49 = "\");" + NL + "connection_";
  protected final String TEXT_50 = ".close();" + NL + "resourceMap.remove(\"connection_";
  protected final String TEXT_51 = "\");" + NL + "globalMap.put(\"";
  protected final String TEXT_52 = "_NB_LINE\", nbline_";
