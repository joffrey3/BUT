...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_180 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_187 = NL + "\t\t\tif(rs_";
  protected final String TEXT_188 = ".get";
  protected final String TEXT_189 = "(";
  protected final String TEXT_190 = "column_index_";
  protected final String TEXT_191 = ") != null) {" + NL + "\t\t\t\t";
  protected final String TEXT_192 = ".";
  protected final String TEXT_193 = " = new java.util.Date(rs_";
  protected final String TEXT_194 = ".get";
  protected final String TEXT_195 = "(";
  protected final String TEXT_196 = "column_index_";
  protected final String TEXT_197 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
