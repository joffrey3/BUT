...
public class TTeradataCommitMainJava
{
  ...
  protected final String TEXT_117 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_118 = "\");" + NL + "if(conn_";
  protected final String TEXT_119 = " != null && !conn_";
  protected final String TEXT_120 = ".isClosed())" + NL + "{";
  protected final String TEXT_121 = NL + "    try{";
  protected final String TEXT_122 = NL + "    }finally{";
  protected final String TEXT_123 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_124 = ".setAutoCommit(true);" + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_125 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_126 = NL + "                           try{" + NL + "                              conn_";
  protected final String TEXT_127 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_128 = ");" + NL + "                           }catch(Exception e){" + NL + "                                  System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_129 = NL + "             }catch(Exception e){";
  protected final String TEXT_130 = NL + "                    System.err.println(e.getMessage());" + NL + "             }" + NL;
