...
public class TTeradataRowEndJava
{
  ...
  protected final String TEXT_116 = NL + "        stmt_";
  protected final String TEXT_117 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_118 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_119 = NL;
  protected final String TEXT_120 = NL + "\tpstmt_";
  protected final String TEXT_121 = ".close();";
  protected final String TEXT_122 = NL + "\tstmt_";
  protected final String TEXT_123 = ".close();";
  protected final String TEXT_124 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_125 = ">commitCounter_";
  protected final String TEXT_126 = "){" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_128 = "=0;" + NL + "" + NL + "\t\t}";
  protected final String TEXT_129 = NL + "\t";
  protected final String TEXT_130 = NL;
  protected final String TEXT_131 = NL + "    conn_";
  protected final String TEXT_132 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_133 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_134 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_135 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_136 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
  protected final String TEXT_137 = NL + "     }catch(Exception e){";
  protected final String TEXT_138 = NL + "         System.err.println(e.getMessage());" + NL + "     }";
