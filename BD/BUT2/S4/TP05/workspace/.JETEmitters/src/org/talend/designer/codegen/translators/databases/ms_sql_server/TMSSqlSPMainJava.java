...
public class TMSSqlSPMainJava
{
  ...
  protected final String TEXT_48 = ".execute();" + NL + "\t\t\twhile(statement_";
  protected final String TEXT_49 = ".getMoreResults() || (statement_";
  protected final String TEXT_50 = ".getUpdateCount() != -1)){" + NL + "\t\t\t\t//Do nothing. \"getMoreResults()\" would call method do error check." + NL + "\t\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_58 = " = resultSet_";
  protected final String TEXT_59 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_60 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_61 = " = statement_";
  protected final String TEXT_62 = ".getString(";
  protected final String TEXT_63 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_64 = " != null && tmpString_";
  protected final String TEXT_65 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_66 = ".";
  protected final String TEXT_67 = " = tmpString_";
  protected final String TEXT_68 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_69 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_70 = " = statement_";
  protected final String TEXT_71 = ".getTimestamp(";
  protected final String TEXT_72 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_73 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_74 = ".";
  protected final String TEXT_75 = " = new java.util.Date(tmpDate_";
  ...
  protected final String TEXT_83 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_84 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_97 = NL + "\t\t// No code generated: define a schema for ";
