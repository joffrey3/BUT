...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_197 = NL + "\t\t        if(stmt_";
  protected final String TEXT_198 = " instanceof com.mysql.jdbc.Statement){" + NL + "\t\t\t\t    ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_199 = ").enableStreamingResults();" + NL + "\t\t\t\t}else if(stmt_";
  protected final String TEXT_200 = " instanceof com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper){" + NL + "\t\t\t\t    ((com.mysql.jdbc.jdbc2.optional.JDBC4StatementWrapper)stmt_";
  protected final String TEXT_201 = ").enableStreamingResults();" + NL + "\t\t\t\t}";
  protected final String TEXT_202 = NL + "\t\t\t//check if year is null in DB" + NL + "\t\t\tString yearStringValue_";
  ...
  protected final String TEXT_206 = ");" + NL + "\t\t\tif (null != yearStringValue_";
  protected final String TEXT_207 = ") {" + NL + "\t\t\t\tInteger yearValue_";
  protected final String TEXT_208 = " = rs_";
  protected final String TEXT_209 = ".getInt(";
  protected final String TEXT_210 = "column_index_";
  protected final String TEXT_211 = ");" + NL + "\t\t\t\tcalendar_";
  protected final String TEXT_212 = ".set(yearValue_";
  protected final String TEXT_213 = ", 0, 1);" + NL + "\t\t\t\t";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = " = calendar_";
  protected final String TEXT_216 = ".getTime();" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  protected final String TEXT_217 = ".";
  protected final String TEXT_218 = " = null;" + NL + "\t\t\t}";
  protected final String TEXT_219 = NL + "\t\t\t\tif(rs_";
  protected final String TEXT_220 = ".getString(";
  protected final String TEXT_221 = "column_index_";
  protected final String TEXT_222 = ") != null) {" + NL + "\t\t\t\t\tString dateString_";
  ...
  protected final String TEXT_226 = ");" + NL + "\t\t\t\t\tif (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_227 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  protected final String TEXT_228 = ")) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_229 = ".";
  protected final String TEXT_230 = " = rs_";
  protected final String TEXT_231 = ".getTimestamp(";
  protected final String TEXT_232 = "column_index_";
  ...
  protected final String TEXT_247 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_248 = " =  conn_";
  protected final String TEXT_249 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_250 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_251 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_252 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_253 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_254 = NL + "                 conn_";
  protected final String TEXT_255 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_256 = NL + "               ";
  protected final String TEXT_257 = " + \"=\" + ";
  protected final String TEXT_258 = " + \";\" +";
  protected final String TEXT_259 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_260 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_261 = ");";
  protected final String TEXT_262 = NL + "\t\t    ";
  protected final String TEXT_263 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_264 = " = ";
  protected final String TEXT_265 = ";" + NL + "\t\t\t";
  protected final String TEXT_266 = NL + "                log.debug(\"";
  protected final String TEXT_267 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_274 = "_QUERY\",dbquery_";
  protected final String TEXT_275 = ");";
  protected final String TEXT_276 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_277 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_300 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_301 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_302 = ".setName(rsmd_";
  protected final String TEXT_303 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_312 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_313 = ".setDbTypeId(rsmd_";
  protected final String TEXT_314 = ".getColumnType(i));";
  protected final String TEXT_315 = NL + "                \tdcm_";
  protected final String TEXT_316 = ".setFormat(";
  protected final String TEXT_317 = ");";
  protected final String TEXT_318 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_319 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_320 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_321 = ".setLength(rsmd_";
  protected final String TEXT_322 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_323 = ".setLength(rsmd_";
  protected final String TEXT_324 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_325 = NL + "\t\t\tdcm_";
  protected final String TEXT_326 = ".setLength(rsmd_";
  protected final String TEXT_327 = ".getPrecision(i));";
  protected final String TEXT_328 = NL + "                \tdcm_";
  protected final String TEXT_329 = ".setPrecision(rsmd_";
  protected final String TEXT_330 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_331 = ".setNullable(rsmd_";
  protected final String TEXT_332 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_333 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_334 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_335 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_336 = ".metadatas.add(dcm_";
  protected final String TEXT_337 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_338 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_339 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_340 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_341 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_342 = NL + "\t\t    ";
  protected final String TEXT_343 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_344 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_345 = NL + "\t\t    while (rs_";
  protected final String TEXT_346 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_347 = "++;" + NL + "\t\t        ";
  protected final String TEXT_348 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_349 = " = ";
  protected final String TEXT_350 = " + dcg_";
  protected final String TEXT_351 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_352 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_353 = " = ";
  protected final String TEXT_354 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_357 = " < ";
  protected final String TEXT_358 = "column_index_";
  protected final String TEXT_359 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_360 = ".";
  protected final String TEXT_361 = " = ";
  protected final String TEXT_362 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_363 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_366 = NL + "\t\t                            ";
  protected final String TEXT_367 = ".";
  protected final String TEXT_368 = " = (List)rs_";
  ...
  protected final String TEXT_375 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_376 = ".getObject(";
  protected final String TEXT_377 = "column_index_";
  protected final String TEXT_378 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_379 = NL + "                                    ";
  protected final String TEXT_380 = ".";
  protected final String TEXT_381 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_390 = ".setEPSG(";
  ...
  protected final String TEXT_400 = "; i_";
  protected final String TEXT_401 = "  <= rsmd_";
  protected final String TEXT_402 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_415 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_416 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_417 = ".getColumnTypeName(i_";
  protected final String TEXT_418 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_419 = ".add(rs_";
  protected final String TEXT_420 = ".getString(i_";
  protected final String TEXT_421 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_422 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
