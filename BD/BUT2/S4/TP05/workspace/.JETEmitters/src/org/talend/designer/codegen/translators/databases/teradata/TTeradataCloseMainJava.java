...
public class TTeradataCloseMainJava
{
  ...
  protected final String TEXT_121 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_122 = ".setAutoCommit(true);" + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_123 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_124 = NL + "                             try{" + NL + "                                 conn_";
  protected final String TEXT_125 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_126 = ");" + NL + "                             }catch(Exception e){" + NL + "                                   System.err.println(e.getMessage());" + NL + "                             }";
  protected final String TEXT_127 = NL + "             }catch(Exception e){";
  protected final String TEXT_128 = NL + "                 System.err.println(e.getMessage());" + NL + "             }" + NL;
