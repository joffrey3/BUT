...
public class THiveRowMainJava
{
  ...
  protected final String TEXT_55 = NL + NL + "java.text.DateFormat dateStrFormat = new java.text.SimpleDateFormat(\"yyyyMMddHHmmss\");" + NL + "final String queryIdentifier = projectName + \"_\" + jobName + \"_\" + jobVersion.replace(\".\", \"_\") + \"_";
  protected final String TEXT_56 = "_\" + dateStrFormat.format(new Date(startTime));" + NL + "// For MapReduce Mode" + NL + "stmt_";
  protected final String TEXT_57 = ".execute(\"set mapred.job.name=\" + queryIdentifier);" + NL + "// For Tez Mode" + NL + "stmt_";
  protected final String TEXT_58 = ".execute(\"set hive.query.name=\" + queryIdentifier);" + NL + "\t\t";
  protected final String TEXT_59 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_60 = ".setTimestamp(";
  protected final String TEXT_61 = ",new java.sql.Timestamp(";
  ...
  protected final String TEXT_70 = ".executeQuery();" + NL + "\t";
  protected final String TEXT_71 = NL + "\t    \tpstmt_";
  protected final String TEXT_72 = ".execute();" + NL + "\t    \t";
  protected final String TEXT_73 = NL + "\t\t\t\trs_";
  protected final String TEXT_74 = " = stmt_";
  protected final String TEXT_75 = ".executeQuery(query_";
  protected final String TEXT_76 = ");" + NL + "\t\t\t";
  protected final String TEXT_77 = NL + "\t\t  \tstmt_";
  protected final String TEXT_78 = ".execute(query_";
  protected final String TEXT_79 = ");" + NL + "\t    \t";
  protected final String TEXT_80 = NL + "\t\tlog.info(\"Query sent to HiveServer2 to be executed with [Application Name(MapReduce)/DAG Name(Tez): \" + queryIdentifier + \"]\");" + NL + "\t    } catch (java.lang.Exception e) {" + NL + "\t        whetherReject_";
  protected final String TEXT_81 = " = true;" + NL + "\t        ";
  protected final String TEXT_82 = NL + "\t            throw(e);" + NL + "\t            ";
  protected final String TEXT_83 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_84 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_85 = NL + "\t                ";
  protected final String TEXT_86 = " = new ";
  protected final String TEXT_87 = "Struct();" + NL + "\t                ";
  ...
  protected final String TEXT_94 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t                ";
  protected final String TEXT_95 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_96 = ";" + NL + "\t                ";
  protected final String TEXT_97 = NL + "\t                System.err.print(e.getMessage());" + NL + "\t                ";
  protected final String TEXT_98 = NL + "\t    }" + NL + "\t\t";
  protected final String TEXT_99 = NL + "\t    if(!whetherReject_";
  ...
  protected final String TEXT_114 = NL + "\t        commitCounter_";
  protected final String TEXT_115 = "++;" + NL + "\t        if(commitEvery_";
  protected final String TEXT_116 = " <= commitCounter_";
  protected final String TEXT_117 = ") {" + NL + "\t        " + NL + "\t\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_119 = " - Starting to commit.\");" + NL + "\t\t\t\t";
  protected final String TEXT_120 = NL + "\t        \tconn_";
  protected final String TEXT_121 = ".commit();" + NL + "\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_123 = " - Commit has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_124 = NL + "\t        \t" + NL + "\t        \tcommitCounter_";
  protected final String TEXT_125 = "=0;" + NL + "\t        \t" + NL + "\t        }" + NL + "\t        ";
