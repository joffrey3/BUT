...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_1098 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1099 = "){" + NL + "\t\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1100 = " = e_";
  protected final String TEXT_1101 = ".getNextException(),sqle_";
  protected final String TEXT_1102 = "=null;" + NL + "\t\t\t\t    \tString errormessage_";
  protected final String TEXT_1103 = ";" + NL + "\t\t\t\t\t\tif (ne_";
  protected final String TEXT_1104 = " != null) {" + NL + "\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_1105 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1106 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1107 = ".getMessage(), ne_";
  protected final String TEXT_1108 = ".getSQLState(), ne_";
  protected final String TEXT_1109 = ".getErrorCode(), ne_";
  protected final String TEXT_1110 = ");" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1111 = " = sqle_";
  protected final String TEXT_1112 = ".getMessage();" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1113 = " = e_";
  protected final String TEXT_1114 = ".getMessage();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1115 = NL + "\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_1116 = " != null) {" + NL + "\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1117 = ");" + NL + "\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t            \tthrow(e_";
  protected final String TEXT_1118 = ");" + NL + "\t\t\t\t            }" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1119 = NL + "\t\t\t\t    \tint countSum_";
  protected final String TEXT_1120 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1121 = ": e_";
  protected final String TEXT_1122 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1123 = " += (countEach_";
  protected final String TEXT_1124 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1125 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1126 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1127 = " += countSum_";
  protected final String TEXT_1128 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1129 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1130 = " += countSum_";
  protected final String TEXT_1131 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1132 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_1133 = " += countSum_";
  protected final String TEXT_1134 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1135 = NL + "\t\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_1136 = ");" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1137 = NL + "\t\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1138 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1139 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1140 = " <= commitCounter_";
  protected final String TEXT_1141 = ") {";
  protected final String TEXT_1142 = NL + "                if ((batchSize_";
  protected final String TEXT_1143 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1144 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1145 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_1146 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1147 = ": pstmt_";
  protected final String TEXT_1148 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1156 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1157 = " += countSum_";
  protected final String TEXT_1158 = ";" + NL + "            \t    \t";
  protected final String TEXT_1159 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1160 = " += countSum_";
  protected final String TEXT_1161 = ";" + NL + "            \t    \t";
  protected final String TEXT_1162 = NL + "                batchSizeCounter_";
  protected final String TEXT_1163 = " = 0;" + NL + "               }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1164 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_1165 = " = e_";
  protected final String TEXT_1166 = ".getNextException(),sqle_";
  protected final String TEXT_1167 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_1168 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1169 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_1170 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1171 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1172 = ".getMessage(), ne_";
  protected final String TEXT_1173 = ".getSQLState(), ne_";
  protected final String TEXT_1174 = ".getErrorCode(), ne_";
  protected final String TEXT_1175 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1176 = " = sqle_";
  protected final String TEXT_1177 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_1178 = " = e_";
  protected final String TEXT_1179 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t    \t";
  protected final String TEXT_1180 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_1181 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_1182 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_1183 = ");" + NL + "\t\t\t            }" + NL + "\t\t\t    \t";
  protected final String TEXT_1184 = NL + "\t\t\t    \tint countSum_";
  protected final String TEXT_1185 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1186 = ": e_";
  protected final String TEXT_1187 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1188 = " += (countEach_";
  protected final String TEXT_1189 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1190 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1191 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1192 = " += countSum_";
  protected final String TEXT_1193 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1194 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1195 = " += countSum_";
  protected final String TEXT_1196 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1197 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1198 = " += countSum_";
  protected final String TEXT_1199 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1200 = NL + "\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_1201 = ");" + NL + "\t\t\t    \t";
  protected final String TEXT_1202 = NL + "\t\t\t\t}" + NL + "            }";
  protected final String TEXT_1203 = NL + "                \tconn_";
  protected final String TEXT_1204 = ".commit();" + NL + "                \t";
  protected final String TEXT_1205 = NL + "                \tcommitCounter_";
  protected final String TEXT_1206 = "=0;" + NL + "                }";
