...
public class TOracleInputBeginJava
{
  ...
  protected final String TEXT_299 = NL + "\t\t\tbyte [] tmpBytes_";
  protected final String TEXT_300 = " = rs_";
  protected final String TEXT_301 = ".getBytes(";
  protected final String TEXT_302 = "column_index_";
  protected final String TEXT_303 = ");" + NL + "\t\t\tif(tmpBytes_";
  protected final String TEXT_304 = " != null) {" + NL + "\t\t\t\t";
  protected final String TEXT_305 = ".";
  protected final String TEXT_306 = " = tmpBytes_";
  protected final String TEXT_307 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  protected final String TEXT_308 = ".";
  protected final String TEXT_309 = " = null;" + NL + "\t\t\t}";
  protected final String TEXT_310 = NL + "    \t\t\tTalendTimestampWithTZ talendTimestampWithTZ = null;" + NL + "    \t\t\tif(((oracle.jdbc.OracleResultSet) rs_";
  protected final String TEXT_311 = ").getTIMESTAMPTZ(";
  protected final String TEXT_312 = "column_index_";
  protected final String TEXT_313 = ") != null){" + NL + "    \t\t\t\ttalendTimestampWithTZ = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) rs_";
  protected final String TEXT_314 = ").getTIMESTAMPTZ(";
  protected final String TEXT_315 = "column_index_";
  protected final String TEXT_316 = ").toBytes());" + NL + "                }" + NL + "                if(talendTimestampWithTZ != null){" + NL + "                \t";
  protected final String TEXT_317 = ".";
  protected final String TEXT_318 = " = talendTimestampWithTZ;" + NL + "                }else{" + NL + "                \t";
  protected final String TEXT_319 = ".";
  protected final String TEXT_320 = " = null;" + NL + "                }" + NL + "    \t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\tjava.sql.Timestamp timestamp = rs_";
  protected final String TEXT_322 = ".getTimestamp(";
  protected final String TEXT_323 = "column_index_";
  protected final String TEXT_324 = ");" + NL + "\t\t\t\t\tif(timestamp != null) {" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_325 = ".";
  protected final String TEXT_326 = " = new java.util.Date(timestamp.getTime());" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_327 = ".";
  protected final String TEXT_328 = " = null;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_329 = NL + "\t\t\t\t";
  protected final String TEXT_330 = ".";
  protected final String TEXT_331 = " = routines.system.JDBCUtil.getDoubleObject2(rs_";
  protected final String TEXT_332 = ", ";
  protected final String TEXT_333 = "column_index_";
  protected final String TEXT_334 = ");";
  protected final String TEXT_335 = NL + "\t\t\t\t";
  protected final String TEXT_336 = ".";
  protected final String TEXT_337 = " = routines.system.JDBCUtil.getDouble2(rs_";
  protected final String TEXT_338 = ", ";
  protected final String TEXT_339 = "column_index_";
  protected final String TEXT_340 = ");";
  protected final String TEXT_341 = NL + "\t\t\t\t";
  protected final String TEXT_342 = ".";
  protected final String TEXT_343 = " = routines.system.JDBCUtil.getDoubleObject(rs_";
  protected final String TEXT_344 = ", ";
  protected final String TEXT_345 = "column_index_";
  protected final String TEXT_346 = ");";
  protected final String TEXT_347 = NL + "\t\t\t\t";
  protected final String TEXT_348 = ".";
  protected final String TEXT_349 = " = routines.system.JDBCUtil.getDouble(rs_";
  protected final String TEXT_350 = ", ";
  protected final String TEXT_351 = "column_index_";
  protected final String TEXT_352 = ");";
  protected final String TEXT_353 = NL + "\t\t\t\tObject tmpObj_";
  protected final String TEXT_354 = "_";
  protected final String TEXT_355 = " = rs_";
  protected final String TEXT_356 = ".getObject(";
  protected final String TEXT_357 = "column_index_";
  protected final String TEXT_358 = ");" + NL + "\t\t\t\tif(tmpObj_";
  protected final String TEXT_359 = "_";
  protected final String TEXT_360 = " != null) {";
  protected final String TEXT_361 = NL + "\t\t\t\t\t";
  protected final String TEXT_362 = ".";
  protected final String TEXT_363 = " = oracle.xdb.XMLType.createXML((oracle.sql.OPAQUE) tmpObj_";
  protected final String TEXT_364 = "_";
  protected final String TEXT_365 = ").getStringVal();";
  protected final String TEXT_366 = NL + "\t\t\t\t\t";
  protected final String TEXT_367 = ".";
  protected final String TEXT_368 = " = tmpObj_";
  ...
  protected final String TEXT_375 = NL + "\t\t\t\t\t\tthrow new RuntimeException(\"Null value in non-Nullable column\");";
  ...
  protected final String TEXT_395 = " == 0 && rs_";
  ...
  protected final String TEXT_399 = NL + "\t\t\t\t\t\tif(rs_";
  protected final String TEXT_400 = ".getObject(";
  protected final String TEXT_401 = "column_index_";
  protected final String TEXT_402 = ") == null){" + NL + "\t\t\t\t\t";
  protected final String TEXT_403 = NL + "\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\tif(rs_";
  ...
  protected final String TEXT_417 = NL + " \t                \tthrow new RuntimeException(\"Null value in non-Nullable column\");";
  protected final String TEXT_418 = NL + "\t\t\t\t\t}";
  protected final String TEXT_419 = NL + NL + NL + "\t";
  protected final String TEXT_420 = NL + "\t\t    int nb_line_";
  protected final String TEXT_421 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_422 = " = null;";
  protected final String TEXT_423 = NL + "\t\t        conn_";
  protected final String TEXT_424 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_425 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\t";
  protected final String TEXT_427 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_428 = " =  conn_";
  protected final String TEXT_429 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_430 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_431 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_432 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_433 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_434 = NL + "                 conn_";
  protected final String TEXT_435 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_436 = NL + "               ";
  protected final String TEXT_437 = " + \"=\" + ";
  protected final String TEXT_438 = " + \";\" +";
  protected final String TEXT_439 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_440 = ".setAutoCommit(currentAutoCommitMode";
  ...
  protected final String TEXT_454 = "_QUERY\",dbquery_";
  protected final String TEXT_455 = ");";
  protected final String TEXT_456 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_457 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_458 = " = stmt_";
  protected final String TEXT_459 = ".executeQuery(dbquery_";
  protected final String TEXT_460 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_461 = " = rs_";
  protected final String TEXT_462 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_463 = " = rsmd_";
  protected final String TEXT_464 = ".getColumnCount();" + NL;
  protected final String TEXT_465 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_466 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_467 = ".setDbmsId(\"";
  protected final String TEXT_468 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_469 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_470 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_471 = ".add(\"";
  protected final String TEXT_472 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_473 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_474 = " = ";
  protected final String TEXT_475 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_476 = "; i <= rsmd_";
  protected final String TEXT_477 = ".getColumnCount()-";
  protected final String TEXT_478 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_479 = ".contains(rsmd_";
  protected final String TEXT_480 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_481 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_482 = ".setName(rsmd_";
  protected final String TEXT_483 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_484 = ".setDbName(rsmd_";
  protected final String TEXT_485 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_486 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_487 = "\", rsmd_";
  protected final String TEXT_488 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_489 = ".getPrecision(i), rsmd_";
  protected final String TEXT_490 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_491 = ".setDbType(rsmd_";
  protected final String TEXT_492 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_493 = ".setDbTypeId(rsmd_";
  protected final String TEXT_494 = ".getColumnType(i));";
  protected final String TEXT_495 = NL + "                \tdcm_";
  protected final String TEXT_496 = ".setFormat(";
  protected final String TEXT_497 = ");";
  protected final String TEXT_498 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_499 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_500 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_501 = ".setLength(rsmd_";
  protected final String TEXT_502 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_503 = ".setLength(rsmd_";
  protected final String TEXT_504 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_505 = NL + "\t\t\tdcm_";
  protected final String TEXT_506 = ".setLength(rsmd_";
  protected final String TEXT_507 = ".getPrecision(i));";
  protected final String TEXT_508 = NL + "                \tdcm_";
  protected final String TEXT_509 = ".setPrecision(rsmd_";
  protected final String TEXT_510 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_511 = ".setNullable(rsmd_";
  protected final String TEXT_512 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_513 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_514 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_515 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_516 = ".metadatas.add(dcm_";
  protected final String TEXT_517 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_518 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_519 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_520 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_521 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_522 = NL + "\t\t    ";
  protected final String TEXT_523 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_524 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_525 = NL + "\t\t    while (rs_";
  protected final String TEXT_526 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_527 = "++;" + NL + "\t\t        ";
  protected final String TEXT_528 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_529 = " = ";
  protected final String TEXT_530 = " + dcg_";
  protected final String TEXT_531 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_532 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_533 = " = ";
  protected final String TEXT_534 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_535 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_536 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_537 = " < ";
  protected final String TEXT_538 = "column_index_";
  ...
  protected final String TEXT_548 = " = (List)rs_";
  protected final String TEXT_549 = ".getObject(";
  protected final String TEXT_550 = "column_index_";
  protected final String TEXT_551 = ");";
  protected final String TEXT_552 = NL + "\t                         \t\t";
  protected final String TEXT_553 = NL + "\t                         \t\t";
  protected final String TEXT_554 = NL + "\t                         \t\t";
  protected final String TEXT_555 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_556 = ".getObject(";
  protected final String TEXT_557 = "column_index_";
  protected final String TEXT_558 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_559 = NL + "                                    ";
  protected final String TEXT_560 = ".";
  protected final String TEXT_561 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_570 = ".setEPSG(";
  protected final String TEXT_571 = ");" + NL + "                                        }";
  protected final String TEXT_572 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_573 = NL + "                                  ";
  protected final String TEXT_574 = ".";
  protected final String TEXT_575 = "=dcg_";
  protected final String TEXT_576 = ";";
  protected final String TEXT_577 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_578 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_579 = " = ";
  protected final String TEXT_580 = "; i_";
  protected final String TEXT_581 = "  <= rsmd_";
  protected final String TEXT_582 = ".getColumnCount(); i_";
  protected final String TEXT_583 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_584 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_585 = ".getColumnTypeName(i_";
  protected final String TEXT_586 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_587 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_588 = ".getClob(i_";
  protected final String TEXT_589 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_590 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_591 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_592 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_593 = ".add(tNTextImpl_";
  protected final String TEXT_594 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_595 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_596 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_597 = ".getColumnTypeName(i_";
  protected final String TEXT_598 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_599 = ".add(rs_";
  protected final String TEXT_600 = ".getString(i_";
  protected final String TEXT_601 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_602 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_603 = ".";
  protected final String TEXT_604 = ", rs_";
  protected final String TEXT_605 = ", fixedColumnCount_";
  protected final String TEXT_606 = ",list_";
  protected final String TEXT_607 = ",";
  protected final String TEXT_608 = ");";
  protected final String TEXT_609 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_610 = ".";
  protected final String TEXT_611 = ", rs_";
  protected final String TEXT_612 = ", fixedColumnCount_";
  protected final String TEXT_613 = ",";
  protected final String TEXT_614 = ");";
  protected final String TEXT_615 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_616 = ".";
  protected final String TEXT_617 = ", rs_";
  protected final String TEXT_618 = ", fixedColumnCount_";
  protected final String TEXT_619 = ",";
  protected final String TEXT_620 = ");";
  protected final String TEXT_621 = NL + "                                  Object geom = rs_";
  protected final String TEXT_622 = ".getObject(";
  protected final String TEXT_623 = "column_index_";
  protected final String TEXT_624 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_625 = ".";
  protected final String TEXT_626 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_632 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_633 = " - Retrieving the record \" + nb_line_";
