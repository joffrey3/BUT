...
public class TParAccelInputBeginJava
{
  ...
  protected final String TEXT_180 = " > 0) {" + NL + "\t\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_181 = " = new java.io.FileWriter(";
  protected final String TEXT_182 = ", true);" + NL + "\t\t\t\t\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_183 = ",true));" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\tcom.paraccel.Driver.setLogLevel(";
  protected final String TEXT_184 = ");" + NL + "" + NL + "\t\t\tString url_";
  protected final String TEXT_185 = " = \"jdbc:paraccel://\" + ";
  protected final String TEXT_186 = " + \":\" + ";
  protected final String TEXT_187 = " + \"/\" + ";
  protected final String TEXT_188 = " +\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_189 = "+\"&protocolVersion=3\";";
