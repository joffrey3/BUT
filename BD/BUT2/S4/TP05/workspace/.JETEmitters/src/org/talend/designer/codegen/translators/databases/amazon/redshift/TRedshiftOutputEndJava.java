...
public class TRedshiftOutputEndJava {
  ...
  protected final String TEXT_135 = NL + "            commitCounter_";
  protected final String TEXT_136 = " = rowCount";
  protected final String TEXT_137 = ";//correct the commit counter as commit can happen before executing the sql for extend insert";
  protected final String TEXT_138 = NL + NL + "\t    if(rowCount";
  protected final String TEXT_139 = "!=0){" + NL + "" + NL + "\t        StringBuilder extendInsertValue_";
  protected final String TEXT_140 = " = new StringBuilder();" + NL + "\t        for(int i_";
  protected final String TEXT_141 = "=0 ; i_";
  protected final String TEXT_142 = " < rowCount";
  protected final String TEXT_143 = " ; i_";
  protected final String TEXT_144 = "++){";
  protected final String TEXT_145 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_146 = ".append(\"(";
  protected final String TEXT_147 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_148 = ".";
  protected final String TEXT_149 = ")+\")\");";
  protected final String TEXT_150 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_151 = ".append(\"(\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_152 = ".";
  protected final String TEXT_153 = ")+\")\");";
  protected final String TEXT_154 = NL + "\t\t\t\textendInsertValue_";
  protected final String TEXT_155 = ".append(\"(";
  protected final String TEXT_156 = ")\");";
  protected final String TEXT_157 = NL + "     \t\t\tif (i_";
  protected final String TEXT_158 = " != rowCount";
  protected final String TEXT_159 = " - 1) extendInsertValue_";
  protected final String TEXT_160 = ".append(\",\");" + NL + "\t        }" + NL;
  protected final String TEXT_161 = NL + "                \tinsert_";
  ...
  protected final String TEXT_171 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = ", \"";
  protected final String TEXT_174 = "\")+\") VALUES \" + extendInsertValue_";
  protected final String TEXT_175 = ".toString();";
  protected final String TEXT_176 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_177 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_178 = " + \"\\\" (";
  protected final String TEXT_179 = ") VALUES \"+extendInsertValue_";
  ...
  protected final String TEXT_185 = NL + "\t\t\trowCount";
  protected final String TEXT_186 = " = 0;" + NL + "\t        for(BufferLine_";
  protected final String TEXT_187 = " bufferL";
  protected final String TEXT_188 = " : exInsertColValueList";
  protected final String TEXT_189 = "){" + NL + "\t\t\t\tint count";
  protected final String TEXT_190 = " = rowCount";
  protected final String TEXT_191 = " *" + NL + "\t\t\t\t\t(";
  protected final String TEXT_192 = NL + "\t\t\t\t\t\t+ bufferL";
  protected final String TEXT_193 = ".";
  protected final String TEXT_194 = ".getColumnCount()";
  protected final String TEXT_195 = NL + "\t\t\t\t\t)" + NL + "\t\t\t\t+ 1;";
  protected final String TEXT_196 = NL + "\t                    count";
  protected final String TEXT_197 = "++;" + NL + "\t                    ";
  protected final String TEXT_198 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(bufferL";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = ", pstmt_";
  protected final String TEXT_201 = ", count";
  protected final String TEXT_202 = "-1, \"";
  protected final String TEXT_203 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_204 = NL + NL + "\t            rowCount";
  protected final String TEXT_205 = "++;" + NL + "\t        }" + NL + "\t        insertedCount_";
  protected final String TEXT_206 = " = insertedCount_";
  protected final String TEXT_207 = " + pstmt_";
  protected final String TEXT_208 = ".executeUpdate();" + NL + "\t    }" + NL + "\t";
  ...
  protected final String TEXT_213 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_214 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_215 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_216 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_217 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_218 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_219 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_220 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_221 = NL + "                        int[] status_";
  protected final String TEXT_222 = " = null;" + NL + "                        int countSum_";
  protected final String TEXT_223 = " = 0;" + NL + "                        try {" + NL + "                            if(pstmt_";
  protected final String TEXT_224 = "!=null && batchSizeCounter_";
  protected final String TEXT_225 = " > 0 ){";
  protected final String TEXT_226 = NL + "                                status_";
  protected final String TEXT_227 = " = pstmt_";
  protected final String TEXT_228 = ".executeBatch();";
  protected final String TEXT_229 = NL + "                                for(int countEach_";
  protected final String TEXT_230 = ": status_";
  protected final String TEXT_231 = ") {" + NL + "                                    countSum_";
  protected final String TEXT_232 = " += (countEach_";
  protected final String TEXT_233 = " < 0 ? 0 : countEach_";
  protected final String TEXT_234 = ");" + NL + "                                }" + NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_235 = NL + "                                throw(e);";
  protected final String TEXT_236 = NL + "                            for(int countEach_";
  protected final String TEXT_237 = ": e.getUpdateCounts()) {" + NL + "                                countSum_";
  protected final String TEXT_238 = " += (countEach_";
  protected final String TEXT_239 = " < 0 ? 0 : countEach_";
  protected final String TEXT_240 = ");" + NL + "                            }" + NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_241 = NL + "                        }" + NL + "                        if(pstmt_";
  protected final String TEXT_242 = "!=null && batchSizeCounter_";
  protected final String TEXT_243 = " > 0 ){" + NL + "                            try {" + NL + "                                tmp_batchUpdateCount_";
  protected final String TEXT_244 = " = pstmt_";
  protected final String TEXT_245 = ".getUpdateCount();" + NL + "                            }catch (java.sql.SQLException e){" + NL + "" + NL + "                            }" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_246 = " = tmp_batchUpdateCount_";
  ...
  protected final String TEXT_251 = NL + "                                insertedCount_";
  ...
  protected final String TEXT_258 = " += tmp_batchUpdateCount_";
  protected final String TEXT_259 = ";";
  protected final String TEXT_260 = NL + "                        }";
  protected final String TEXT_261 = NL + "                        if(pstmt_";
  protected final String TEXT_262 = " != null) {" + NL + "                            pstmt_";
  protected final String TEXT_263 = ".close();" + NL + "                        }";
  protected final String TEXT_264 = NL;
  protected final String TEXT_265 = NL + "\t\tif (commitCounter_";
  ...
  protected final String TEXT_272 = " .close();" + NL + "\t\t";
  protected final String TEXT_273 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_274 = "\", true);" + NL + "    \t";
  protected final String TEXT_275 = NL + "\tnb_line_deleted_";
  protected final String TEXT_276 = "=nb_line_deleted_";
  protected final String TEXT_277 = "+ deletedCount_";
  protected final String TEXT_278 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_279 = "=nb_line_update_";
  protected final String TEXT_280 = " + updatedCount_";
  protected final String TEXT_281 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_282 = "=nb_line_inserted_";
  protected final String TEXT_283 = " + insertedCount_";
  protected final String TEXT_284 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_285 = "=nb_line_rejected_";
  protected final String TEXT_286 = " + rejectedCount_";
  protected final String TEXT_287 = ";" + NL + "\t";
  protected final String TEXT_288 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_289 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_290 = "_NB_LINE\",nb_line_";
  protected final String TEXT_291 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_292 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_293 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_294 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_295 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_296 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_297 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_298 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_299 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_300 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_301 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_304 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_305 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_306 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_307 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_310 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_311 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_312 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_313 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_316 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_317 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_318 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_319 = NL + "        globalMap.put(\"";
  protected final String TEXT_320 = "_NB_LINE\",nb_line_";
  protected final String TEXT_321 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_322 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_323 = ");" + NL + "        globalMap.put(\"";
