package org.talend.designer.codegen.translators.databases.azure.sqldatawarehouse;
...
public class TSQLDWHOutputBeginJava {
  ...
  protected final String TEXT_131 = " += \";applicationName=Talend;\" + ";
  ...
  protected final String TEXT_380 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_381 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_386 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_387 = ".close();";
  protected final String TEXT_388 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_389 = " = conn_";
  protected final String TEXT_390 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_391 = " = dbMetaData_";
  protected final String TEXT_392 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_393 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_421 = ".close();" + NL + "                                }";
  protected final String TEXT_422 = NL + "                                if(whetherExist_";
  protected final String TEXT_423 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_424 = " = conn_";
  protected final String TEXT_425 = ".createStatement();";
  protected final String TEXT_426 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_434 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_441 = ".execute(((\"";
  protected final String TEXT_442 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_450 = ".execute(\"";
  ...
  protected final String TEXT_467 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_473 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_474 = " = stmtTruncCount_";
  protected final String TEXT_475 = ".executeQuery(\"";
  protected final String TEXT_476 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_477 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_478 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_479 = " = rsTruncCount_";
  protected final String TEXT_480 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_481 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_482 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_499 = ".close();";
  protected final String TEXT_500 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_516 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_517 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_518 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_519 = ".close();";
  ...
  protected final String TEXT_531 = " = null;" + NL + "\t\tString keyPsmt_";
  ...
  protected final String TEXT_549 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_554 = ") VALUES (";
  protected final String TEXT_555 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_562 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_577 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_578 = " = conn_";
  protected final String TEXT_579 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_595 = ") VALUES (";
  protected final String TEXT_596 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_597 = " = conn_";
  protected final String TEXT_598 = ".prepareStatement(insert_";
  protected final String TEXT_599 = ");";
  protected final String TEXT_600 = NL + NL + "    class BufferLine_";
  protected final String TEXT_601 = " {";
  protected final String TEXT_602 = NL + "                ";
  protected final String TEXT_603 = " ";
  protected final String TEXT_604 = ";";
  protected final String TEXT_605 = NL + NL + "        public BufferLine_";
  ...
  protected final String TEXT_614 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_615 = "> sInsertColValueList";
  protected final String TEXT_616 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_617 = " sInsertColValue";
  protected final String TEXT_618 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_619 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_620 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_621 = ".append(\"(";
  protected final String TEXT_622 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_623 = "-1) extendInsertValueStmt_";
  protected final String TEXT_624 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_625 = " = \"INSERT INTO \"+";
  protected final String TEXT_626 = "+\" (";
  protected final String TEXT_627 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_628 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_629 = " =  conn_";
  protected final String TEXT_630 = ".prepareStatement(insert_";
  protected final String TEXT_631 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_632 = " = \"";
  protected final String TEXT_633 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_634 = " =  \"";
  protected final String TEXT_635 = "\";" + NL + "    int rowCount";
  protected final String TEXT_636 = " = 0;";
  protected final String TEXT_637 = NL + "        StringBuffer query_";
  protected final String TEXT_638 = " = null;" + NL + "       \t";
  protected final String TEXT_639 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_640 = " = insert_";
  protected final String TEXT_641 = ".split(\"\\\\?\");";
  protected final String TEXT_642 = NL + "\t\t\tupdate_";
  protected final String TEXT_643 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_644 = " = update_";
  ...
  protected final String TEXT_649 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_650 = " = insert_";
  protected final String TEXT_651 = ".split(\"\\\\?\");";
  protected final String TEXT_652 = NL + "\t\t\tdelete_";
  protected final String TEXT_653 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_654 = " = delete_";
  protected final String TEXT_655 = ".split(\"\\\\?\");";
  protected final String TEXT_656 = NL + "\t\t\treplace_";
  protected final String TEXT_657 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_658 = " = replace_";
  protected final String TEXT_659 = ".split(\"\\\\?\");";
  protected final String TEXT_660 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_661 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_662 = " = insertIgnore_";
  ...
  protected final String TEXT_667 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_668 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_669 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_670 = "\") == true;";
  protected final String TEXT_671 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_672 = " = conn_";
  protected final String TEXT_673 = ".createStatement();";
  protected final String TEXT_674 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_675 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_676 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_677 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_678 = NL + "     \t\tstmt_";
  protected final String TEXT_679 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_680 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_681 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_682 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_683 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_684 = " =null;" + NL + "\t";
  protected final String TEXT_685 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_686 = " = null;" + NL + "\t\t";
  protected final String TEXT_687 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_688 = " = null;";
  protected final String TEXT_689 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_690 = " =  null;";
  protected final String TEXT_691 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_692 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_693 = " = null;";
  protected final String TEXT_694 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_698 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_699 = " = null;";
  protected final String TEXT_700 = NL + "\t\t \tString[] insertSQLSplits_";
